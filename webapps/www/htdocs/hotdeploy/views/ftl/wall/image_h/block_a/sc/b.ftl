<div class="bankuai fl">
    ...
    <!--atit-->
    <div class="h_picon mr_l"> <a href="javascript:void(0)" name="preview" cuno="${block.discoveryWallContent.contentUno}"
               cid="${block.discoveryWallContent.contentId}"><div class="h_img">
