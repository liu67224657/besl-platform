...
(function() {
            ...
            $.JMDialog = function(o) {
                ...
                $.JMDialog.init(defaults);
            };
            var BOXID,isIE6 = !-[1,] && !window.XMLHttpRequest;
            var $JMDialogarr = new Array();
            ...
            $.extend($.JMDialog, {
                        ...
                        init: function (o) {
                            ...
                            var $box = $("#" + o.___boxID);
                            $.JMDialog.showBox(o);
                            $(".___closeBox", $box).die().live("click",
                                    function() {
                                        $.JMDialog.removeBox();
                                    }).css({zIndex:"870618"});
                            if (o.___closeID != "") {
                            ...
                            ;
                            if (o.___time != "") {
                                setTimeout($.JMDialog.removeBox, o.___time);
                            }
                            ;
                            if (o.___showbg != "" && o.___showbg == true) {
                                var $boxBgDom = "<div id=\"JMDialogBg\" style=\"position:absolute;background:" + o.___windowBgColor + ";filter:alpha(opacity=0);opacity:0;width:100%;left:0;top:0;z-index:870618\"><iframe src=\"about:blank\" style=\"width=100%;height:" + $(document).height() + "px;filter:alpha(opacity=0);opacity:0;scrolling=no;z-index:870610\"></iframe></div>";
                            ...
                            ;
                            $.JMDialog.contentBox(o);
                            if (o.___button != "") {
                                $.JMDialog.ask(o);
                            }
                            ;
                            $.JMDialog.keyDown(o);
                            $.JMDialog.setBoxzIndex(o);
                            if (o.___showbg != true) {
                        ...
                        showBox: function(o) {
                            ...
                            var $width = parseInt(o.___width) > 1000 ? 1000 : parseInt(o.___width),
                                    $height = parseInt(o.___height) > 550 ? 600 : parseInt(o.___height);
                            var $boxDom = "<div id=\"" + o.___boxID + "\" class=\"JMDialog\">";
...
//				$boxDom += "<div class=\"___boxBd\"></div>";
                            $boxDom += "<iframe src=\"about:blank\" style=\"position:absolute;left:0;top:0;filter:alpha(opacity=0);opacity:0;scrolling=no;z-index:10714\" allowTransparency=\"true\"></iframe>";
                            $boxDom += "</div>";
...
//					background:o.___boxBdColor,
                            ...
                            ;
                            if (o.___showTitle != true) {
                                $(".___boxTitle", $box).remove();
                            }
                            ...
                            if (isIE6) {
                                if (o.___triggerID == "") {
                                    if (TOP >= 0) {
                                        $.JMDialog.addStyle(".ui_fixed_" + o.___boxID + "{width:100%;height:100%;position:absolute;left:expression(documentElement.scrollLeft+documentElement.clientWidth-this.offsetWidth);top:expression(documentElement.scrollTop+" + TOP + ")}");
                                        ...
                                        $.JMDialog.addStyle(".ui_fixed2_" + o.___boxID + "{width:100%;height:100%;position:absolute;left:expression(documentElement.scrollLeft+documentElement.clientWidth-this.offsetWidth);top:expression(documentElement.scrollTop+documentElement.clientHeight-this.offsetHeight)}");
                                        $wrap = $("<div class=\"" + o.___boxID + "IE6FIXED\"  id=\"" + o.___boxID + "parent\"></div>");
                                        $box.appendTo($wrap);
                                        $("body").append($wrap);
                                        $("." + o.___boxID + "IE6FIXED").css($location).css({
                            ...
                            switch ($contentType) {
                                ...
                                case "iframe":
                                    ...
                                    $.ajax({
                                                ...
                                                success:function(html) {
                                                    $contentID.html("<iframe src=\"" + $content + "\" width=\"100%\" height=\"" + parseInt(o.___height) + "px\" scrolling=\"auto\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\" allowTransparency=\"true\"></iframe>");
                                                }
                                            });
                            }
                            ;
                        ...
                        ask:function(o) {
                            ...
                            if (o.___button != "") {
                                ...
                                ;
                                $boxDialog.html($.map(answerStrings,
                                        function(v) {
                                            return "<input class='dialogBtn' type='button'  value='" + v + "' />";
                                        }).join(' '));
                                $(".dialogBtn", $boxDialog).hover(
                                        function() {
                                            $(this).addClass("hover");
                                        },
                                        function() {
                        ...
                        setBoxzIndex: function (o) {
                            $JMDialogarr.push(document.getElementById(o.___boxID + "parent"));//存储窗口到数组
                            var ___event = "mousedown" || "click";
                            var $box = $("#" + o.___boxID + "parent");
                            $box.die().live("click", function() {
                                for (var i = 0; i < $JMDialogarr.length; i++) {
                                    $JMDialogarr[i].style.zIndex = 870618;
                                }
                                ;
...
//
//
//        hideAtMaskBoxId:function (boxId) {
//            var $box = $("#" + boxId);
//            var $boxbg = $("#JMDialogBg");
//            if ($box != null || $boxbg != null) {
//                $box.parent().removeAttr("style").remove();
