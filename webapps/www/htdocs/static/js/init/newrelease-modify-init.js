...
//            upload_progress_handler : uploadProgress,
    ...
    $(document).ready(function () {
        ...
        $('#form_submit_create').bind('submit', function () {
            ...
            if (icon.length == 0) {
                alertOption.text = "请上传图标";
                alertOption.title = "图标"
                joymealert.alert(alertOption);
                return false;
            }
            ...
            if (picStr.length == 0) {
                alertOption.text = "请上传截图";
                alertOption.title = "截图"
                joymealert.alert(alertOption);
                return false;
            }
