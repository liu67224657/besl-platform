define(function (require, exports, module) {
    ...
    $(document).ready(function () {
        ...
        $('.exchange').click(function () {
            ...
            var consumePoint = $(this).attr('data-cpoint');
            ...
            biz.exchange(goodsId, callback.exchangeCallback);
        });
    ...
    var bizLock;
    var biz = {
        exchange: function (goodsId, callback) {
            if (bizLock) {
                return;
            }
            bizLock = true;
            $.ajax({type: "POST",
                        url: joyconfig.URL_WWW + "/json/goods/exchange",
                        data: {gsid: goodsId},
    ...
    var callback = {
        exchangeCallback: function (result) {
            if (result.status_code == '-1') {
                ...
                alertOption.callbackFunction = function () {
                    window.location.href = joyconfig.URL_WWW + '/goods';
                }
            }
