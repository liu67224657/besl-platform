...
SWFUpload.prototype.getFlashHTML = function (flashVersion) {
    var classid = window.navigator.userAgent.indexOf('Firefox') != -1 || window.navigator.userAgent.indexOf('Chrome') != -1 ||window.navigator.userAgent.indexOf('Safari') != -1? '' : 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ';
    // Flash Satay object syntax: http://www.alistapart.com/articles/flashsatay
    return ['<object id="', this.movieName,'" type="application/x-shockwave-flash" ' + classid + ' data="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
