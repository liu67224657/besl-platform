				...
				CKEDITOR.scriptLoader.load( languageFiles, function()
					{
						...
						for ( var m = 0 ; m < methods.length ; m++ )
						{
							for ( var i = 0 ; i < pluginsArray.length ; i++ )
							{
								...
								// Uses the first loop to modifyEmailAndCode the language entries also.
...
CKEDITOR.tools.extend( CKEDITOR.editor.prototype,
	/** @lends CKEDITOR.editor.prototype */
	{
		 ...
		 *		element, this parameter indicates whether or not to modifyEmailAndCode the
		...
		setReadOnly : function( makeEditable )
		{
			if ( this.readOnly != !makeEditable )
			{
				...
				// Fire the readOnly event so the editor features can modifyEmailAndCode
...
/**
 * Whether escape HTML when editor modifyEmailAndCode original input element.
