...
<div id="wrapper">
    ...
    <div class="content">
        <ul>
            <li>
                <a href="http://api.${DOMAIN}/my/totask?profileid=${profile.profileId}&appkey=${appkey}&clientid=${clientid}&platform=${platform}"><span
                        class="fl">今日任务</span><em class="fr"></em></a></li>
            <li>
                <a href="http://api.${DOMAIN}/my/giftlist?profileid=${profile.profileId}&appkey=${appkey}&type=1&clientid=${clientid}&platform=${platform}"><span
