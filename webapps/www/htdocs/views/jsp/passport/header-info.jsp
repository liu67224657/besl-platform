...
<c:choose>
    ...
    <c:otherwise>
        ...
        document.write('<a href="http://passport.${DOMAIN}/auth/thirdapi/qq/bind?rurl='+escape(window.location.href)+'" class="qq" title="qq号码登录"></a>');
        document.write('<a href="http://passport.${DOMAIN}/auth/thirdapi/sinaweibo/bind?rurl='+escape(window.location.href)+'" class="weibo" title="新浪微博登录"></a>');
        <%--document.write('<a href="http://passport.${DOMAIN}/auth/thirdapi/renren/bind?rurl='+escape(window.location.href)+'" class="renren" title="人人登录"></a>');--%>
...
<c:if test="${userSession!=null}">
    ...
    document.write('<li class="first"><a href="${URL_WWW}/profile/customize/basic">设置</a></li>');
    <%--document.write('<li class="first"><a href="${URL_WWW}/activity/pay">充值</a></li>');--%>
    document.write('<li>');
    document.write('<li>');
