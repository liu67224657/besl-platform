...
<c:choose>
    <c:when test="${userCenterSession!=null}">
        ...
        document.writeln("<div class=\"joyme-right-nav\">");
        document.writeln("<div class=\"joyme-loginbar\">");
        document.writeln("<div class=\"after\">");
        document.writeln("<span>");
        document.writeln("<em>欢迎你，</em>");
        document.writeln("<a class=\"joyme-userName\" href=\"${URL_UC}/usercenter/home\">${userCenterSession.nick}</a>");
        document.writeln("<cite></cite>");
        document.writeln("<div>");
        document.writeln("<ul>");
        document.writeln("<li><a href=\"${URL_WWW}/profile/customize/basic\">设置</a></li>");
        document.writeln("<li><a href=\"http://passport.${DOMAIN}/auth/logout?reurl=${redr}\">退出</a>");
        document.writeln("</li>");
        document.writeln("</ul>");
        document.writeln("</div>");
        document.writeln("</span>");
