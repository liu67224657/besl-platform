...
<div class="content set_content clearfix">
    ...
    <div id="set_right">
        ...
        <div class="bind-mobile">
            <h4>绑定手机号，即可领取着迷礼包</h4>

            <form action="/profile/mobile/verify" method="post" id="verifyform">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <c:if test="${fn:length(codeError)>0}">
                                <div class="error">
                                    <fmt:message key="${codeError}"
                                                 bundle="${userProps}"/></div>
                            </c:if>
                        </td>
                    </tr>
                    <tr>
                        <th>&nbsp;</th>
                        <td><br/><a href="javascript:void(0)" class="submitbtn" id="formsubmit" ><span>确定</span></a></td>
                    </tr>
                </table>
            </form>
        </div>
