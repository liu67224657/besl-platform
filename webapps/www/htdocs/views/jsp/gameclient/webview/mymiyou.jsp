...
<head>
    ...
    <%--<script type="text/javascript" src="http://static.joyme.com/app/wanba/js/miyouscroll.js"></script>--%>
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var nodata = $(".no-data").length;
            if (nodata > 0) {
                $(".inner").addClass("none_data");
            }
            ...
            if (cookieValue != miyoumodifytime) {
                $("#removered").addClass("hint");
            }
            $("#removered").on('touchstart', function () {
                $.cookie(uidparam, miyoumodifytime, {expires: 10});
                $("#removered").removeClass("hint");
            });
        });
            ...
            <li class="item">
                <div class="mi-tit-box">
                    <h2>
                        <c:forEach items="${profiles}" var="profile">
                            <c:if test="${item.uri eq profile.profileId}">
                                <cite><img
                                        class="lazy" src="${URL_LIB}/static/theme/default/images/data-bg.gif"
                    ...
                    <a href="http://api.${DOMAIN}/joymeapp/gameclient/webview/miyou/miyoudetail?commentid=${item.commentId}">
                        ...
                        <em><b class="ll-num">${item.longCommentSum}</b><img
                                class="lazy" src="${URL_LIB}/static/theme/default/images/data-bg.gif"
                                data-src="${item.pic}"
                                alt=""></em>
                        </c:if>
...
<ul id="thelist1" class="lists">
    <c:forEach items="${todayList}" var="item">
        <li class="item">
            <div href="http://api.${DOMAIN}/joymeapp/gameclient/webview/miyou/miyoudetail?commentid=${item.commentId}"
                 class="mi-tit-box">
