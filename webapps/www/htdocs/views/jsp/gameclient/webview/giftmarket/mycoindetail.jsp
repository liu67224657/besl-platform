...
<head>
    ...
    <%--<script type="text/javascript" src="${URL_LIB}/static/js/page/WebViewJavascriptBridge.js?${version}"></script>--%>
...
<div id="wrapper">
    <div class="win pt-45">
        ...
        <p>消耗迷豆：<span>${dto.point}</span></p>
    </div>

    <div class="order  clearfix  exclusive">
        <h2><cite class="sp-icon"><img src="${URL_LIB}/static/theme/default/images/my/shop-zy.png" alt=""></cite>&nbsp;&nbsp;商品摘要
        </h2>
        <dl class="clearfix">
            <dt class="fl"><img src="${dto.gipic}" alt=""></dt>
            <dd class="fl">
                <h3>${dto.title}</h3>
                <b>数量：<span class="color">1</span></b>&nbsp;&nbsp;&nbsp;
                <%--<b>规格：<span class="color">默认</span></b>--%>
            </dd>
        </dl>
    </div>
    <c:if test="${dto.goodsType=='0'}">
        <div class="win-message">
            <h1><img src="${URL_LIB}/static/theme/wap/images/add.png"
                     alt="">收货人：<span>${address.contact}</span></h1>
