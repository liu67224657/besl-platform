...
<head>
    ...
    <link rel="stylesheet" href="${URL_STATIC}/pc/userEncourageSys/css/dropload.css">
                                    ...
                                    <li>
                                        <div class="list-item-l">
                                            <cite class="user-head-img"
                                                ...
                                                <a href="${URL_UC}/usercenter/page?pid=${profileMap[notice.body.destProfileId].profileId}"
                                                   target="_blank">
                                        ...
                                        <div class="list-item-r situatio-one">
                                            <div class="item-r-name ">
                                                <c:choose>
                                                    <c:when test="${notice.body.wikiNoticeDestType.code eq 9}">
                                                        <a href="${URL_UC}/usercenter/page?pid=${profileMap[notice.body.destProfileId].profileId}"
                                                           target="_blank"> ${profileMap[notice.body.destProfileId].nick} </a> 取消了对你的关注
                                                    </c:when>
                                                    <c:otherwise>
                                                        <a href="${URL_UC}/usercenter/page?pid=${profileMap[notice.body.destProfileId].profileId}"
                                                           target="_blank">${profileMap[notice.body.destProfileId].nick}</a>
                                                        关注了你，去他的
                                                        <a href="${URL_UC}/usercenter/page?pid=${profileMap[notice.body.destProfileId].profileId}"
                                                           target="_blank">个人中心</a>看看
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
