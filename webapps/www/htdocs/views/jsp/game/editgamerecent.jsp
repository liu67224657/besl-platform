...
<div class="sqcontent">
    ...
    <div class="sqc">
        ...
        <div class="editor-baike-bar">
            ...
            <a href="javascript:void(0);" class="current">编辑最近更新</a>
            <%--<a href="${URL_WWW}/game/${game.gameCode}/edit/menupage" >导航设置</a>--%>
            <%--<a href="${URL_WWW}/game/${game.gameCode}/edit/addmodulepage" >添加新栏目</a>--%>
        </div>
        <div class="clear"></div>
        <div class="content-manager">
            <form action="${URL_WWW}/game/${game.gameCode}/edit/modifyrecent" method="post" id="form_modifyrecent">
                <textarea name="recent" id="txtarea_recent" style="height:300px;">${recent}</textarea>
                <div class="tipstext" id="recent_error" style="display:none;clear: both;"></div>
...
<script>
    ...
    seajs.use('${URL_LIB}/static/js/init/game-editrecent-init.js');
</script>
