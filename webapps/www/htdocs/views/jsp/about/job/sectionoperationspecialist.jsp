...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
     ...
     <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;专区运营专员</div>
			...
			<div class="u_fans u_fansz">
					<ul class="zp">
						...
						<li class="listf clearfix">
							...
							<dl>
								<dt>1.</dt>
								<dd>对重点游戏专区的资料收集、内容更新及维护；</dd>
							</dl>
							<dl>
								<dt>2.</dt>
								<dd>制作相关专题，包含细分类游戏分类专题及重要更新专题；</dd>
							</dl>
							<dl>
								<dt>3.</dt>
								<dd>定期针对所负责的专区制作专题或热门活动；</dd>
							</dl>
							<dl>
								<dt>4.</dt>
								<dd>根据统计数据、竞品动态、用户反馈等信息提炼优化产品的可行性意见，优化专区，并推动落实；</dd>
							</dl>
						</li>
						<li class="listf clearfix">
							<br><b> • 任职要求：</b><br>
