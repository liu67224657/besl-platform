...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;美术设计部经理
        </div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>带领并指导每款产品的创意构思及执行，保证并监督设计部的作品质量；</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>负责带领创意团队并对部门成员进行专业培训和指导；</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>根据公司各项目要求及特点组织研讨、确定设计方案，带领设计团队保质保量按时完成设计任务；</dd>
                        </dl>
                        <dl>
                            <dt>4.</dt>
                            <dd>负责管理策划工作，把关设计团队作品，确定项目的整体设计风格；</dd>
                        </dl>
                        <dl>
                            <dt>5.</dt>
                            <dd>制定、规范规划设计部操作流程及工作程序，协调部门工作、学习。</dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        <br><b> • 任职要求：</b><br>
                        <dl>
                            <dt>1.</dt>
                            <dd>5年以上相关工作经验,美工基础过硬，擅长网页，美工设计，对色彩敏感；</dd>
                            <dt>2.</dt>
                            <dd>有成功作品，有大型门户网站或移动端策划、设计、制作经验；</dd>
                            <dt>3.</dt>
                            <dd>精通HTML语言、CSS、javascript ；精通WEB标准（DIV+CSS）；</dd>
                            <dt>4.</dt>
                            <dd>精通平面设计软件：Photoshop、CarelDraw；熟练使用网页制作三剑客:Dreamweaver、Flash、Fireworks；</dd>
                            <dt>5.</dt>
                            <dd>对游戏或者动漫有一定的热爱和了解。</dd>
                        </dl>
                    </li>
                </ul>
            </div>
