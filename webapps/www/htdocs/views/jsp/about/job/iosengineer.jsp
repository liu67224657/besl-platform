            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>全程参与App版本产品需求，功能等定义。</dd>
                            <dt>2.</dt>
                            <dd>担任产品开发任务，可以独立完成App产品的开发。</dd>
                            <dt>3.</dt>
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            ...
                            <dd>计算机及相关专业；</dd>
                            <dt>2.</dt>
                            <dd>一年及以上相关工作经验，有过C/C++开发经验或者有AppStore上架应用的优先。</dd>
                            <dt>3.</dt>
                            <dd>熟练掌握Objective-C，能够熟练使用Xcode及Instruments工具。</dd>
                            <dt>4.</dt>
                            <dd>能够熟练阅读英文文档。</dd>
                            <dt>5.</dt>
                            <dd>熟练掌握视图的绘制和布局。</dd>
                            ...
                            <dd>熟悉常用网络框架的使用。</dd>
                            <dt>7.</dt>
                            <dd>掌握Objective-C内存管理、block的使用，能够编写稳定高质量的代码。</dd>
                            <dt>8.</dt>
