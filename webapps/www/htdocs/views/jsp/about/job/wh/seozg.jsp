...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;SEO主管
        </div>
                ...
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>2.</dt>
                            <dd>
                                负责搜索引擎优化，评估分析网站关键词，提升网站关键词的搜索和自然排名；
                            </dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>
                                跟踪分析引入的流量以及相关关键词的排名，形成阶梯性数据报告并提出后续优化方案；
                            </dd>
                        </dl>
                        <dl>
                            <dt>4.</dt>
                            <dd>
                                监测跟踪百度、谷歌等收录情况和排名效果，制定SEO月报总结和计划；
                            </dd>
                        </dl>
                        <dl>
                            <dt>5.</dt>
                            <dd>
                                合理构建网站外链，包括论坛、博客及软文外链等；
                            </dd>
                        </dl>
                        <dl>
                            <dt>6.</dt>
                            <dd>
                                熟悉论坛、博客、百度问答等营销方法，负责制定营销策略；
                            </dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>
                                大专以上学历，两年以上工作经验，有游戏网站工作经历者优先；
                            </dd>
                            <dt>2.</dt>
                            <dd>
                                熟知各大搜索引擎（google、baidu、雅虎等）的排名原理、技术特性和优化原则；
                            </dd>
                            <dt>3.</dt>
                            <dd>
                                熟练使用SEO优化各种工具和技术，有较丰富的操作经验；
                            </dd>
                            <dt>4.</dt>
                            <dd>
                                工作积极主动、认真细心踏实、团队意识强、具有很好的沟通能力。
                            </dd>
                        </dl>
                    </li>
                </ul>
