...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;IOS开发工程师
        </div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd> 负责iOS平台移动客户端应用程序的开发；</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>
                                参与App产品开发任务，可以在指导下完成App的开发；
                            </dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>
                                熟悉iOS应用开发框架，能独立开发iOS应用；
                            </dd>
                            <dt>2.</dt>
                            <dd>
                                熟练掌握Objective-C，熟悉MacOS，Xcode及iPhone SDK开发环境，良好的编程习惯；
                            </dd>
                            <dt>3.</dt>
                            <dd>
                                熟悉macos x操作系统和xcode/iphone sdk开发环境；
                            </dd>
                            <dt>4.</dt>
                            <dd>
                                能够熟练阅读英文文档；
                            ...
                            <dt>6.</dt>
                            <dd>
                                对移动互联网有浓厚的兴趣，具有一年左右的同岗位工作经验，计算机专业优秀应届毕业生亦可。
                            </dd>
                        </dl>
                    </li>
                </ul>
