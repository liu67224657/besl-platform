...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;专区编缉（常规专区）
        </div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>制作常规游戏专区，合理安排专区内容分布，完善专区内容饱满度。</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>发布游戏相关文章，更新和维护专区内容和图片。</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>制作特色游戏专题页面，参与内容编写。</dd>
                        </dl>
                        <dl>
                            <dt>4.</dt>
                            <dd>推广专区和专题，推动专区和专题的访问。</dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        <br><b> • 任职要求：</b><br>
                        <dl>
                            <dt>1.</dt>
                            <dd>
                                了解游戏；至少有一个平台的游戏精通，包括TVGAME、网络游戏、电脑单机游戏、手机游戏、掌机游戏；对游戏有足够的自我认知和评判；能够了解游戏领域中比较知名的游戏和游戏厂商；至少有3年以上的游龄。
                            </dd>
                            <dt>2.</dt>
                            <dd>了解html代码；熟悉使用photoshop；有绘画功底者优先。</dd>
                            <dt>3.</dt>
                            <dd>有较长时间的互联网经验，熟悉QQ、微博、论坛等常用的社交平台，并能够从中获取相关信息。</dd>
                            <dt>4.</dt>
                            <dd>对二次元和三次元潮流有充足的了解，喜好动漫者优先。</dd>
                        </dl>
                    </li>
                </ul>
            </div>
