...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;公关经理
        </div>
                ...
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>3.</dt>
                            <dd>
                                通过有效的手段对传播渠道和供应商进行跟进监督；
                            </dd>
                        </dl>
                        <dl>
                            <dt>4.</dt>
                            <dd>
                                开拓、建立和维护重点媒体关系，做好危机处理的预防监测体系；
                            </dd>
                        </dl>
                        <dl>
                            <dt>5.</dt>
                            <dd>
                                针对竞争公司的媒介（包括广告、公关等）策略分析或建议，并定期输出分析报告；
                            </dd>
                        </dl>
                        <dl>
                            <dt>6.</dt>
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            ...
                            <dt>4.</dt>
                            <dd>
                                拥有优秀的商务拓展能力，客户关系维护能力、危机公关处理能力；
                            </dd>
                            <dt>5.</dt>
                            <dd>拥有针对行业层面的媒体传播稿件的撰写能力媒介策划及整合营销的主要理论。</dd>
                        </dl>
                    </li>
                </ul>
            </div>
