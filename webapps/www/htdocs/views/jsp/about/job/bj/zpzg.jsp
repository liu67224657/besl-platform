...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;招聘主管
        </div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>.制订并执行招聘计划，进行工作分析，完成职位说明书体系建设，建立招聘流程体系并持续优化改进；
                            </dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>
                                负责各部门招聘需求信息的采集、分析、整理，并制定和组织实施招聘计划；
                            </dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>
                                专科及以上学历，人力资源管理相关专业优先。
                            </dd>
                            <dt>2.</dt>
                            <dd>
                                2年左右招聘相关工作经验，有猎头招聘经验优先。
                            </dd>
                            <dt>3.</dt>
                            <dd>
                                熟悉企业的招聘流程及各种招聘渠道，熟练掌握各种招聘技巧，能独立开展招聘工作；
                            </dd>
                            <dt>4.</dt>
                            <dd>
                                具备较强推动力、执行力，表达与沟通协作的能力、分析与解决问题的能力；
                            </dd>
                            <dt>5.</dt>
                            <dd>
                                具有较强的抗压能力，能承受较强的工作压力。
                            </dd>
                            <dt>6.</dt>
                            <dd>
                                有IT、互联网行业猎头或招聘经验者优先。
