...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;产品经理（运营方向）
        </div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>负责公司产品模块相关的功能设计，效果评估，功能优化相关工作。</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>负责同类产品的信息日常调研；</dd>
