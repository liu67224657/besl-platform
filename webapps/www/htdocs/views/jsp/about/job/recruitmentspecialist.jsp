...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;招聘专员
        </div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>执行招聘计划，进行工作分析，持续优化改进招聘流程体系；</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>专科及以上学历，人力资源管理相关专业优先；</dd>
                            <dt>2.</dt>
                            <dd>2年左右互联网行业招聘相关工作经验，有一定的招聘渠道或资源；</dd>
                            <dt>3.</dt>
                            <dd>熟悉企业的招聘流程及各种招聘渠道，熟练掌握各种招聘技巧，能独立开展招聘工作；</dd>
                            <dt>4.</dt>
                            <dd>具备较强推动力、执行力，表达与沟通协作的能力、分析与解决问题的能力；</dd>
                            <dt>5.</dt>
                            <dd>能吃苦，有创业精神，能接受出差；</dd>
                            <dt>6.</dt>
                            <dd>有IT、互联网行业猎头或招聘经验者优先；</dd>
                            <dt>7.</dt>
                            <dd>有校招经验，异地招聘经验者优先。</dd>
                        </dl>
                    </li>
                </ul>
            </div>
