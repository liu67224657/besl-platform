...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;Android开发工程师
        </div>
                ...
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            ...
                            <dt>2.</dt>
                            <dd>担任产品开发任务，可以独立完成android产品的开发。</dd>
                            <dt>3.</dt>
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            ...
                            <dd>计算机及相关专业本科；</dd>
                            <dt>2.</dt>
                            <dd>2年以上android开发工作经验，有android实际产品发布开发经验或参与过大型复杂项目的开发工作并担任重要角色。</dd>
                            <dt>3.</dt>
                            <dd>熟悉Android架构和相关技术，基于Android平台系统进行应用开发；</dd>
                            <dt>4.</dt>
                            <dd>能独立进行Android应用功能的设计、开发、调试、发布；</dd>
                            <dt>5.</dt>
