            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>负责iOS平台移动客户端应用程序的开发，开发；</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>参与App产品开发任务，可以在指导下完成App的开发；</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>学习和研究新技术以满足产品的需求。</dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        <br><b> • 任职要求：</b><br>
                        <dl>
                            <dt>1.</dt>
                            <dd>熟悉iOS应用开发框架，能独立开发iOS应用；</dd>
                            <dt>2.</dt>
                            <dd>熟练掌握Objective-C，熟悉MacOS，Xcode及iPhone SDK开发环境，良好的编程习惯； </dd>
                            <dt>3.</dt>
                            <dd>能够熟练阅读英文文档；</dd>
                            <dt>4.</dt>
                            <dd>能根据需求进行合理的模块分解与任务分解； </dd>
                            <dt>5.</dt>
                            <dd>对移动互联网有浓厚的兴趣，具有一年左右的同岗位工作经验，计算机专业优秀应届毕业生亦可。</dd>
                        </dl>
                    </li>
                </ul>
            </div>
