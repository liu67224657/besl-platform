...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;记者</div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>游戏互联网行业日常报道，主动挖掘新闻线索</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>负责新闻实地采访，新闻撰写及稿件深度解析</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>参与专题策划、组织及报道工作</dd>
                        </dl>
                        <dl>
                            <dt>4.</dt>
                            <dd>完成领导安排的其他工作</dd>
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            ...
                            <dd>本科以上学历。</dd>
                            <dt>2.</dt>
                            <dd>熟悉游戏互联网行业，3年以上游戏行业编辑记者工作经验，至少1年采访经验。</dd>
                            <dt>3.</dt>
                            <dd>具有一定的文学功底，撰稿和文字编辑能力，思路清晰。</dd>
                            <dt>4.</dt>
                            <dd>具有良好的沟通、合作能力和服务意识。</dd>
                            <dt>5.</dt>
                            <dd>有强烈的责任心和使命感，良好的团队合作精神，能够承受工作压力，吃苦耐劳。</dd>
                            <dt>6.</dt>
                            <dd>熟练电脑操作，熟练操作OFFICE办公软件与图片处理软件，熟悉网站后台操作，熟悉网站推广、页面优化。</dd>
                            <dt>7.</dt>
                            <dd>具备网页图文采集、编辑能力。</dd>
                        </dl>
                    </li>
