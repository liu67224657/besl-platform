            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>Android手机应用软件设计；</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>Android手机应用软件开发；</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>Android手机软件功能测试与验证。</dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        <br><b> • 任职要求：</b><br>
                        <dl>
                            <dt>1.</dt>
                            <dd>掌握Android平台应用软件开发技术；</dd>
                            <dt>2.</dt>
                            <dd>熟悉Adode AIR编程技术者优先考虑；</dd>
                            <dt>3.</dt>
                            <dd>熟悉c++/Java编程技术；</dd>
                            <dt>4.</dt>
                            <dd>掌握Android系统网络编程能力；</dd>
                            <dt>5.</dt>
                            <dd>对游戏有高度热忱，工作态度积极，重视团队合作与沟通；</dd>
                            <dt>6.</dt>
                            <dd>有APP作品者优先。</dd>
                        </dl>
                    </li>
