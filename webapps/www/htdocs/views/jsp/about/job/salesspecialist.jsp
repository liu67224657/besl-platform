...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;广告销售专员
        </div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>开发新客户，完成公司下达的销售任务。</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>及时了解行业动态，收集、反馈市场信息。</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>与客户保持良好沟通，适时把握客户需求；为客户提供主动、满意、热情、周到的服务。</dd>
                        </dl>
                        <dl>
                            <dt>4.</dt>
                            <dd>定期向公司提供市场分析及预测报告和个人工作周报。 </dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        <br><b> • 任职要求：</b><br>
                        <dl>
                            <dt>1.</dt>
                            <dd>男女不限，22-32岁  专科以上学历</dd>
                            <dt>2.</dt>
                            <dd>乐观开朗积极上进；工作勤奋主动，有较强的团队精神。</dd>
                            <dt>3.</dt>
                            <dd>普通话标准，擅长与人沟通。</dd>
                            <dt>4.</dt>
                            <dd>有较强观察能力和应变能力；能承受较强工作压力；具备良好的服务意识。</dd>
                            <dt>5.</dt>
                            <dd>有一年以上行业媒体销售经验者优先。</dd>
                        </dl>
                    </li>
                </ul>
            </div>
