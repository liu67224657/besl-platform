...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;前台</div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>2.</dt>
                            <dd>负责来访客人/应聘人员的接待，引领和内部通报工作；</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>负责公司各项行政事务：邮递、办公用品的管理及办公设备的管理使用；</dd>
                        </dl>
                        <dl>
                            <dt>4.</dt>
                            <dd>及时更新和管理员工通讯地址和电话号码等联系信息；</dd>
                        </dl>
                        <dl>
                            <dt>5.</dt>
                            <dd>预定火车票、飞机票、住宿酒店以及日常商务宴的饭店预定；</dd>
                        </dl>
                        <dl>
                            <dt>6.</dt>
                            <dd>办理新员工工卡，负责员工考勤管理、统计；</dd>
                        </dl>
                        <dl>
                            <dt>7.</dt>
                            <dd>完成领导交办的其他任务。</dd>
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>大专及以上学历，亲和力强、性格开朗、形象气质佳；</dd>
                            <dt>2.</dt>
                            <dd>熟练操作办公软件、办公设备（如复印件，传真机等）；</dd>
                            <dt>3.</dt>
                            <dd>工作热情积极、细致耐心，具有较强的沟通能力、人际能力、有团队精神和服务意识；</dd>
                            <dt>4.</dt>
                            <dd>接受优秀应届毕业生，实习生。</dd>
                        </dl>
                    </li>
