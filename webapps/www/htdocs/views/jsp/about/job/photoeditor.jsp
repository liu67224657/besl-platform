...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;图片编辑（美术编辑）
        </div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>2.</dt>
                            <dd>根据内容需求和制作规范对已有图片素材进行修改和加工；</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>完成相关配合工作所需的配图及设计工作。</dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        <br><b> • 任职要求：</b><br>
                        <dl>
                            <dt>1.</dt>
                            <dd>大专以上学历，广告、设计、美术、视觉等相关专业</dd>
                            <dt>2.</dt>
                            <dd>熟悉平面、多媒体、广告及网络等设计工作，熟练掌握Photoshop、 Illustrator、InDesign、Flash等平面设计与网页编辑软件；</dd>
                            <dt>3.</dt>
                            <dd>有美术设计、排版经验</dd>
                            <dt>4.</dt>
