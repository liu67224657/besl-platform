...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;运营经理</div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>在公司经营战略指导下，进行市场调查和反馈，确定新游平台的整体定位、风格设计、业务的运营方向，制定运营计划；</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>组织目标市场、竞争态势、客户需求等的调查，撰写市场分析与评述，推动平台商业模式的形成和相关产品的设计、优化；</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>根据新游平台的定位及运营项目策划，确定相应栏目及其编辑方针，进行内容的具体规划，并制定具体运营项目的工作计划，组织运营项目的实施；</dd>
                        </dl>
                        <dl>
                            <dt>4.</dt>
                            <dd>根据运营情况、市场反馈等对运营策略进行监督、控制和绩效评估，及时调整运营策略与内容，保证项目运营目标的持续达成；</dd>
                        </dl>
                        <dl>
                            <dt>5.</dt>
                            <dd>根据公司具体情况和部门业务需要，合理设置部门组织结构和岗位，优化业务流程，合理配置人力资源，开发和培养员工能力，对员工绩效进行管理，提升部门工作效率，提高员工满意度。</dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        <br><b> • 任职要求：</b><br>
                        <dl>
                            <dt>1.</dt>
                            <dd>本科以上学历，两年以上手游行业工作经验，熟悉移动互联网行业；</dd>
                            <dt>2.</dt>
                            <dd>熟悉手游媒体运营、商务各个环节及整体运营体系；</dd>
                            <dt>3.</dt>
                            <dd>具备规范化、优化运营制度能力；</dd>
                            <dt>4.</dt>
                            <dd>能承受高压力、高强度的工作，较强的沟通能力；</dd>
                            <dt>5.</dt>
                            <dd>较强的逻辑性、全局观、分析规划能力和开拓创新意识，灵活的应变能力；</dd>
                            <dt>6.</dt>
                            <dd>良好的团队合作精神；</dd>
                            <dt>7.</dt>
                            <dd>具备国内知名大型游戏媒体工作经验者优先考虑。</dd>
                        </dl>
                    </li>
                </ul>
            </div>
