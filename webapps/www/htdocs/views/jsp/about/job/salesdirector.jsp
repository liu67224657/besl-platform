...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;销售总监
        </div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>确保销售团队100%完成每年公司的销售任务；</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>有效管理销售团队人员，保证销售团队无人违反公司管理制度；</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>每月至少一次针对产品及销售技巧对销售团队进行培训；</dd>
                        </dl>
                        <dl>
                            <dt>4.</dt>
                            <dd>协助公司相关部门完成销售制度及提成制度的政策制定；</dd>
                        </dl>
                        <dl>
                            <dt>5.</dt>
                            <dd>维护公司客户，保证客户的稳定性。</dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        <br><b> • 任职要求：</b><br>
                        <dl>
                            <dt>1.</dt>
                            <dd>国家统招专科及以上学历，市场营销等相关专业优先；</dd>
                            <dt>2.</dt>
                            <dd>市场营销知识、互联网行业知识</dd>
                            <dt>3.</dt>
                            <dd>5年以上销售经验，3年以上销售团队管理经验</dd>
                            <dt>4.</dt>
                            <dd>有丰富的销售及管理能力，为人正直。</dd>
                        </dl>
                    </li>
                </ul>
            </div>
