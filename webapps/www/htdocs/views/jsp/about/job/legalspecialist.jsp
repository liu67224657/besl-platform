...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;法务专员/法务主管
        </div>
                ...
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            ...
                            <dt>2.</dt>
                            <dd>3年或以上互联网公司同岗任职相关工作经验，有各类合同拟定，审核，管理经验，能依法独立起草，修改法律文书特别是商务类合同。</dd>
                            <dt>3.</dt>
                            <dd>有一定的法律知识培训经验。</dd>
                            <dt>4.</dt>
                            <dd>具有较强的服务意识、逻辑分析能力、判断能力、谈判技巧和沟通协调能力；具备独立思考并处理突发事件的能力；</dd>
                            <dt>5.</dt>
                            <dd>具备律师执业资格或通过国家司法考试并取得律师职业资格证书优先；</dd>
                            <dt>6.</dt>
                            <dd>对ESOP方案有了解者优先</dd>
                            <dt>7.</dt>
                            <dd>具备一定劳动仲裁知识者优先。</dd>
