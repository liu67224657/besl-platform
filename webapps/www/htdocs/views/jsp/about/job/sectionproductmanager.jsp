...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
     ...
     <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;产品经理（社区方向）</div>
			...
			<div class="u_fans u_fansz">
					<ul class="zp">
						...
						<li class="listf clearfix">
							...
							<dl>
								<dt>2.</dt>
								<dd>根据用户反馈和产品策略，对社区产品不断进行功能优化；</dd>
							</dl>
							<dl>
								<dt>3.</dt>
								<dd>同类产品的信息日常调研；</dd>
						...
						<li class="listf clearfix">
							...
							<dl>
								<dt>1. </dt>
								<dd>大学本科以上学历，社区型互联网产品工作经验3年以上；</dd>
								<dt>2.	</dt>
								<dd>具备一定的项目管理经验，习惯于用严谨科学的统筹方法来保证工作按计划进行；</dd>
								<dt>3.	</dt>
								<dd>良好的人格魅力和学习能力，协调和沟通能力强，较强的工作组织能力、责任心；</dd>
								<dt>4.	</dt>
								<dd>至少有过一次版主经验，深入研究新浪微博、微信、QQ空间、贴吧及各类社交产品；</dd>
								<dt>5.	</dt>
								<dd>熟悉社区的常见运营手法，能够针对运营手法设计功能；</dd>
								<dt>6.	</dt>
