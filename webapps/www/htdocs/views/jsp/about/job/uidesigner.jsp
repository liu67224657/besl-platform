...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;UI设计师
        </div>
            ...
            <div class="u_fans u_fansz">
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            <dt>1.</dt>
                            <dd>根据产品设计师的策划文档和页面基本框架图，进行产品视觉相关的设计、视觉素材的制作；</dd>
                        </dl>
                        <dl>
                            <dt>2.</dt>
                            <dd>与产品设计和开发人员一起，进行视觉相关的交互设计和体验优化；</dd>
                        </dl>
                        <dl>
                            <dt>3.</dt>
                            <dd>各类互联网产品的视觉相关研究。</dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        <br><b> • 任职要求：</b><br>
                        <dl>
                            <dt>1.</dt>
                            <dd>本科以上，2年以上互联网UI设计类经验，能娴熟和产品设计、前端工程师配合，完成各类功能实现；</dd>
                            <dt>2.</dt>
                            <dd>精通Photoshop、Illustartor等设计工具； </dd>
                            <dt>3.</dt>
                            <dd>沟通顺畅，注重团队合作，有强烈的工作激情，出色的独立思考和主动推动能力； </dd>
                            <dt>4.</dt>
                            <dd>具有大型网站的UI设计经验，兼具网络软件界面设计者经验，手绘能力强者优先考虑。</dd>
                        </dl>
                    </li>
                </ul>
            </div>
