...
<div class="about-bg clearfix">
    ...
    <div class="job-detail">
        ...
        <div class="jobdetail-title"><a href="http://www.joyme.com/about/job/zhaopin">招聘职位</a>&nbsp;&gt;&nbsp;商务拓展经理
        </div>
                ...
                <ul class="zp">
                    ...
                    <li class="listf clearfix">
                        ...
                        <dl>
                            ...
                            <dt>4.</dt>
                            <dd>制定商务拓展业务推广合作流程及规范；</dd>
                            <dt>5.</dt>
                            <dd>挖掘各媒体、渠道及运营的需求，深入挖掘并整合各方面优势资源；</dd>
                            <dt>6.</dt>
                            <dd>负责和各合作上的跟进工作（包括合同拟定、合作接入、对接跟进、后期维护）</dd>
                        </dl>
                    </li>
                    <li class="listf clearfix">
                        <br><b> · 任职要求：</b><br>
                        ...
                        <dl>
                            ...
                            <dt>2.</dt>
                            <dd>三年以上业务拓展、商务合作经验；</dd>
                            <dt>3.</dt>
                            <dd>充满激情、勤奋刻苦、独立开展工作能力强、悟性高、善于总结、能承受压力；</dd>
                            <dt>4.</dt>
                            <dd>熟悉手游厂商，有手游媒体相关资源和从业经验</dd>
                        </dl>
                        <p><br/>优先条件：</p>
                        <dl>
                            <dt>1.</dt>
