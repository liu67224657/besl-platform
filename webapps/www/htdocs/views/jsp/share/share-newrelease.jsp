    ...
    <div id="wiki-share" class="clearfix">
        ...
        <form action="" method="post" id="share_form">
            ...
            <div class="wiki-share-text">• 其他社交网络登录<em></em>
                <a class="share-sina"
                   href="http://passport.${DOMAIN}/auth/thirdapi/sinaweibo/bind?reurl=/share/newrelease/${bindDomain}/page?sid=${shareInfo.baseInfo.shareId}&icn=true"></a>
                <a class="share-qq"
                   href="http://passport.${DOMAIN}/auth/thirdapi/qq/bind?reurl=/share/newrelease/${bindDomain}/page?sid=${shareInfo.baseInfo.shareId}&icn=true"></a>
            </div>
        </form>
        <br/>
    </div>
...
<script>
    var actionPrefix = joyconfig.URL_WWW + '/share/newrelease/';
