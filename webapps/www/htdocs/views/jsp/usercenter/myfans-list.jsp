        ...
        <div class="col-md-9">
            <div id="main">
                <div class="follow-list-box ">
                    <h1 class="page-h1 pag-hor-20 fn-clear">${profile.nick}已经有<span id="h1_fans_count">${fansCount}位粉丝
                    </h1>
                    <div class="letter-tit  web-common-tit web-show ">
                        <a href="${URL_WWW}/usercenter/follow/mylist" class="follow">我的关注</a>
                        <a href="${URL_WWW}/usercenter/fans/mylist" class="fans on">我的粉丝</a>
                    </div>
                                            ...
                                            <div class="fn-right">
                                                ...
                                                <div class="dropdown web-hide" style="display:inline-block">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dLabel"
                                                        ...
                                                        <li><a href="javascript:;" class="more_action_removefans"
                                                               data-destpid="${userinfo.profileId}">移除粉丝</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                ...
                <c:if test="${not empty page&&page.maxPage>1}">
                    <div class="pagecon clearfix">
                        <c:set var="pageurl" value="${URL_UC}/usercenter/fans/mylist"></c:set>
...
<script type="text/javascript">
    ...
    function unfollowOnClick() {
        $('.dropdown-menu').on("click", '.more_action_removefans', function () {
            ...
            mw.ugcwikiutil.confirmDialog(opt, function () {
                if (srcprofileid != null && srcprofileid != "" && destpId != null && destpId != "") {
                    $.ajax({
                        url: "/api/usercenter/relation/removefans",
                        type: "post",
                        async: false,
                        ...
                        success: function (data) {
                            if (data != "") {
                                ...
                                if (rs == "1") {
                                    ...
                                    var fansCountObj = $('#fans_count');
                                    var fansCount = Number(fansCountObj.text()) - 1;

                                    $('#h1_fans_count').text(fansCount);
                                    fansCountObj.text(fansCount);
                                    refresh();
                                } else if (rs == "2") {
                                    mw.ugcwikiutil.msgDialog("移除粉丝失败");
                                } else if (rs == "-1001") {
                    ...
                    if (data != "") {
                        ...
                        if (rs == "1") {
                            ...
                            if (sendResult.result == 'e') {
                                ...
                                $('#fans' + destpId).attr('class', 'each-follow fol-style').append(html);
                            } else {
        ...
        function dropLoad(argument) {
            $('.follow-list-box ').dropload({
                ...
                loadDownFn: function (me) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: '/api/usercenter/relation/fans/list',
    ...
    <%--ajaxData: {--%>
    <%--type: 'post',--%>
    <%--url: '/usercenter/fans/mylist?' + Math.random(),--%>
    ...
    <%--result += '<div class="list-item-l guzhu-l">';--%>
    <%--result += '<cite><img src="">';--%>
    <%--result += '<span class="fensi-def fensi-dec-01 fensi-dec-02 fensi-dec-03 fensi-dec-04 fensi-dec-05 fensi-dec-06 fensi-dec-07"></span>';--%>
    <%--result += '</cite>';--%>
    <%--result += '</div>';--%>
    <%--result += '<div class="list-item-r guzhu-r">';--%>
    <%--result += '<div class="item-r-name fn-clear">';--%>
