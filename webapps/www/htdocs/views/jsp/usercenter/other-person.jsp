        ...
        <div class="fn-clear">
            <div class="col-md-11 info-r fn-clear">
                ...
                <div class="info-user  fn-clear">
                    <div>
                        <a href="javascript:;" class="user-login user-head-img" data-id="${userinfoDTO.profileId}">
                            <img src="${userinfoDTO.icon}" alt=""/>
                        ...
                        <div class="user-intro-con">
                            ...
                            <c:set var="desc" value="  这个人很懒，什么都没留下……"/>
                            ...
                            <div class="focus-letter-box">
                                <c:if test="${userinfoDTO.followStatus eq 0}">
                                    <a href="javascript:;" id="ufollow${userinfoDTO.profileId}"
                                       class="btn-focus-letter private"
                                       onclick="followProfile('${userinfoDTO.profileId}')">关注</a>
                                </c:if>
                                <c:if test="${userinfoDTO.followStatus eq 1}">
                                    <span class="btn-focus-letter focus  focused" id="ufollow${userinfoDTO.profileId}">已关注</span>
                                </c:if>
                                <c:if test="${userinfoDTO.followStatus eq 2}">
                                    <span class="btn-focus-letter focus  focused" id="ufollow${userinfoDTO.profileId}">互相关注</span>
                                </c:if>
                                <a href="javascript:;" class="btn-focus-letter private"
                                   onclick="postMessge('${userinfoDTO.uid}')">私信</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-11 active-num-wrap web-show">
                <div class="active-num">
                    <a href="/usercenter/fans/list?profileid=${userinfoDTO.profileId}">${userinfoDTO.fans}<br/>粉丝</a>
                    <cite></cite>
                    <a href="/usercenter/follow/list?profileid=${userinfoDTO.profileId}">${userinfoDTO.follows}<br/>关注</a>
                    <cite></cite>
        ...
        <div class="col-md-9">
            <div id="main" class="pag-hor-20 tab-box">
                <div class="trends-nav fn-clear tab-tit">
                    <a href="javascript:;" class="on">他的动态<i></i></a>
                    <a href="javascript:;">他的WIKI<i></i></a>
                </div>
                <div class="tab-con">
                    <!--他的动态 开始-->
                                ...
                                <c:when test="${not empty myTimeLineRows}">
                                    ...
                                    <c:if test="${not empty myTimeLinePage&& myTimeLinePage.maxPage>1}">
                                        <div class="more-con" id="myTimeLine" style="display:block;">
                                            <button onclick="myTimeLine('${userinfoDTO.profileId}')">
                                                点击加载更多...
                                            </button>
                                        </div>
                                    </c:if>
            ...
            <div id="sidebar">
                ...
                <c:if test="${not empty followList}">
                    <div class="fans-box fn-clear pag-hor-20">
                        <h3>
                            他的关注
                            <a href="/usercenter/follow/list?profileid=${userinfoDTO.profileId}" class="fn-right">
                                更多
                            </a>
                        </h3>
                        <div class="row fans-con">
                            <c:forEach items="${followList}" var="tempProfile" varStatus="st">
                                <a class="col-md-3"
                                   href="/usercenter/page?pid=${tempProfile.profileId}" target="_blank">
                ...
                <c:if test="${not empty fansList }">
                    <div class="fans-box fn-clear pag-hor-20">
                        <h3>
                            他的粉丝
                            <a href="/usercenter/fans/list?profileid=${userinfoDTO.profileId}" class="fn-right">
                                更多
                            </a>
                        </h3>
                        <div class="row fans-con">
                            <c:forEach items="${fansList}" var="tempProfile" varStatus="st">
                                <a href="/usercenter/page?pid=${tempProfile.profileId}" target="_blank"
                                   class="col-md-3">
                                    <cite class="user-head-img" data-id="${tempProfile.profileId}">
                                        <img src="${tempProfile.icon}" alt="img">
                                        <span class="focus-def <c:if test="${not empty tempProfile.headskin}">focus-dec-0${tempProfile.headskin}</c:if>">
                    ...
                    if (typeof(manageWikis) != "undefined" && manageWikis.length > 0) {
                        ...
                        for (var i = 0; i < manageWikis.length; i++) {
                            innerHtml += '<li class="col-md-4">' +
                                    ...
                                    '<a href="' + manageWikis[i].site_url + '" class="mg-wiki-main fn-clear col-md-12"  target="_blank">' +
