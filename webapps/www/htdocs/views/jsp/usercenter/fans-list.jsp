        ...
        <div class="col-md-9">
            <div id="main">
                <div class="follow-list-box ">
                    <h1 class="page-h1 pag-hor-20 fn-clear">${profile.nick}已经有了${fansCount}位粉丝</h1>
                    <div class="letter-tit  web-common-tit web-show ">
                        <a href="${URL_WWW}/usercenter/follow/list?profileid=${profileId}" class="follow">他的关注</a>
                        <a href="${URL_WWW}/usercenter/fans/list?profileid=${profileId}" class="fans on">他的粉丝</a>
                    </div>
                                ...
                                <li id="li_row_user${userinfo.profileId}">
                                    ...
                                    <div class="list-item-r guzhu-r">
                                        ...
                                        <div class="item-r-other fn-clear">
                                            ...
                                            <span>编辑&nbsp;<a
                                                    href="http://wiki.${DOMAIN}/home/index.php?title=特殊:着迷贡献&userid=${userinfo.uid}">${userinfo.edits}</a></span>
                                        </div>
                                    </div>
                                </li>
                            </c:forEach>
                ...
                <c:if test="${not empty page&&page.maxPage>1}">
                    <div class="pagecon clearfix">
                        <c:set var="pageurl"
                               value="${URL_UC}/usercenter/fans/list"></c:set>
