...
<c:forEach var="layout" items="${layoutList}" varStatus="status">
    <div class="picsee_con<c:if test="${status.index==0}"> mt15 clearfix</c:if>" id="block_${status.index}">
    ${layout.layoutHtml}
    </div>
...
<div id="box" class="wallBox" style="right: 153px;">
...
<script>
    seajs.use('${URL_LIB}/static/js/init/magazine-image-init.js')
</script>
