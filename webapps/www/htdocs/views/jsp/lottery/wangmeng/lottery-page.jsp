...
<div id="lottery-banner">
    <div>
        <a href="/wangmeng/lottery/qq/bind" class="lottery-join-qq">QQ参与抽奖</a>
        <a href="/wangmeng/lottery/sinaweibo/bind" class="lottery-join-weibo">微博参与抽奖</a>
    </div>
</div>
...
<div id="lottery-content">
    ...
    <iframe src="/wangmeng/lottery/rewardlist" scrolling="no" width="100%" frameborder=”no” border=”0″></iframe>
    ...
    <div id="recommend-wiki">
        ...
        <div class="getMore"><a href="http://www.joyme.com/games">更多攻略大全&nbsp;&gt;&gt;</a></div>
    </div>
