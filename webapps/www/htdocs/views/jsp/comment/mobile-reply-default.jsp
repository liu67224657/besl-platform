...
<head>
    ...
    <link href='${URL_STATIC}/mobile/cms/jmsy/logincont/loginbar.css' rel='stylesheet' type='text/css'>
...
<div id='content'>
    ...
    <div id="outer-div">
        ...
        <div class='module-comment clearfix' id="commentBody" style="display: none">
            <!--hot-tit-->
            <div class='info-bar hot-tit' id="loginTips"><a href="javascript:void(0);" class="fr"
                                                            id="loginout">登录</a><span>热门评论</span></div>
...
<script type="text/javascript" src="${URL_LIB}/static/js/init/login_common_m.js"></script>
<script type="text/javascript" src="${URL_LIB}/static/js/wap/wapcomment.js"></script>
</body>
</html>
