        ...
        <form action="${ctx}/json/content/post/chat" method="post" id="postchat">
            <div class="talk ">
                <div class="talk_wrapper clearfix">
                    <textarea name="content" id="chat_content" cols="" rows="" class="talk_text" warp="off" style="font-family:Tahoma, '宋体';"></textarea>
            ...
            <div class="edit">
                <div class="edittool">
                    ...
                    <a href="javascript:void(0)" onclick="return false;" class="talk_video" id="relVideo" title="视频">视频</a>
                    <a href="javascript:void(0)" onclick="return false;" class="talk_tag" id="relTag" title="标签">标签</a>
                    <a href="javascript:void(0)" onclick="return false;" class="talk_friend" id="relFriend" title="@朋友">朋友</a>
                    <a href="javascript:void(0)" onclick="return false;" class="talk_app" id="relApp" title="APP">APP</a>
                    <a title="投票" class="poll_btn" href="${URL_WWW}/vote/post/page" target="_blank" id="relVote">投票</a>
                    <c:if test="${openSync}">
                    <span class="tongbu">|<input type="checkbox" id="publish_s" class="publish_s" name="sync" <c:choose>
                   <c:when test="${fn:length(syncProviderSet)>0}">checked="true"</c:when>
                    <c:otherwise>disabled="true"</c:otherwise></c:choose>>
