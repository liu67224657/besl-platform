...
<div id="div_post_text" style="display:none">
    <form action="${ctx}/json/content/post/text" method="post" id="posttext" onsubmit="return false;">
        ...
        <div class="editcon clearfix" id="editcon">
            ...
            <%--长文更长模式--%>
            <div class="unfold">
                <a href="javascript:void(0)" class="unfold_bd" id="edit_text_height" title="改为文章模式，支持发布更多内容">
        ...
        <div class="edit">
            ...
            <c:if test="${openSync}">
                    ...
                    <c:choose>
                        ...
                        <label for="publish_s"><span>同步</span></label><em class="install" id="text_syn_install"
                                                                          title="同步设置"></em>
                    </span>
                </c:if>
        </div>
