...
<div class="stab_hd clearfix">
    <ul class="stablist">
        <li>
            <a href="${URL_WWW}/group/${group.gameCode}/talk" >
                <span>讨论区</span>
            </a>
        </li>
        <li>
...
<div class="game-group-article">
    ...
    <div class="pagecon clearfix">
        <c:set var="pageurl" value="${URL_WWW}/group/${group.gameCode}/ess"/>
        <%@ include file="/views/jsp/page/page.jsp" %>
    </div>
    </c:when>
    <c:otherwise>
         <p style="line-height:120px; text-align:center"><fmt:message key="group.content.empty" bundle="${userProps}"/></p>
    </c:otherwise>
    </c:choose>
</div>
