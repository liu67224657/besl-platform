...
import com.enjoyf.webapps.joyme.dto.joymeapp.socialclient.WatermarkDTO;
 ...
 */
@Controller
@RequestMapping(value = "/socialapp/watermark")
public class SocialWatermarkController extends AbstractSocialAppBaseController {
    private Logger logger = Logger.getLogger(SocialWatermarkController.class);
    private static final int SOCIAL_WATERMARK_PAGE_SIZE = 30;
    ...
    public String list(HttpServletRequest request, HttpServletResponse response,
        ...
        NextPagination nextPagination = new NextPagination(startNum, SOCIAL_WATERMARK_PAGE_SIZE, next);
        try {
            NextPageRows<WatermarkDTO> result = socialClientWebLogic.querySocialWatermark(platform, nextPagination);
            if (result == null) {
