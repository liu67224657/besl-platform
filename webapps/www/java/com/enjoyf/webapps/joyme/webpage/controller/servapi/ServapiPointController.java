 ...
 */
@Controller
@RequestMapping(value = "/servapi/point")
public class ServapiPointController extends AbstractServApiController {
    ...
    private static final String FLAG = "*(%KDFSD__dfdsdf234s--4f";
    ...
    public String adjust(@RequestParam(value = "uid", required = false) String uidString,
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/adminadjust")
    ...
    public String sharePage(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (uid == -1 && StringUtil.isEmpty(appkey)) {
            return ResultCodeConstants.PARAM_EMPTY.getJsonString();
        }
        ...
        try {
            ...
            Map map = new HashMap();
            map.put("point", userPoint == null ? 0 : userPoint.getUserPoint());
