...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="100%" valign="top">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                 <%--target="_parent"--%>
                <form action="/viewline/lineedit" method="POST">
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
<%--                            <select name="locationCode" class="default_select_single" disabled="disabled">
                                <c:forEach items="${locationMap.keySet()}" var="locations">
                                    <option value="${locations}" <c:if test="${line.locationCode eq locations}">selected="true"</c:if>>
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <input name="displayOrder" type="text" class="default_input_singleline" size="10"
                                   maxlength="16" value="${line.displayOrder}"> * 值越小越靠前。
                        </td>
                    </tr>
                    <tr>
                        <td width="120" align="right" class="edit_table_defaulttitle_td">Line最小条数：</td>
                        <td nowrap class="edit_table_value_td">
                            <input rows="3" cols="100" name="itemMinCount" value="${line.itemMinCount}"
