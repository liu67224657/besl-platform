...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
    <form action="/viewline/addlineitem" method="post" name="addlineitemform" id="addlineitemform">
        ...
        <input name="lineItemTypeCode" type="hidden" value="${line.itemType.code}"/>
        <tr>
            <td width="120" align="right" class="edit_table_defaulttitle_td">博客域名：</td>
            <td class="edit_table_value_td">
                <input name="srcId1" type="input" class="default_input_singleline" size="16" maxlength="32">
            </td>
            <td width="120" align="right" class="edit_table_defaulttitle_td">或博客昵称：</td>
            <td class="edit_table_value_td">
                <input name="srcId2" type="input" class="default_input_singleline" size="16" maxlength="32">
            </td>
        </tr>
        <tr>
            <td width="120" align="right" class="edit_table_defaulttitle_td">[选填]：</td>
            <td colspan="3" class="edit_table_value_td">当有自定义需求时，可填下面内容</td>
        </tr>
        <tr>
