    ...
    <form action="/viewline/addlineitem" method="post" name="addlineitemform" id="addlineitemform">
        ...
        <tr>
            ...
            <td nowrap="" class="edit_table_value_td">
                <input type="text" value="" size="64" class="default_input_singleline" name="extrafield1">
            </td>
        </tr>
        <tr>
            <td width="120" align="right" class="edit_table_defaulttitle_td">扩展信息2：</td>
            <td nowrap="" class="edit_table_value_td">
                <input type="text" value="" size="64" class="default_input_singleline" name="extrafield2">
            </td>
        </tr>
        <tr>
            <td width="120" align="right" class="edit_table_defaulttitle_td">扩展信息3：</td>
            <td nowrap="" class="edit_table_value_td">
                <input type="text" value="" size="64" class="default_input_singleline" name="extrafield3">
            </td>
        </tr>
        <tr>
            <td width="120" align="right" class="edit_table_defaulttitle_td">扩展信息4：</td>
            <td nowrap="" class="edit_table_value_td">
                <input type="text" value="" size="64" class="default_input_singleline" name="extrafield4">
            </td>
        </tr>
        <tr>
            <td width="120" align="right" class="edit_table_defaulttitle_td">扩展信息5：</td>
            <td nowrap="" class="edit_table_value_td">
                <input type="text" value="" size="64" class="default_input_singleline" name="extrafield5">
            </td>
        </tr>
        <tr>
...
$(window).load(function() {
    ...
    $("#createNewImg1").click(function() {
        ...
        if (xAxias == '' && yAxias == '' && width == '' && heightvi == '') {
            alert("请选择一个区域");
