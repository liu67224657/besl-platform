    ...
    <tr class="list_table_even_tr" id="t${vst.index}">
        ...
        <td>
            ...
            <table width="100%">
                ...
                <tr>
                    <td><p>标题：<a target="_blank" href="${nonTopItem.viewLineItem.displayInfo.linkUrl}">
    ...
    <tr class="
        ...
        <td>
            <%--<table>--%>
                ...
                <%--</tr>--%>
            <%--</table>--%>
            <%--<div><b>显示标题</b>：${lineItem.viewLineItem.displayInfo.subject}</div>--%>
            <%--<div><b>显示连接</b>：<a href="${lineItem.viewLineItem.displayInfo.linkUrl}" target="_blank"/></div>--%>
            <%--<div><b>显示图片</b>：<img src="${uf:parseBFace(lineItem.viewLineItem.displayInfo.iconUrl)}" width="110px" height="110px"/></div>--%>
            <%--<div><b>显示描述</b>：${lineItem.viewLineItem.displayInfo.desc}</div>--%>
            ...
            <table width="100%">
                ...
                <tr>
                    <td><p>标题：<a target="_blank" href="${lineItem.viewLineItem.displayInfo.linkUrl}">
