...
<tr>
    <td height="22" class="page_navigation_td">>> 运营维护 >> <a
            href="/viewline/categorylist?aspectCode=${category.categoryAspect.code}">分类管理</a> >> 新建分类
    </td>
</tr>
<tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="list_table_header_td">新建分类</td>
    </tr>
    <tr>
...
<form action="/viewline/categorycreate" method="POST">
    <table width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
            ...
            <td class="edit_table_value_td">
                ...
                <c:if test="${errorMsgMap['categoryCodeMatch']!=null}">
                    <span class="error_msg_td"><fmt:message key="${errorMsgMap['categoryCodeMatch']}"
                                                            bundle="${error}"/></span><br>
                </c:if>
                        ...
                        <tr>
                            ...
                            <td nowrap class="edit_table_value_td">
                                <input id="subject" type="text" name="subject" class="default_input_singleline"
                                       size="64" onfocus="ss=setInterval(sp,600)" onblur="clearInterval(ss)"/>
...
jQuery(function ($) {
    var settings = {
        ...
        button_height: 22,
        //                button_text : '上传',
        //                button_text_style : 'background-url:/static/images/uploadbutton.jpg;width:76px;height:23px',
...
//                jcrop_api.setOptions(this.selectedIndex != 0 ? { aspectRatio: this.value } : { aspectRatio: 0 });
//                jcrop_api.focus();
//            });
    ...
    $("#createNewImg").click(function () {
        ...
        <%--//            $.post("/json/viewline/imgcropper",{filename:imgNew,x1:$("#x").val(),y1:$("#y").val(),w:$("#w").val(),h:$("#h").val(),at:$('#at').val()},--%>
        <%--//            function(data){--%>
        <%--//              alert(data)--%>
        <%--//            })--%>
