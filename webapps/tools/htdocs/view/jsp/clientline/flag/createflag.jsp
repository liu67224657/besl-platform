...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/clientline/flag/create" method="post" id="form_submit">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="flagdesc" size="30" id="input_text_desc" value="${flagDesc}"/> *必填项
                        </td>
                        <td height="1" align="left"></td>
                    </tr>
                    <c:if test="${flagType == clientLine}">
                        <tr>
                            <td height="1" class="default_line_td">
                                选择一条Line:
                            </td>
                            <td height="1">
                                <select name="lineid" id="selected_lineid">
                                    ...
                                    <c:forEach items="${lineList}" var="line">
                                        ...
                                        <c:if test="${line.lineId == lineId}">selected="selected"</c:if>>${line.lineName}&nbsp;&nbsp;${line.code}</option>
                                    </c:forEach>
                                </select>
                            </td>
                            ...
                            <td height="1">
                                <select name="lineid" id="selected_platform">
                                    ...
                                    <c:forEach items="${platforms}" var="pl">
                                        ...
                                        <c:if test="${pl.code == lineId}">selected="selected"</c:if>>
                            ...
                            <td height="1">
                                <select name="appid" id="selected_app">
                                    ...
                                    <c:forEach items="${appList}" var="app">
                                        <option value="${app.appId}" <c:if test="${app.appId == appId}">selected="selected"</c:if>>${app.appName}</option>
                                    </c:forEach>
                                </select>
                            </td>
                            <td height="1"></td>
