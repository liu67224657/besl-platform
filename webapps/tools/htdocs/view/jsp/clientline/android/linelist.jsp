...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营维护 >> 分类管理 >> 着迷大端AndroidClientLine列表</td>
    </tr>
    <tr>
        <td height="100%" valign="top"><br>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">大端ClientLine列表</td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    <td>
                        <form method="post" action="/clientline/android/list">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <p:privilege name="/clientline/android/list">
                    ...
                    <td>
                        <form method="post" action="/clientline/android/createpage">
                            <table>
                                <tr>
                                    <td>
            ...
            <form action="/clientline/android/list" method="post">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <c:when test="${list.size() > 0}">
                            <c:forEach items="${list}" var="line" varStatus="st">
                                <tr class="<c:choose><c:when test="${st.index % 2 == 0}">list_table_opp_tr</c:when><c:otherwise>list_table_even_tr</c:otherwise></c:choose>">
                                    ...
                                    <td nowrap align="left"><a href="/clientline/android/detail?lineid=${line.lineId}">${line.lineName}</a></td>
                                    ...
                                    <td nowrap align="left">
                                        <a href="/clientline/android/modifypage?lineid=${line.lineId}">编辑</a>
                                        <c:choose>
                                            <c:when test="${line.validStatus.code == 'valid'}">
                                                <a href="/clientline/android/delete?lineid=${line.lineId}">删除</a>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="/clientline/android/recover?lineid=${line.lineId}">激活</a>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                </tr>
                    ...
                    <c:if test="${page.maxPage > 1}">
                        <tr class="list_table_opp_tr">
                            <td colspan="13">
                                <pg:pager url="/clientline/android/list"
