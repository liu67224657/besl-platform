...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function back(aspectCode) {
            window.location.href = "/clientline/android/list";
        }

        function edit(lineId) {
            window.location.href = "/clientline/android/modifypage?lineid=" + lineId;
        }
    </script>
</head>
<body>
                ...
                <tr class="toolbar_tr">
                    <td>
                        <p:privilege name="/clientline/android/list">
                            <input name="Submit" type="submit" class="default_button" value="返回着迷大端ClientLine列表"
                                   onClick="back();">
                        </p:privilege>
                        <p:privilege name="/clientline/android/modifypage">
