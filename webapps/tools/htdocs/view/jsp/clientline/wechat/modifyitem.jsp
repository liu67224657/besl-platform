...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/wechat/line/item/modify" method="post" id="form_submit">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="text" name="title" size="60" id="input_title" value="${item.title}"/>*必填项
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <textarea name="desc" rows="8" cols="50" id="textarea_desc">${item.desc}</textarea>*必填项,不超过500字
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            ...
                            <input id="input_menu_pic" type="hidden" name="pic" value="${item.picUrl}">*必填项
                            <c:if test="${item.itemType.code == top}">640*200</c:if><c:if
                                test="${item.itemType.code == activity}">600*250</c:if>
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="">
                            <input id="input_url" type="text" size="80" name="url" value="${item.url}">*必填项
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="hot">
                                <option value="false"
                                <c:if test="${!item.param.isHot}">selected="selected"</c:if>>否</option>
                                <option value="true"
                                <c:if test="${item.param.isHot}">selected="selected"</c:if>>是</option>
                            </select>*必填项
                        </td>
                        <td height="1">
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="new" id="select_new">
                                <option value="false"
                                <c:if test="${!item.param.isNew}">selected="selected"</c:if>>否</option>
                                <option value="true"
                                <c:if test="${item.param.isNew}">selected="selected"</c:if>>是</option>
                            </select>*必填项
                        </td>
                        <td height="1">
                        </td>
