    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">微信论坛活动管理</td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    <td>
                        <form method="post" action="/wechat/line/list">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <p:privilege name="/wechat/line/list">
                    ...
                    <td>
                        <form method="post" action="/wechat/line/createpage">
                            <table>
                                <tr>
                                    <td>
            ...
            <form action="/wechat/line/list" method="post">
                        ...
                        <c:when test="${list.size() > 0}">
                            <c:forEach items="${list}" var="line" varStatus="st">
                                <tr class="<c:choose><c:when test="${st.index % 2 == 0}">list_table_opp_tr</c:when><c:otherwise>list_table_even_tr</c:otherwise></c:choose>">
                                    ...
                                    <td nowrap align="left"><a href="/wechat/line/detail?lineid=${line.lineId}">${line.lineName}</a></td>
                                    ...
                                    <td nowrap align="left">
                                        <a href="/wechat/line/modifypage?lineid=${line.lineId}">编辑</a>
                                        <c:choose>
                                            <c:when test="${line.validStatus.code == 'valid'}">
                                                <a href="/wechat/line/delete?lineid=${line.lineId}">删除</a>
                                            </c:when>
                                            <c:otherwise>
