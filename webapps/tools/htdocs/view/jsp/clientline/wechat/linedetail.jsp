...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function back(aspectCode) {
            window.location.href = "/wechat/line/list";
        }

        function edit(lineId) {
            window.location.href = "/wechat/line/modifypage?lineid=" + lineId;
        }
    </script>
</head>
<body>
                ...
                <tr class="toolbar_tr">
                    <td>
                        <p:privilege name="/wechat/line/list">
                            <input name="Submit" type="submit" class="default_button" value="返回"
                                   onClick="back();">
                        </p:privilege>
                        <p:privilege name="/wechat/line/modifypage">
            ...
            <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="height:100%" valign="top">
                        <iframe style="z-index: 1; width: 100%; height: 100%" src="/wechat/line/item/list?lineid=${clientLine.lineId}" frameBorder=0 scrolling=auto></iframe>
                    </td>
                </tr>
            </table>
        </td>
