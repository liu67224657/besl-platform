    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <table>
                <tr>
                    <td>
                        <form method="post" action="/clientline/iphone/guide/list">
                            <table>
                                <tr>
                    ...
                    <td>
                        <form method="post" action="/clientline/iphone/guide/createpage">
                            <table>
                                <tr>
                                    <td>
            ...
            <form action="/clientline/iphone/guide/list" method="post">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <c:when test="${list.size() > 0}">
                            <c:forEach items="${list}" var="line" varStatus="st">
                                <tr class="<c:choose><c:when test="${st.index % 2 == 0}">list_table_opp_tr</c:when><c:otherwise>list_table_even_tr</c:otherwise></c:choose>">
                                    ...
                                    <td nowrap align="left"><a href="/clientline/iphone/guide/detail?lineid=${line.lineId}">${line.lineName}</a></td>
                                    ...
                                    <td nowrap align="left">
                                        <a href="/clientline/iphone/guide/modifypage?lineid=${line.lineId}">编辑</a>
                                        <c:choose>
                                            <c:when test="${line.validStatus.code == 'valid'}">
                                                <a href="/clientline/iphone/guide/delete?lineid=${line.lineId}">删除</a>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="/clientline/iphone/guide/recover?lineid=${line.lineId}">激活</a>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                </tr>
                    ...
                    <c:if test="${page.maxPage > 1}">
                        <tr class="list_table_opp_tr">
                            <td colspan="13">
                                <pg:pager url="/clientline/iphone/guide/list"
