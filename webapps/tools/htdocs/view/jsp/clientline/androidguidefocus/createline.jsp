    ...
    <script>
        $().ready(function () {
            ...
            $('#form_submit').bind('submit', function () {
                ...
                var type = $('#select_angle').val();
                if (type.length == 0) {
                    alert("请选择角度");
                    return false;
                }
                var type = $('#smallpic').val();
                if (type.length == 0) {
                    alert("请上传小图");
                    return false;
                }
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/clientline/android/guidefocus/create" method="post" id="form_submit">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="text" name="linename" size="40" id="input_text_name"/> *必填项
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <input id="input_text_code" type="text" size="40" name="linecode">*必填项
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <select name="itemtype" id="select_type">
                                ...
                                <c:forEach items="${itemTypeCollection}" var="type">
                                    <option value="${type.code}"><fmt:message key="client.item.type.${type.code}"
                                                                              bundle="${def}"/></option>
                                </c:forEach>
                            </select>
                            *必填项
                        ...
                        <td height="1">
                            <select name="angular" id="select_angle">
                                ...
                                <c:forEach items="${itemAngleCollection}" var="angle">
                                    <option value="${angle.code}"><fmt:message key="client.item.angle.${angle.code}"
                                                                               bundle="${def}"/></option>
                                </c:forEach>
                            </select>
                            *必填项
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <textarea name="line_desc" rows="8" cols="50"></textarea>
                        </td>
                        <td height="1"></td>
                    </tr>
