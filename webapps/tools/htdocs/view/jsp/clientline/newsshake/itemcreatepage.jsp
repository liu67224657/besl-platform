...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/shake/line/item/create" method="post" id="form_submit" onsubmit="return checkClientLine()">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="text" name="itemname" size="32" id="input_text_name"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <input id="input_shakeweight" type="text" name="shakeweight">*0~1000整数，若为0不会进入权重库。
                        </td>
                        <td height="1"></td>
                    </tr>
                </table>
