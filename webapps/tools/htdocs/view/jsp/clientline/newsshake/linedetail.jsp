...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function back(aspectCode) {
            window.location.href = "/joymeapp/newsclient/shake/list";
        }

        function edit(lineId) {
            window.location.href = "/joymeapp/newsclient/shake/modifypage?lineid=" + lineId;
        }
    </script>
</head>
<body>
    ...
    <tr>
        <td valign="top"><br>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="toolbar_tr">
                    <td>
                        <p:privilege name="/joymeapp/newsclient/shake/list">
                            <input name="Submit" type="submit" class="default_button" value="返回摇一摇列表"
                                   onClick="back();">
                        </p:privilege>
                        <p:privilege name="/joymeapp/newsclient/shake/modifypage">
            ...
            <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="height:100%" valign="top">
                        <iframe style="z-index: 1; width: 100%; height: 100%" src="/shake/line/item/list?lineid=${clientLine.lineId}" frameBorder=0 scrolling=auto></iframe>
                    </td>
                </tr>
            </table>
        </td>
