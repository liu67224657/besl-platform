...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function back(aspectCode) {
            window.location.href = "/clientline/iphone/guidefocus/list";
        }

        function edit(lineId) {
            window.location.href = "/clientline/iphone/guidefocus/modifypage?lineid=" + lineId;
        }
    </script>
</head>
<body>
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">运营维护 >> <a
                href="/clientline/iphone/guidefocus/list"> 着迷攻略端ClientLine专题管理</a> >> ClientLine详细信息
        </td>
    </tr>
    <tr>
        <td valign="top"><br>
                ...
                <tr class="toolbar_tr">
                    <td>
                        <p:privilege name="/clientline/iphone/guidefocus/list">
                            <input name="Submit" type="submit" class="default_button" value="返回着迷攻略端ClientLine列表"
                                   onClick="back();">
                        </p:privilege>
                        <p:privilege name="/clientline/iphone/guidefocus/modifypage">
