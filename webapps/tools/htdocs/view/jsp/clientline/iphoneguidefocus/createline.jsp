...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/clientline/iphone/guidefocus/create" method="post" id="form_submit">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="text" name="linename" size="20" id="input_text_name"/> *必填项
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <input id="input_text_code" type="text" size="20" name="linecode">*必填项
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
