...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function back(aspectCode) {
            window.location.href = "/clientline/iphone/list";
        }

        function edit(lineId) {
            window.location.href = "/clientline/iphone/modifypage?lineid=" + lineId;
        }
    </script>
</head>
<body>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="toolbar_tr">
                    <td>
                        ...
                        <p:privilege name="/clientline/iphone/modifypage">
