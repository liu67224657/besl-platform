...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function back(aspectCode) {
            window.location.href = "/clientline/android/guide/list";
        }

        function edit(lineId) {
            window.location.href = "/clientline/android/guide/modifypage?lineid=" + lineId;
        }
    </script>
</head>
<body>
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">运营维护 >> <a
                href="/clientline/android/guide/list"> 着迷攻略端ClientLine管理</a> >> ClientLine详细信息
        </td>
    </tr>
    <tr>
        <td valign="top"><br>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="toolbar_tr">
                    <td>
                        ...
                        <p:privilege name="/clientline/android/guide/modifypage">
