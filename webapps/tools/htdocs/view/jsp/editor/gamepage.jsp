    ...
    <tr>
        <td height="100%" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="22" class="page_navigation_td">>> 编辑管理 >>> 游戏管理 >>> ${editor.editorName}</td>
                </tr>
            </table>
            <br>
            <table width="40%" border="0" cellspacing="0" cellpadding="0">
                <tr class="list_table_opp_tr">
                    ...
                    <td>
                         <p:privilege name="/editor/game/createpage">
                            &nbsp;&nbsp;&nbsp;&nbsp;<a href="/editor/game/createpage"> 录入游戏 </a>
                        </p:privilege>
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <c:forEach var="entry" varStatus="st" items="${list}">
                    <tr class="<c:choose>
                        ...
                        <td >
                            <p:privilege name="/editor/game/del">
                            <a href="/editor/game/del?itemno=${entry.itemNo}">删除</a>
                            </p:privilege>
                        </td>
                    </tr>
                </c:forEach>
