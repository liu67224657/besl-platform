    ...
    <tr>
        <td height="100%" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="22" class="page_navigation_td">>> 编辑管理 >>> 文章管理 >>> 文章录入</td>
                </tr>
            </table>
            <br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <form action="/editor/content/create" method="post">
                        ...
                        <td class="edit_table_value_td">
                            ...
                            <select name="subtype">
                                ...
                                <c:forEach var="subType" items="${subTypeList}">
                                    <option value="${subType.code}"><fmt:message key="def.editor.${subType.code}.name" bundle="${def}"/></option>
                                </c:forEach>
                            </select>
                        </td>
                        <td nowrap class="edit_table_value_td"></td>
