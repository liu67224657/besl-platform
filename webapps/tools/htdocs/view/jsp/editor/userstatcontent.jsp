        ...
        <td height="100%" valign="top">
            ...
            <table width="30%" border="0" cellspacing="0" cellpadding="0">
                <tr class="list_table_opp_tr">
                    <form action="/editor/user/stat/content" method="post">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr class="list_table_title_tr">
                    <td width="" align="left">文章链接</td>
                    <td width="15%" align="left">发布时间</td>
                    <td width="10%" align="left">类型</td>
                     <td width="10%" align="center">PV</td>
                    <td width="10%" align="center">UV</td>
                    <td width="10%" align="center">贡献下游PV</td>
                ...
                <c:forEach var="dto" varStatus="st" items="${list}">
                    ...
                    <td ><fmt:message key="def.editor.${dto.subType}.name" bundle="${def}"/></td>
