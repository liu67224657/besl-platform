    ...
    <tr>
        <td height="100%" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="22" class="page_navigation_td">>> 编辑管理 >>> 文章管理 >>> 游戏编辑</td>
                </tr>
            </table>
            <br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">游戏编辑</td>
                </tr>
            </table>
            ...
            <form action="/editor/game/modify" method="post">
                <table width="40%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td class="edit_table_value_td">
                            <input value="${editorItem.itemSubType}" name="subtype" size="40" class="default_input_singleline"/>
                        </td>
                        <td nowrap class="edit_table_value_td"></td>
                    </tr>
                    <tr>
