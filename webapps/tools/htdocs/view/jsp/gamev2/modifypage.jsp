...
<head>
    ...
    <script>
        $(document).ready(function () {
            ...
            WS({el: '#gametags',data:{
                <c:forEach var="tagObj" items="${game.gameTag}">
                    ${tagObj.tagName}:${tagObj.id},
                </c:forEach>
            }});
        });
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营维护 >> Joymewiki管理 >> 新版游戏资料库-修改游戏</td>
    </tr>
    <tr>
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">修改游戏</td>
                </tr>
            </table>
            <form action="/gamev2/modify" method="post" id="form_submit">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td">
                                <input type="text" id="name" value="${game.name}" name="name" class=""
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td">
                                <input type="text" id="aliasName" value="${game.aliasName}" name="aliasName" class=""
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td">
                                <textarea name="gameDesc" rows="8" cols="50">${game.gameDesc}</textarea>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td" id="uplaod_logo_container">
                                <img src="${game.gameLogo}" width="120px" height="120px" id="img_gameLogo"/>
                                <input type="hidden" name="gameLogo" value="${game.gameLogo}" id="hidden_gameLogo">
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td" colspan="2">
                                <table>
                                    <tr>
                                        <td>
                                            <img src="${pic1}" width="120px" height="120px" id="img_pic1"/><br/>
                                            <input type="hidden" name="pic1" value="${pic1}" id="hidden_pic1">
                                            <a href="#" id="but_pic1">上传游戏截图1</a>&nbsp;&nbsp;&nbsp;&nbsp;

                                            <a href="javascript:void(0);" <c:if test="${fn:length(pic1)==0}">style="display:none"</c:if> id="delpic1"
                                               data-button="1">删除截图1</a>
                                        </td>
                                        <td>
                                            <img src="${pic2}" width="120px" height="120px" id="img_pic2"/><br/>
                                            <input type="hidden" name="pic2" value="${pic2}" id="hidden_pic2">
                                            <a href="#" id="but_pic2">上传游戏截图2</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="javascript:void(0);" <c:if test="${fn:length(pic2)==0}">style="display:none"</c:if> id="delpic2"
                                               data-button="2">删除截图2</a>
                                        </td>
                                        <td>
                                            <img src="${pic3}" width="120px" height="120px" id="img_pic3"/><br/>
                                            <input type="hidden" name="pic3" value="${pic3}" id="hidden_pic3">
                                            <a href="#" id="but_pic3">上传游戏截图3</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="javascript:void(0);" <c:if test="${fn:length(pic3)==0}">style="display:none"</c:if> id="delpic3"
                                               data-button="3">删除截图3</a>
                                        </td>
                                        <td>
                                            <img src="${pic4}" width="120px" height="120px" id="img_pic4"/><br/>
                                            <input type="hidden" name="pic4" value="${pic4}" id="hidden_pic4">
                                            <a href="#" id="but_pic4">上传游戏截图4</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="javascript:void(0);" <c:if test="${fn:length(pic4)==0}">style="display:none"</c:if> id="delpic4"
                                               data-button="4">删除截图4</a>
                                        </td>
                                        <td>
                                            <img src="${pic5}" width="120px" height="120px" id="img_pic5"/><br/>
                                            <input type="hidden" name="pic5" value="${pic5}" id="hidden_pic5">
                                            <a href="#" id="but_pic5">上传游戏截图5</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="javascript:void(0);" <c:if test="${fn:length(pic5)==0}">style="display:none"</c:if> id="delpic5"
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td" >
                                <div>
                                    <input type="hidden" id="gametags" name="gameTag" value=""/>
                                </div>
                            </td>
                            ...
                            <td class="edit_table_value_td">
                                <select name="gameType">
                                    ...
                                    <c:forEach var="gtype" items="${gameType}">
                                        <option value="${gtype}"
                                                <c:if test="${gtype==game.gameType}">selected</c:if> >${gtype}</option>
                                    </c:forEach>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td">
                                <input type="text" id="gameDeveloper" value="${game.gameDeveloper}" name="gameDeveloper" class=""
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td">
                                <input type="text" id="gamePublisher" value="${game.gamePublisher}" name="gamePublisher" class=""
                            ...
                            <td class="edit_table_value_td">
                                <select name="operStatus">
                                    ...
                                    <c:forEach var="ops" items="${operStatus}">
                                        <option value="${ops}"
                                                <c:if test="${ops==game.operStatus}">selected</c:if> >${ops}</option>
                                    </c:forEach>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td">
                                <input type="radio" name="isOnline" value="true" <c:if test="${game.online}">checked</c:if>>是
                                <input type="radio" name="isOnline" value="false" <c:if test="${!game.online}">checked</c:if>>否
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td">
                                <input type="text" id="language" value="${language}" name="language" class=""
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td">
                                <input type="text" id="size" value="${game.size}" name="size" class=""
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td">
                                <input type="text" id="price" value="${game.price}" name="price" class=""
                            ...
                            <td class="edit_table_value_td" colspan="2">
                                <table>
                                    <tr>
                                        <td>是否是安卓：</td>
                                        <td>
                                            <input type="checkbox" value="true" name="android" <c:if test="${game.android}">checked</c:if>/>
                                        </td>
                                        <td>下载地址：</td>
                                        <td>
                                            <input type="text" value="${game.androidDownload}" name="androidDownload"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>是否是IOS：</td>
                                        <td>
                                            <input type="checkbox" value="true" name="ios" <c:if test="${game.ios}">checked</c:if>/>
                                        </td>
                                        <td>下载地址：</td>
                                        <td>
                                            <input type="text" value="${game.iosDownload}" name="iosDownload"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>是否是PC：</td>
                                        <td>
                                            <input type="checkbox" value="true" name="pc" <c:if test="${game.pc}">checked</c:if>/>
                                        </td>
                                        <td>下载地址：</td>
                                        <td>
                                            <input type="text" value="${game.pcDownload}" name="pcDownload"/>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="edit_table_value_td" colspan="2">
                                <table>
                                    <tr>
                                        <td>一句话推荐作者</td>
                                        <td><input name="recommendAuth" value="${game.recommendAuth}" placeholder="推荐作者"/></td>
                                        <td>一句话推荐</td>
                                        <td><input name="recommend" value="${game.recommend}" placeholder="一句话推荐"/></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
