    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        <form action="/apiwiki/gametag/list" method="post">
                            标签名称
                    ...
                    <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
                    <td>
                        <form action="/apiwiki/gametag/createpage" method="post">
            ...
            <table width="80%" border="0" cellspacing="1" cellpadding="0">
                            ...
                            <tr class="<c:choose><c:when test="${st.index % 2 == 0}">list_table_opp_tr</c:when><c:otherwise>list_table_even_tr</c:otherwise></c:choose>">
                                ...
                                <td nowrap align="center">
                                    <c:if test="${dto.gameSum>0}">
                                        <a href="/apiwiki/gametag/gamelist?id=${dto.id}">${dto.gameSum}</a>
                                    </c:if>
                                    <c:if test="${dto.gameSum<=0}">
                                        ${dto.gameSum}
                                    </c:if>
                                ...
                                <td nowrap align="center">
                                    ...
                                    <c:if test="${dto.validStatus=='invalid'}">
                                ...
                                <td nowrap align="center">
                                    <a href="/apiwiki/gametag/modifypage?id=${dto.id}">编辑</a>&nbsp;&nbsp;&nbsp;
                                    |
                                    <c:if test="${dto.validStatus=='valid'}">
                                        <a href="/apiwiki/gametag/valid?id=${dto.id}&valid=invalid">禁用</a>
                                    </c:if>
                                    <c:if test="${dto.validStatus=='invalid'}">
                                        <a href="/apiwiki/gametag/valid?id=${dto.id}&valid=valid">启用</a>
                                    </c:if>
                ...
                <c:if test="${page.maxPage > 1}">
                    <tr class="list_table_opp_tr">
                        <td colspan="6">
                            <pg:pager url="/apiwiki/gametag/list"
