    ...
    <tr>
        ...
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <form action="/apiwiki/vertualprofile/update" method="post" id="form">
                            <input type="hidden" name="uid" value="${vertualProfile.id}">
                            <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td class="edit_table_value_td">
                                        <input type="text" id="nick" name="nick" class="" value="${vertualProfile.nick}"
                                               placeholder="请输入昵称" maxlength="32" size="32" readonly/>
                                    </td>
                                    <td id="msg_nick" class="detail_table_value_td">*不能修改</td>
                                </tr>
                                <tr>
                                    <td class="edit_table_defaulttitle_td" width="100" height="1">头像</td>
                                    <td class="edit_table_value_td">
                                        <div id="container">
                                            <img id="imageUrl" src="${vertualProfile.icon}"/>
                                            <input type="hidden" name="icon" value="${vertualProfile.icon}" id="icon">
                                ...
                                <tr>
                                    ...
                                    <td class="edit_table_value_td">
                                        <input type="radio" value="1" name="sex" <c:if test="${vertualProfile.sex==1}">checked</c:if>>男
                                        <input type="radio" value="0" name="sex" <c:if test="${vertualProfile.sex==0}">checked</c:if>>女
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="edit_table_value_td">
                                        <textarea id="description" name="description" rows="8" cols="50">${vertualProfile.description}</textarea>
                                    </td>
