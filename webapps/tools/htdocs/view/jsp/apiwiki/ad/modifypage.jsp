    ...
    <tr>
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">编辑广告</td>
                </tr>
            </table>
            <form action="/apiwiki/ad/modify" method="post" id="form_submit">
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="index" type="text" name="index" size="48" value="${adExtendJson.index}"/>*必填项
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="input_menu_pic" type="hidden" name="pic" value="${advertise.pic}">*必填项<span
                                style="color:red">尺寸：640*360</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
