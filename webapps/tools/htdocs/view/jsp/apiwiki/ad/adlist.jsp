...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营维护 >> Joymewiki管理>> 广告</td>
    </tr>
    <tr>
        <td height="100%" valign="top"><br>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        <form action="/apiwiki/ad/list" method="post">
                            ...
                            平台 ${platform}：<select name="platform">
                    ...
                    <td>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
                    <td>
                        <form action="/apiwiki/ad/createpage" method="post">
            ...
            <table width="80%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr class="list_table_title_tr">
                    ...
                    <td nowrap align="center" width="70px">平台</td>
                    <td nowrap align="center">上架时间</td>
                    <td nowrap align="center">下架时间</td>
                    <td nowrap align="center" width="50px">位置</td>
                    ...
                    <c:when test="${list.size() > 0}">
                        <c:forEach items="${list}" var="dto" varStatus="st">
                            <tr class="<c:choose><c:when test="${st.index % 2 == 0}">list_table_opp_tr</c:when><c:otherwise>list_table_even_tr</c:otherwise></c:choose>">
                                ...
                                <td nowrap align="center">${dto.extend}</td>
                                <td nowrap align="center">
                                ...
                                <td nowrap align="center">
                                    <a href="/apiwiki/ad/modifypage?id=${dto.id}">编辑</a>&nbsp;&nbsp;&nbsp;
                                    <c:choose>
                                        <c:when test="${dto.removeStatus.code=='valid' || dto.removeStatus.code=='invalid' }">
                                            <a href="/apiwiki/ad/updatestatus?id=${dto.id}&removestatus=${removestatus}&platform=${platform}&status=removed&pageStartIndex=${pageStartIndex}">删除</a>
                                        </c:when>
                                        <c:otherwise>
                                            <c:choose>
                                                <c:when test="${now<dto.endTime}">
                                                    <a href="/apiwiki/ad/updatestatus?id=${dto.id}&removestatus=${removestatus}&platform=${platform}&status=valid&pageStartIndex=${pageStartIndex}">恢复</a>
                                                </c:when>
                                                <c:otherwise>
                                                    不可用
                                                </c:otherwise>
