    ...
    <tr>
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">广告</td>
                </tr>
            </table>
            <form action="/apiwiki/ad/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="title" type="text" name="title" size="80" value=""/>*必填项
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input id="index" type="text" name="index" size="48" value=""/>*必填项
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input type="radio" name="platform" value="-1"/>双端
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="target" type="text" name="target" size="80" value="" placeholder="链接过长请采用短链形式"/>
                            *必填项<span style="color:red">请不要填写包含#的URL</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <img id="menu_pic" src="/static/images/default.jpg" class="img_pic" width="200px"
                                 height="200px"/>
                            ...
                            <input id="input_menu_pic" type="hidden" name="pic" value="">*必填项<span style="color:red">尺寸：640*360</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
