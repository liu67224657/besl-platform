    ...
    <tr>
        ...
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <form action="/apiwiki/verifyprofile/update" method="post" id="form">
                            <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td class="edit_table_value_td">
                                        <input  type="hidden" name="uid" value="${verifyProfile.id}"/>
                                        <input type="text" id="nick"  value="${verifyProfile.nick}" name="nick" class=""  readonly placeholder="请输入用户的昵称" maxlength="32" size="32"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="edit_table_value_td">
                                        <input type="text" id="qq" name="qq"  value="${verifyProfile.qq}" class="" placeholder="请输入QQ号" maxlength="32" size="32"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="edit_table_value_td">
                                        <input type="text" id="mobile" value="${verifyProfile.mobile}" name="mobile" class="" placeholder="请输入手机号" maxlength="32" size="32"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="edit_table_value_td">
                                        <input type="text" id="microMsg" value="${verifyProfile.microMsg}"  name="microMsg" class="" placeholder="请输入微信号" maxlength="32" size="32"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="edit_table_value_td">
                                        <textarea id="verifyInfo"  name="verifyInfo" rows="8" cols="50">${verifyProfile.verifyInfo}</textarea>
                                    </td>
