    ...
    <tr>
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">添加推荐轮播图</td>
                </tr>
            </table>
            <form action="/apiwiki/slide/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="target" type="text" name="target" size="80" value="" placeholder="链接过长请采用短链形式"/>*必选项
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="input_menu_pic" type="hidden" name="pic" value="">*必填项<span style="color:red">尺寸：750*300</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
