    ...
    <script>
        ...
        $(document).ready(function () {
            $('#form_submit').bind('submit', function () {
                ...
                if($.trim(lotteryAwardRuleCountType)==""){
                    alert('请填写奖品次数类型');
                    return false;
                }
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/lottery/award/create" method="post" id="form_submit">
                    ...
                    <tr>
                        ...
                        <c:if test="${lottery.lotteryRule.lotteryRuleActionType.code==1}">
                            ...
                            <td height="1" class="" width="10">
                                ...
                                &nbsp;——&nbsp;
                                <input type="text" name="maxrate" size="20" id="input_text_max" onblur="checkRate();"/>
                            </td>
                            <td height="1">*必填项</td>
                        </c:if>
