...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营管理 >> 条目管理 >> 添加彩票</td>
    </tr>
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">添加彩票</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
            ...
            <form action="/ticket/menu/createticket" method="post" id="form_submit" onsubmit="return checkticket()">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="text" name="ticketname" size="20" id="input_text_name"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="text" class="Wdate"
                                   onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:00:00',vel:'starttime',autoPickDate:true})"
                                   readonly="readonly"/>
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="text" class="Wdate"
                                   onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:00:00',vel:'endtime',autoPickDate:true})"
                                   readonly="readonly"/>
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <select name="wintype" id="input_text_wintype" onchange="changetype();">
                                ...
                                <option value="0">手动开奖</option>
                                <option value="1">自动开奖</option>
                            </select>

                            <div style="display:none;" id="wintimediv">
                                请选择开奖日期：<input type="text" class="Wdate"
                                               onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:00:00',vel:'wintime',autoPickDate:true})"
                                               readonly="readonly" autoPickDate="true" id="wintimetext"/>
                                <input type="hidden" name="wintime" id="wintime">
                            </div>
                        </td>
