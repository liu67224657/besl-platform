...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营管理 >> 条目管理 >> 添加彩票奖品</td>
    </tr>
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">添加彩票奖品</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
            ...
            <form action="/ticket/award/createticketaward" method="post" id="form_submit"
                ...
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="hidden" value="${ticketId}" name="ticketId" size="20"
                    ...
                    <tr>
                        ...
                        <td height="1">
                            ...
                            <input id="input_hid_awardpic" type="hidden" name="awardPic">
                        </td>
                        ...
                        <td height="1" class="" width="10">
                            <select name="awardLevel" id="awardlevel">
                                ...
                                <c:forEach items="${awardLevel}" var="al">
                                    <option value="${al}"><fmt:message key="lottery.award.level.${al}"
                                                                       bundle="${def}"/></option>
                                </c:forEach>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="text" onkeyup="value = value.replace(/\D|^0/g, '');" name="awardCount"
                                   id="awardcount"/>
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            ...
                            <input type="text" onkeyup="value = value.replace(/\D|^0/g, '');" id="currentcount"
                                   name="currentCount"/>
                        </td>
