...
<tr>
    ...
    <td height="1" class="edit_table_defaulttitle_td">
        <select name="rtype" id="select_rtype">
            ...
            <option value="6"
                    <c:if test="${msgDTO.pushMessage.options.list.get(0).type == 6}">selected="selected"</c:if>>打开wap页
            </option>
        </select><span style="color: red">*必选项</span>
    </td>
    <td height="1">
...
<c:if test="${pushListType == 0}">
    ...
    <tr>
        ...
        <td height="1">
            <textarea id="textarea_nemas" name="screennames" cols="60" rows="10">${screenNames}</textarea>
            *多个用户昵称之间用空格" "隔开
        </td>
        <td height="1">
        </td>
