...
<tr>
    <td height="22" class="page_navigation_td">>> 运营管理 >> 条目管理 >> 通知管理</td>
</tr>
<tr>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
            ...
            <td height="1" class="edit_table_defaulttitle_td">
                <select name="rtype" id="select_rtype">
                    ...
                    <option value="4"
                    <c:if test="${4==redirectType}">selected="selected"</c:if>>打开文章页</option>
                    <option value="5"
                    <c:if test="${5==redirectType}">selected="selected"</c:if>>打开活动页</option>
                    <option value="6"
                    <c:if test="${6==redirectType}">selected="selected"</c:if>>打开wap页</option>
                </select><span style="color: red">*必选项</span>
            </td>
            <td height="1">
            </td>
        ...
        <c:if test="${pushListType == 0}">
            ...
            <tr>
                ...
                <td height="1">
                    <textarea id="textarea_nemas" name="screennames" cols="60" rows="10"></textarea>
                    *多个用户昵称之间用空格" "隔开
                </td>
                <td height="1">
                </td>
            ...
            <tr>
                ...
                <td height="1">
                    <input id="senddate" name="senddate" value=""
