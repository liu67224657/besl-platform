    ...
    <tr>
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">添加背景音乐</td>
                </tr>
            </table>
            <form action="/joymeapp/social/bgaudio/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_name" type="text" name="audioname" size="48" value="${audioName}"/>*必填项
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${fn:length(audioPic) > 0}"><img id="img_pic"
                                                                               src="${audioPic}"
                            ...
                            <input id="input_pic" type="hidden" name="audiopic" value="${audioPic}">*必填项(100px * 100px)
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_singer" type="text" name="singer" size="48" value="${singer}"/>
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <span id="div_mp3_src" style="width: 300px;height: 70px">
                                <c:if test="${fn:length(mp3Src) > 0}">
                                    <audio controls="controls">
                                        <source src="${mp3Src}" type="audio/mpeg">
                                        <embed src="${mp3Src}" controls="console" align="middle" loop="false"
                                               autostart="false"
                                               width="300"
                                               height="30"></embed>
                                    </audio>
                            ...
                            <span id="loading" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
                            <input id="input_mp3_src" type="hidden" name="mp3src" value="${mp3Src}">*必填项
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <span id="div_wav_src" style="width: 300px;height: 70px">
                                <c:if test="${fn:length(wavSrc) > 0}">
                                    <audio controls="controls">
                                        <source src="${wavSrc}" type="audio/mpeg">
                                        <embed src="${wavSrc}" controls="console" align="middle" loop="false"
                                               autostart="false"
                                               width="300"
                                               height="30"></embed>
                                    </audio>
                            ...
                            <span id="loading2" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
                            <input id="input_wav_src" type="hidden" name="wavsrc" value="${wavSrc}">
                        </td>
                        <td height="1">
                        </td>
                    </tr>
