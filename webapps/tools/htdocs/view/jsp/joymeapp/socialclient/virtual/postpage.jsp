    ...
    <tr>
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">文章发布</td>
                </tr>
            </table>
            <form action="/joymeapp/socialclient/virtual/postcontent" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="audiotime" id="input_audiotime" value="${audiotime}"/>*必填项,单位：（毫秒）
                        </td>
                        <td height="1">
                        </td>
                    </tr>
