...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营管理 >> APP广告管理 >> 修改虚拟用户</td>
    </tr>
    <tr>
        <td valign="top"><br>
            ...
            <form action="/joymeapp/socialclient/virtual/modify" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <input id="virtualId" type="hidden" name="virtualId" size="48"
                           value="${accountVirtual.virtual_id}"/>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="screenName" type="text" name="screenName" size="48"
                                   value="${profile.blog.screenName}"/><span style="color:red;">*必填项</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input readonly="readonly" type="text" class="default_input_singleline" size="16"
                                   maxlength="20"
                                   name="birthday" id="birthday" value="${profile.detail.birthday}"/><span
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="radio" name="sex" value="1" <c:if test="${profile.detail.sex==1}">checked="checked"</c:if>
                            />男
                            <input type="radio" name="sex" value="0" <c:if test="${profile.detail.sex==0}">checked="checked"</c:if>/>女
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
