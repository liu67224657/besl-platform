...
<form action="/joymeapp/social/activity/create" method="post" id="form_submit">
...
<tr>
    ...
    <td height="1">
        <textarea id="input_description" type="text" name="description"
                  style="height: 100px;width: 300px">${description}</textarea>*必填项
    </td>
    <td height="1">
    </td>
</tr>
<tr>
    ...
    <td>
        ...
        <input id="input_ios_icon" type="hidden" name="iosicon" value="${iosIcon}">*必填项(500px * 500px)
    </td>
    <td height="1">
    </td>
</tr>
...
<tr>
    ...
    <td>
        <c:choose>
            <c:when test="${fn:length(iosSmallPic) > 0}"><img id="ios_small_pic" src="${iosSmallPic}"
                                                              class="img_pic"/></c:when>
        ...
        <span id="upload_button3" class="upload_button">上传</span>
                            <span id="loading3" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
        <input id="input_ios_small_pic" type="hidden" name="iossmallpic" value="${iosSmallPic}">*必填项(285px * 200px)
    </td>
    <td height="1">
    </td>
</tr>
<tr>
    ...
    <td>
        <c:choose>
            <c:when test="${fn:length(androidSmallPic) > 0}"><img id="android_small_pic" src="${androidSmallPic}"
                                                                  class="img_pic"/></c:when>
        ...
        <span id="upload_button4" class="upload_button">上传</span>
                            <span id="loading4" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
        <input id="input_android_small_pic" type="hidden" name="androidsmallpic" value="${androidSmallPic}">
    </td>
    <td height="1">
    </td>
</tr>
<tr>
    ...
    <td>
        <c:choose>
            <c:when test="${fn:length(iosBigPic) > 0}"><img id="ios_big_pic" src="${iosBigPic}"
                                                            class="img_pic"/></c:when>
        ...
        <span id="upload_button5" class="upload_button">上传</span>
                            <span id="loading5" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
        <input id="input_ios_big_pic" type="hidden" name="iosbigpic" value="${iosBigPic}">*必填项(580px * 200px)
    </td>
    <td height="1">
    </td>
</tr>
<tr>
    ...
    <td>
        <c:choose>
            <c:when test="${fn:length(androidBigPic) > 0}"><img id="android_big_pic" src="${androidBigPic}"
                                                                class="img_pic"/></c:when>
        ...
        <span id="upload_button6" class="upload_button">上传</span>
                            <span id="loading6" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
        <input id="input_android_big_pic" type="hidden" name="androidbigpic" value="${androidBigPic}">
    </td>
    <td height="1">
    </td>
</tr>
    ...
    <td height="1">
        <select name="shareid" id="select_shareid">
            ...
            <c:forEach items="${shareInfoList}" var="share">
                ...
                <c:if test="${share.shareId == shareId}">selected="selected"</c:if>>
                ${share.shareKey}
                </option>
            </c:forEach>
        </select>
...
<tr>
    ...
    <td height="1">
        <select name="retype" id="select_retype">
            <option value="0"
            <c:if test="${reType == 0}">selected="selected"</c:if>>WEBVIEW</option>
            <option value="1"
            <c:if test="${reType == 1}">selected="selected"</c:if>>NATIVE</option>
        </select>
    </td>
    <td height="1" class=>
    </td>
...
<tr>
    ...
    <td height="1">
        <input type="text" name="reurl" size="64" value="${reUrl}"/>
    </td>
    <td height="1" class=>
    </td>
</tr>
    ...
    <td height="1" id="td_awards">
        <table id="table_award_1" name="table_award" bgcolor="#e0ffff">
            <tr>
                ...
                <td>
                    <input type="text" size="48" name="name" id="input_text_name_1"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" size="48" name="name" id="input_text_level_1"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" size="48" name="name" id="input_text_total_1"/>
                </td>
            </tr>
            <tr>
