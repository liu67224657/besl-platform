...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营管理 >> 条目管理 >> 修改消息推送</td>
    </tr>
    <tr>
        <td height="100%" valign="top"><br>
            <table width="30%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">修改消息推送</td>
                    <td class="">
                        <form></form>
                    </td>
                </tr>
            ...
            <form action="/joymeapp/pushmessage/modify" method="post" id="form_submit">
                <input type="hidden" name="msgid" value="${pushMessage.pushMessage.pushMsgId}"/>
                <input type="hidden" name="appkey" value="${pushMessage.pushMessage.appKey}"/>
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <c:choose>
                                <c:when test="${fn:length(pushMessage.pushMessage.msgIcon)>0}"><img id="img_icon"
                                                                                                    src="${pushMessage.pushMessage.msgIcon}"/></c:when>
                                <c:otherwise><img id="img_icon" src="/static/images/default.jpg"/></c:otherwise>
                            </c:choose>

                            <span id="upload_button">上传</span>
                            <span id="loading" style="display:none"><img src="/static/images/loading.gif"/></span>
                            <input id="msg_icon" type="hidden" name="icon" value="${pushMessage.pushMessage.msgIcon}">
                        </td>
                        <td height="1" class="edit_table_defaulttitle_td">
                    ...
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <input id="msg_subject" type="text" name="subject"
                                   value="${pushMessage.pushMessage.msgSubject}">
                        </td>
                        <td height="1" class="edit_table_defaulttitle_td">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <input id="msg_message" type="text" name="shortmessage"
                                   value="${pushMessage.pushMessage.shortMessage}">*不能超过20个字，负责苹果服务器会拒绝推送
                        </td>
                        <td height="1" class="edit_table_defaulttitle_td">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <input id="url" type="text" name="url" size="32"
                                   value="${pushMessage.pushMessage.options.list.get(0).info}">
                        </td>
                        <td height="1" class="edit_table_defaulttitle_td">
                        </td>
                    </tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <select name="type" id='redirecttype'>
                                ...
                                <c:forEach var="type" items="${typeCollection}">
                                    ...
                                    <c:if test="${type.code == pushMessage.pushMessage.options.list.get(0).type}">selected="selected"</c:if>>
                                    <fmt:message key="client.item.redirect.${type.code}" bundle="${def}"/>
                                    </option>
                                </c:forEach>
                            </select>
                        </td>
