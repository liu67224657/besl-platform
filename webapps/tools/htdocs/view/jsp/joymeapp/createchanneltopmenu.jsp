    ...
    <form action="" method="post" id="form_submit">
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
                ...
                <td height="1">
                    <input type="text" name="name" id="input_text_name" size="48"/>
                </td>
                <td height="1" class=>
                </td>
            </tr>
            <tr>
                ...
                <td height="1">
                    <input type="text" name="menuurl" id="input_text_mewnurl" size="48"/>
                </td>
                <td height="1" class=>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td height="1">
                    <input type="text" name="desc" id="input_text_desc" size="48"/>
                </td>
                <td height="1" class=>
                </td>
            </tr>
