...
<tr>
    ...
    <td height="1" class="edit_table_defaulttitle_td">
        <select name="rtype" id="select_rtype">
            ...
            <option value="4"
                    <c:if test="${msgDTO.pushMessage.options.list.get(0).type == 4}">selected="selected"</c:if>>WEBVIEW
            </option>
            <option value="9"
                    <c:if test="${msgDTO.pushMessage.options.list.get(0).type == 9}">selected="selected"</c:if>>下载
            </option>
        </select><span style="color: red">*必选项</span>
    </td>
    <td height="1">
