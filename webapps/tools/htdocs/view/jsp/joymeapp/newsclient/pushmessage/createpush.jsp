...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营维护 >> 手游画报 >> 手游画报消息推送列表</td>
    </tr>
<tr>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr>
                    ...
                    <td height="1">
                        <textarea id="input_sortmsg" name="shortmessage" cols="40"
                                  rows="5">${shortMessage}</textarea><span style="color: red">*必填项</span>
                    </td>
                    <td height="1">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td height="1" class="edit_table_defaulttitle_td">
                        <select name="rtype" id="select_rtype">
                            ...
                            <option value="1"
                            <c:if test="${1==redirectType}">selected="selected"</c:if>>native文章页</option>
                            <option value="2"
                            <c:if test="${2==redirectType}">selected="selected"</c:if>>native栏目列表页</option>
                            <option value="4"
                            <c:if test="${4==redirectType}">selected="selected"</c:if>>WEBVIEW</option>
                            <option value="9"
                            <c:if test="${9==redirectType}">selected="selected"</c:if>>下载</option>
                        </select><span style="color: red">*必选项</span>
                    </td>
                    <td height="1">
                    </td>
                ...
                <tr>
                    ...
                    <td height="1">
                        ...
                        如果是纯文本，可以不填
                        <br/>1.4.0版本之后，支持栏目列表页，如果是跳转到栏目列表页，请填写栏目的ID。
                        <br/><span style="color: red">1.4.0版本之后，cms文章native单页跳转，android填syhbao/pingguoduan/201408/2549463.html，ios填syhb2/pingguoduan/201408/2549463.html</span>
                    </td>
                    <td height="1">
                    </td>
                </tr>
