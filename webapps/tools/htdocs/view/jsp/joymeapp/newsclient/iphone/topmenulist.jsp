...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营维护 >> 着迷APP >> 着迷新闻端Iphone首页轮播图</td>
    </tr>
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <table>
                <tr>
                    <td>
                        <form action="/joymeapp/newsclient/topmenu/iphone/list" method="post">
                            <table width="100%">
                                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <form action="/joymeapp/newsclient/topmenu/iphone/createpage" method="post">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <c:forEach items="${list}" var="dto" varStatus="st">
                            <tr class="<c:choose><c:when test="${st.index % 2 == 0}">list_table_opp_tr</c:when><c:otherwise>list_table_even_tr</c:otherwise></c:choose>">
                                ...
                                <td nowrap><fmt:message key="joymeapp.menu.status.${dto.activityTopMenu.isHot}"
                                                        bundle="${def}"/></td>
                                <td nowrap>
                                    <a href="/joymeapp/newsclient/topmenu/iphone/sort/up?activitytopmenuid=${dto.activityTopMenu.activityTopMenuId}"><img
                                            src="/static/images/icon/up.gif"></a>
                                    <a href="/joymeapp/newsclient/topmenu/iphone/sort/down?activitytopmenuid=${dto.activityTopMenu.activityTopMenuId}"><img
                                ...
                                <td nowrap>
                                    <a href="/joymeapp/newsclient/topmenu/iphone/modifypage?activitytopmenuid=${dto.activityTopMenu.activityTopMenuId}">编辑</a>&nbsp;
                                    <c:choose>
                                        <c:when test="${dto.activityTopMenu.validStatus.code eq 'valid'}">
                                            <a href="/joymeapp/newsclient/topmenu/iphone/delete?activitytopmenuid=${dto.activityTopMenu.activityTopMenuId}">删除</a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="/joymeapp/newsclient/topmenu/iphone/recover?activitytopmenuid=${dto.activityTopMenu.activityTopMenuId}">恢复</a>
                                        </c:otherwise>
                                    </c:choose>
                ...
                <c:if test="${page.maxPage > 1}">
                    <tr class="list_table_opp_tr">
                        <td colspan="10">
                            <pg:pager url="/joymeapp/newsclient/topmenu/iphone/list"
