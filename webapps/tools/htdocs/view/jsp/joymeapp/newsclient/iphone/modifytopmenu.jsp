...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top"><br>
            ...
            <form action="/joymeapp/newsclient/topmenu/iphone/modify" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <td height="1">
                            <select name="menutype" id="select_menutype">
                                ...
                                <c:forEach items="${menuTypes}" var="type">
                                    ...
                                    <c:if test="${type.code == activityTopMenu.redirectType}">selected="selected"</c:if>>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_desc" type="text" name="menudesc" size="48"
                                   value="${activityTopMenu.menuDesc}"/>*必填项
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
