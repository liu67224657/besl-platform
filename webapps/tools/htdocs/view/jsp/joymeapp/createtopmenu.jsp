    ...
    <script>
        $().ready(function () {
            ...
            $('#input_add_channel_menu').click(function () {
                $('#table_add_channel_button').before('<iframe src="/joymeapp/channeltopmenu/createpage" id="iframe" width="100%" frameborder="no" scrolling="no" marginheight="0" onload="Javascript:SetWinHeight(this)"></iframe>');
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top"><br>
            ...
            <form action="/joymeapp/topmenu/create" method="post" id="form_submit" onsubmit="return isNotNull();">
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_menuName" type="text" name="menuname" size="48" value=""/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_url" type="text" name="url" size="48" value=""/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="gameid" value=""/><span style="color: #ff0000;">*注：优酷游戏中心合作项目idfa上报，绑定的游戏</span>
                        </td>
                    </tr>
                    <tr>
                        <td height="1" class="default_line_td" width="100">
