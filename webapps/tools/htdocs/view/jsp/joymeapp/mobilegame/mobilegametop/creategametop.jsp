...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/mobile/top/create" method="post" id="form_submit">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        <td height="1"> 类型：<select onchange="itemtypeChange();" name="itemtype">
                            ...
                            <option value="4">手游排行榜</option>
                            <option value="7">推广</option>
                        </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="text" name="linename" size="32" id="input_text_name"/> *排行榜必填 推广可不填
                            例:（恋爱类手游排行榜）
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <input id="input_text_code" type="text" size="32" name="linecode"><span style="color:red">必填且不可重复（英文、下划线、数字） </span>
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="">
                            <textarea cols="55" rows="20" name="intro"></textarea><span
                                style="color:red">排行榜必填 推广可不填 </span>
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr id="linedesc">
                        ...
                        <td height="1" class="">
                            <textarea cols="55" rows="20" name="linedesc"></textarea><span style="color:red">必填 </span>
                        </td>
                        <td height="1"></td>
                    </tr>
                    ...
                    <tr id="pic2">
                        ...
                        <td>
                            ...
                            <span id="loading2" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
                            <input id="input_menu_pic2" type="hidden" name="picurl2" value="">*必填项
                            <span style="color: #ff0000;">*(根据情况选择图片，不做死要求,注意尺寸）</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    ...
                    <tr id="pic3">
                        ...
                        <td>
                            <img id="menu_pic3" src="/static/images/default.jpg" class="img_pic"/>
                            <span id="upload_button3" class="upload_button">上传</span>
                            <span id="loading3" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
                            <input id="input_menu_pic3" type="hidden" name="picurl3" value="">*必填项
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            ...
                            *必填项 <span style="color: #ff0000;">如果选择双平台 会在IOS和Android各生成一条记录</span>
                        </td>
                        <td height="1" align="left"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            ...
                            *必填项 <span style="color: #ff0000;">广告请选推广 </span>
                        </td>
                        <td height="1" align="left"></td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <c:if test="${fn:length(errorMsg)>0}">
                                <span style="color: red" id="span_name_exist">${errorMsg}</span>
                            </c:if>
                        </td>
                    </tr>
