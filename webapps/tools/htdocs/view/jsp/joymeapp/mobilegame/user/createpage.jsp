    ...
    <tr>
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">新增用户</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <form action="/joymeapp/mobilegame/virtual/create/${accountVirtualType}" method="post" id="form_submit">
                <input id="accountVirtualType" type="hidden" name="accountVirtualType" value="${accountVirtualType}"/>
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="screenname" type="text" name="screenname" size="48"/><span
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="picurl1" type="hidden" name="picurl1" ><span
                                style="color:red;">*必填项</span>
                        </td>
                        <td height="1">
                        </td>
