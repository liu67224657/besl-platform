        ...
        $().ready(function () {
            ...
            $('#form_submit').bind('submit', function () {
                ...
                if ($("#sharedomain").val() == "def") {
                    if (activityid != "") {
                        alert("第三方平台为默认，ID不需要填写。");
                        return false;
                    }
                }
                if($("#sharedomain").val() != "def" && share_type==5) {
                   if(activityid==""){
                       alert("请需要ID。");
                       return false;
                   }
    ...
    <tr>
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">新增大动漫分享</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <form action="/joymeapp/anime/share/create" method="post" id="form_submit">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <textarea id="body" type="text" name="body"
                                      style="height: 100px;width: 575px">${socialShare.body}</textarea><span style="color: red">标签:{body} 内容 {url} 链接</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                        ...
                        <td height="1" class="">
                            <select name="sharedomain" id="sharedomain">
                                ...
                                <c:forEach var="type" items="${accountDomainList}">
                                    <option value="${type.code}" <c:if test="${type.code==socialShare.sharedomain.code}">selected='selected'</c:if>><fmt:message key="social.share.third.type.${type.code}" bundle="${def}"/></option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
