            ...
            <form action="/joymeapp/anime/tag/modify" method="post" id="form_submit">
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="ch_name" type="text" name="ch_name" size="48" value="${animeTag.ch_name}"/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input id="en_name" type="text" name="en_name" size="48" value="${animeTag.en_name}"/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                        ...
                        <td height="1" class="">
                            ...
                            <select name="search_type" style="width: 81px">
                                <c:forEach var="stype" items="${animeTagSearchType}">
                                    <c:if test="${animeTag.animeTagSearchType.code==stype.code}">
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <c:forEach var="type" items="${animeTagModel}">
                                <c:if test="${animeTag.animeTagModel.code==type.code}">
                                    <input type="radio" name="model" checked="checked" value='${type.code}'/><fmt:message key="anime.tag.model.${type.code}" bundle="${def}"/>
                                 </c:if>
                                <c:if test="${animeTag.animeTagModel.code!=type.code}">
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <c:forEach var="type" items="${animeTagType}">
                                <c:if test="${animeTag.animeTagType.code==type.code}">
<input type="radio" name="type" checked="checked"  value='${type.code}'/><fmt:message key="anime.tag.type.${type.code}" bundle="${def}"/>
                                </c:if>
                                <c:if test="${animeTag.animeTagType.code!=type.code}">
<input type="radio" name="type"  value='${type.code}'/><fmt:message key="anime.tag.type.${type.code}" bundle="${def}"/>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="volume" type="text" name="volume" size="48" value="${animeTag.volume}"/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <textarea id="ch_desc" type="text" name="ch_desc"
                                      style="height: 80px;width: 431px">${animeTag.ch_desc}</textarea>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <textarea id="en_desc" type="text" name="en_desc"
                                      style="height: 80px;width: 431px">${animeTag.en_desc}</textarea
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
