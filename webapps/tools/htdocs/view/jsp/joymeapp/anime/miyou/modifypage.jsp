...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top"><br>
            ...
            <form action="/animetag/miyou/modify" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        <td height="1" colspan="3" class="default_line_td">
                            <input type="hidden" name="tagid" size="48" value="${animeTag.tag_id}"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="tagname" size="48" value="${animeTag.tag_name}" maxlength="10"/>
                            *必填项 最多10个字
                        </td>
                        <td height="1" class=>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <textarea rows="10" cols="50" maxlength="20" name="tagdesc">${animeTag.tag_desc}</textarea>*必填项  最多20个字
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="pepolenum" value="${animeTag.total_sum}"  onkeyup="value=value.replace(/[^\d]/g,'')"/> *必填项
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${empty animeTag.picjson.ios}">
                                    <img id="menu_pic" src="/static/images/default.jpg" class="img_pic"/>
                                </c:when>
                                <c:otherwise>
                                    <img id="menu_pic" src="${animeTag.picjson.ios}" class="img_pic"/>
                                </c:otherwise>
                            </c:choose>
                            ...
                            <input id="input_menu_pic" type="hidden" name="picurl" value="${animeTag.picjson.ios}"><span
                                style="color: red">*必填项  120*120 不超过15KB</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
