...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top"><br>
            ...
            <form action="/anime/index/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_menuname" type="text" name="linename" size="48" value=""/>*必填项
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <select name="code" id="codeselect">
                                ...
                                <option value="0">追番</option>
                                <option value="1">事典</option>
                                <option value="2">海湾</option>
                            </select>*请选择，<b style="color:red">注意每个页面在每个平台里只可存在一个</b>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            ...
                            <input type="text" name="wikinum" id="wikinum" style="display:none;"/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="superscript" id="superscript"/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="input_menu_pic" type="hidden" name="picurl" value=""><span style="color: red">*必填项，图片尺寸：558px * 376px</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="linkurl" id="linkurl"/>如果选择的是跳转<b style="color:red;">追番</b>请填写<b
                                style="color:red;">标签的ID</b>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
