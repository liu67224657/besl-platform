...
<form action="/joymeapp/push/create" method="post" id="form_submit">
    <table width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
            ...
            <td height="1">
                <textarea id="input_sortmsg" name="shortmessage" cols="40" rows="5"></textarea><span style="color: red">*必填项</span>
        ...
        <c:if test="${pushListType == 0}">
            ...
            <tr>
                ...
                <td height="1">
                    <input type="radio" name="sound" value="default" checked="checked">系统默认&nbsp;
        ...
        <tr>
            ...
            <td height="1" class="edit_table_defaulttitle_td">
                <select name="rtype" id="select_rtype">
                    <option value="0">打开应用</option>
                    <option value="1">专题视频列表</option>
                    <option value="2">专题图文列表</option>
                    <option value="3">wap直达</option>
                    <option value="4">专题文字列表</option>
                    <option value="5">海湾首页</option>
                    <option value="6">追番首页</option>
                    <option value="7">追番详情页</option>
                    <option value="8">事典wap打开</option>
                    <option value="9">消息中心小红点</option>
                </select><span style="color: red">*必选项</span>
            </td>
            <td height="1">
            </td>
        ...
        <tr>
            ...
            <td height="1">
                <input id="input_info" type="text" name="info" size="64"/><a href="http://www.surl.sinaapp.com/"
