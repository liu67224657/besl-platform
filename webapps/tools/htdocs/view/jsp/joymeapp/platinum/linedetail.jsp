...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function back(aspectCode) {
            window.location.href = "/platinum/list";
        }

        function edit(lineId) {
            window.location.href = "/platinum/modifypage?lineid=" + lineId;
        }
    </script>
</head>
<body>
                ...
                <tr class="toolbar_tr">
                    <td>
                        <p:privilege name="/platinum/list">
                            <input name="Submit" type="submit" class="default_button" value="返回APP精选推荐列表"
                                   onClick="back();">
                        </p:privilege>
                        <p:privilege name="/platinum/modifypage">
                ...
                <tr>
                    <td style="height:100%" valign="top">
                        <iframe style="z-index: 1; width: 100%; height: 100%"
                                src="/platinum/item/list?lineid=${clientLine.lineId}" frameBorder=0
