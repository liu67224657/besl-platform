    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">APP推荐墙列表</td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    <td>
                        <form method="post" action="/platinum/list">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <p:privilege name="/platinum/list">
                    ...
                    <td>
                        <form method="post" action="/platinum/createpage">
                            <table>
                                <tr>
                                    <td>
                                        <p:privilege name="/platinum/createpage">
                                        <input type="submit" name="button" class="default_button" value="添加"/>
                                        </p:privilege>
                                    <td>
                                <tr>
                            </table>
            ...
            <form action="/platinum/list" method="post">
                            ...
                            <c:forEach items="${list}" var="line" varStatus="st">
                                <tr class="<c:choose><c:when test="${st.index % 2 == 0}">list_table_opp_tr</c:when><c:otherwise>list_table_even_tr</c:otherwise></c:choose>">
                                    ...
                                    <td nowrap align="left"><a
                                            href="/platinum/detail?lineid=${line.lineId}">${line.lineName}</a></td>
                                    ...
                                    <td nowrap align="left">
                                        <a href="/platinum/modifypage?lineid=${line.lineId}">编辑</a>
                                        <c:choose>
                                            <c:when test="${line.validStatus.code == 'valid'}">
                                                <a href="/platinum/delete?lineid=${line.lineId}">删除</a>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="/platinum/recover?lineid=${line.lineId}">激活</a>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                </tr>
