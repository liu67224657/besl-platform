...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/platinum/item/create" method="post" id="form_submit">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <textarea name="desc" rows="8" cols="50" id="textarea_desc">${desc}</textarea>*必填项
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                    ...
                    <%--<option value="${type.code}" <c:if test="${type.code == redirectType}">selected="selected"</c:if>><fmt:message--%>
                    <%--key="platinum.item.redirect.${type.code}"--%>
                    <%--bundle="${def}"/></option>--%>
                    <%--</c:forEach>--%>
                    <%--</select>--%>
                    <%--</td>--%>
                    ...
                    <c:choose>
                        <c:when test="${itemType == apps}">
                            <tr>
                                ...
                                <td height="1">
                                    <input type="text" name="size" value="${size}" id="input_size"/>*必填项
                                </td>
                                <td height="1">
                                </td>
                            </tr>
                        </c:when>
                        <c:when test="${itemType == events}">
                            <tr>
                                <td height="1" class="default_line_td">
                                    有效时间:
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="hot" id="select_hot">
                                        <option value="false"
                                        <c:if test="${!hot}">selected="selected"</c:if>>否</option>
                                        <option value="true"
                                        <c:if test="${hot}">selected="selected"</c:if>>是</option>
                                    </select>*必填项
                                </td>
                                <td height="1">
                                </td>
