    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">添加APP版本</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
            ...
            <form action="/joymeapp/updatecontent/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <input type="text" name="version_url" size="70" id="input_text_version_url"/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <select name="packagetype" id="select_packagetype">
                                ...
                                <c:forEach var="packageType" items="${packageTypes}">
                                    <option value="${packageType.code}"><fmt:message key="joymeapp.contentversion.packagetype.${packageType.code}" bundle="${def}"/></option>
                                </c:forEach>
                            </select>
                        </td>
                        <td height="1" class=>
