                            ...
                            <select name="platform" id="select_platform" onchange="getVersion()" disabled="disabled">
                                ...
                                <c:choose>
                                    <c:when test="${pushListType ==0}">
                                        ...
                                        <option value="2"
                                                <c:if test="${msgDTO.pushMessage.appPlatform.code == 2}">selected="selected"</c:if>>
                                            IOS-企业版
                                        </option>
                                    </c:when>
                  ...
                  rows="5" disabled="disabled">${msgDTO.pushMessage.shortMessage}</textarea>
                    ...
                    <c:if test="${pushListType == 0}">
                        <tr>
                            ...
                            <td height="1">
                                <input id="input_badge" type="text" name="badge" value="${msgDTO.pushMessage.badge}"
                                       disabled="disabled"/>*应用右上角的消息数目，通常为0或1
                            </td>
                            <td height="1">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="1">
                                <input type="radio" name="sound" value="default"
                                       <c:if test="${msgDTO.pushMessage.sound == 'default'}">checked="checked"</c:if>
                                       disabled="disabled"/>系统默认&nbsp;
                                <input type="radio" name="sound" value=""
                                       <c:if test="${msgDTO.pushMessage.sound == ''}">checked="checked"</c:if>
                                       disabled="disabled"/>无&nbsp;
                            </td>
                            <td height="1">
                            </td>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            ...
                            打开应用/首页 可不填，剧集详情 填写完整详情页http://地址，专题列表 填写"1"或"2"，"1"--更多，"2"--专题
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    <c:if test="${pushListType == 0}">
                        <tr>
                            ...
                            <td height="1" id="td_version">
                                <input type="checkbox" id="all_version" onclick="checkAllVersion($(this))"
                                       disabled="disabled"/>全选
                                <input type="checkbox" id="inverse_version" onclick="checkInverseVersion()"
                                       disabled="disabled"/>反选<br/>
                        ...
                        <tr>
                            ...
                            <td height="1">
                                <input type="checkbox" id="all_channel" onclick="checkAllChannel($(this))"
                                       disabled="disabled"/>全选
                                <input type="checkbox" id="inverse_channel" onclick="checkInverseChannel()"
                                       disabled="disabled"/>反选<br/>
