                    ...
                    <tr>
                        ...
                        <td height="1">
                            <select name="platform" id="select_platform" onchange="getVersion()">
                                ...
                                <option value="0"
                                        <c:if test="${0==platform}">selected="selected"</c:if>>IOS
                                </option>
                                <option value="1"
                                        <c:if test="${1==platform}">selected="selected"</c:if>>安卓
                                </option>
                    ...
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <select name="rtype" id="select_rtype">
                                <option value="0"
                                        <c:if test="${0==redirectType}">selected="selected"</c:if>>打开应用
                                </option>
                                <option value="1"
                                        <c:if test="${1==redirectType}">selected="selected"</c:if>>首页
                                </option>
                                <option value="2"
                                        <c:if test="${2==redirectType}">selected="selected"</c:if>>专题列表
                                </option>
                                <option value="3"
                                        <c:if test="${3==redirectType}">selected="selected"</c:if>>剧集详情
                                </option>
                                <option value="4"
                                        <c:if test="${4==redirectType}">selected="selected"</c:if>>积分墙
                                </option>
                                <option value="5"
                                        <c:if test="${5==redirectType}">selected="selected"</c:if>>看看模块
                                </option>
                            </select><span style="color: red">*必选项</span>
                        </td>
                        <td height="1">
