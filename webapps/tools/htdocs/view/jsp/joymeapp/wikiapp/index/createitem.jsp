...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td valign="top"><br>
            ...
            <form action="/joymeapp/wikiapp/index/item/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr id="tr_title">
                        ...
                        <td height="1">
                            <input type="text" name="title" value="${title}" id="input_title"/>*必填项
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    <tr id="tr_desc">
                        ...
                        <td height="1">
                            <textarea id="textarea_desc" type="text" name="desc"
                                      style="height: 100px;width: 600px">${desc}</textarea>
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <img id="img_icon" src="${fn:length(picUrl) > 0 ? picUrl : '/static/images/default.jpg'}"/>
                            ...
                            <input id="msg_icon" type="hidden" name="picurl" value="${picUrl}">*选填
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                        ...
                        <td height="1">
                            <select id="select_redirect" name="redirecttype">
                                ...
                                <c:forEach items="${redirectTypeSet}" var="redirect">
                                    <option value="${redirect.code}" <c:if test="${redirect.code == redirectType}">selected="selected"</c:if>>
