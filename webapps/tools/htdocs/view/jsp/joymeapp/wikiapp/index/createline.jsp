    ...
    <tr>
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">添加首页模块</td>
                </tr>
            </table>
            <form action="/joymeapp/wikiapp/index/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="linename" value="${lineName}" id="input_linename"/>*必填项
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="linecode" value="${lineCode}" placeholder="wikiapp_{自定义英文单词、缩写、简拼}"
                                   id="input_linecode" size="50"/>*必填项
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            ...
                            <input id="msg_icon" type="hidden" name="bigpic">*选填
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                        ...
                        <td height="1">
                            <select id="select_platform" name="platform">
                                ...
                                <c:forEach items="${platformSet}" var="plat">
                                    <option value="${plat.code}" <c:if test="${plat.code == platform}">selected="selected"</c:if>>
