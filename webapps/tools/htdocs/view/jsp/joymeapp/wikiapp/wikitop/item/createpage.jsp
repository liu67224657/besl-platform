    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">新增wikitop</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
            ...
            <form action="/wiki/top/item/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="wikiname" size="32" id="wikiname"/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="wikikey" size="32" id="wikikey"/> <span style="color:red;">必填 wiki的key,如op、mt</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="url" size="32" id="url"/> <span
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="category" size="32" id="category"/> <span style="color:red;">标签，不填不显示</span>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="rate" size="32" id="rate"/><span
                                style="color:red;">必填，热度作为排序字段请填写数字</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
