    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">修改提示板</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <form action="/joymeapp/tips/modify" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        <td height="1" colspan="3" class="default_line_td">
                            <input type="hidden" name="tid" value="${tips.tipsId}"/>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="title" size="32" id="input_text_title" value="${tips.tipsTitle}"/>暂时不用填
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <textarea name="description" id="input_text_description" rows="8"
                                      cols="50">${tips.tipsDescription}</textarea>*必填项
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" class="default_input_singleline" size="16" maxlength="20"
                                   name="updatetime" id="updatetime" value="<fmt:formatDate value="${tips.updateTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>*必填项
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="url" size="32" id="input_text_url" value="${tips.tipsUrl}"/>暂时不用填
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                        ...
                        <td height="1">
                            <select name="appid" id="select_appid">
                                ...
                                <c:forEach items="${appList}" var="app">
                                    <c:choose>
                                        <c:when test="${app.appId == tips.appId}">
                        ...
                        <td height="1">
                            <select name="platform">
                                <c:forEach var="plat" items="${platformList}">
                                    <c:choose>
                                        <c:when test="${plat.code == tips.platform}">
