...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/joymeapp/client/menu/create" method="post" id="form_submit">
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <c:if test="${pid > 0}">
                        <tr>
                            ...
                            <td height="1">
                                <textarea cols="30" rows="5" id="textarea_desc" name="menudesc"></textarea>
                            </td>
                            <td height="1" class=>
                            </td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_ji" type="text" name="ji" size="32" value=""/>
                    ...
                    <c:if test="${pid > 0}">
                            ...
                            <td height="1">
                                <select name="displaytype" id="displayTypes">
                                    <c:forEach var="display" items="${displaySet}">
                                        <option value="${display.code}"><fmt:message
                                                key="joymeapp.menu.displaytype.${display.code}" bundle="${def}"/></option>
                                    </c:forEach>
                                </select>
                            </td>
                            <td height="1" class=>
                            ...
                            <td height="1" class="">
                                <select name="contenttype">
                                    ...
                                    <c:forEach items="${contentSet}" var="content">
                                        <option value="${content.code}"><fmt:message key="app.menu.content.type.${content.code}"
                                                                                   bundle="${def}"/>
                                        </option>
                                    </c:forEach>
                                </select>
                        ...
                        <tr>
                            ...
                            <td height="1">
                                <textarea cols="30" rows="5" id="textarea_expdesc" name="expdesc"></textarea>
                            </td>
                            <td height="1" class=>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="1">
                                <input type="text" name="author" id="input_author" value=""/>
                            </td>
                            <td height="1" class=>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="1">
                                <input type="text" name="star" id="input_star" value=""/>
                            </td>
                            <td height="1" class=>
                            </td>
                        </tr>
