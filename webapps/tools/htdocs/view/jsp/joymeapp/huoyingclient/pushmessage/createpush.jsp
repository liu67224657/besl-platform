...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营维护 >> 手游画报 >> 火影迷消息中心列表</td>
    </tr>
<tr>
        ...
        <form action="/joymeapp/push/create" method="post" id="form_submit">
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr>
                    ...
                    <td height="1" class="edit_table_defaulttitle_td">
                        <select name="rtype" id="select_rtype">
                            ...
                            <option value="1"
                            <c:if test="${1==redirectType}">selected="selected"</c:if>>影片详情</option>
                            <option value="2"
                            <c:if test="${2==redirectType}">selected="selected"</c:if>>首屏专题/更多</option>
                            <option value="3"
                            <c:if test="${3==redirectType}">selected="selected"</c:if>>订阅列表</option>
                        </select><span style="color: red">*必选项</span>
                    </td>
                    <td height="1">
                    </td>
                ...
                <tr>
                    ...
                    <td height="1">
                        <input id="input_info" type="text" name="info" size="64" value="${info}"/><a
                            href="http://www.surl.sinaapp.com/"
                            target="_blank">短链接工具</a><br/>
                        打开应用/订阅列表可不填，影片详情填写完整详情页http://地址，首屏专题/更多填写"1"或"2"，"1"--更多，"2"--专题
                    </td>
                    <td height="1">
                    </td>
                </tr>
