    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">修改论坛</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <form action="/joymeapp/bbs/modify" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        <td height="1" colspan="3" class="default_line_td">
                            ...
                            <input type="hidden" name="bid" value="${appBBS.deploymentId}"/>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="path" size="32" id="input_text_path" value="${appBBS.path}"/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                        ...
                        <td height="1">
                            <select name="appkey" id="select_appkey">
                                ...
                                <c:forEach items="${appList}" var="app">
                                    <option value="${app.appId}" <c:if test="${app.appId == appBBS.appkey}">selected="selected"</c:if>>${app.appName}</option>
                                </c:forEach>
                            </select>
                        </td>
                        <td height="1" class=>
                        ...
                        <td height="1">
                            <select name="platform">
                                <c:forEach var="plat" items="${platformList}">
                                    <option value="${plat.code}" <c:if test="${plat.code == appBBS.appPlatform.code}">selected="selected"</c:if>>
