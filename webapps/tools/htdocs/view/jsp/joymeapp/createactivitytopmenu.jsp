...
<tr>
    <td valign="top"><br>
        ...
        <form action="/joymeapp/activitytopmenu/create" method="post" id="form_submit">
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <td height="1">
                        <select name="redirect" id="select_redirecttype">
                            ...
                            <c:forEach items="${redirectTypes}" var="re">
                                <option value="${re.code}"><fmt:message key="client.item.redirect.${re.code}"
                                                                        bundle="${def}"/></option>
                            </c:forEach>
                ...
                <tr>
                    ...
                    <td height="1">
                        <textarea id="input_text_desc" type="text" name="menudesc"
                                  style="height: 100px;width: 300px"></textarea>*必填项
                ...
                <tr>
                    ...
                    <td height="1">
                        <input type="text" name="author" size="48" value=""/>
                ...
                <tr>
                    ...
                    <td height="1">
                        <select name="platform" id="select_platform">
                            ...
                            <option value="0"><fmt:message key="joymeapp.platform.0" bundle="${def}"/></option>
                            <option value="1"><fmt:message key="joymeapp.platform.1" bundle="${def}"/></option>
                        </select>*必填项
                    </td>
                    <td height="1" class=>
                    </td>
