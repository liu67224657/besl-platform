    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table width="30%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">创建礼包中心开关</td>
                    <td class="">
                        <form></form>
                    </td>
                </tr>
            ...
            <form action="/joymeapp/giftopen/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_appname" type="text" name="appname" size="64">*必填
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_version" type="text" name="version" size="64">*必填
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                        ...
                        <td height="1">
                            <select name="platform" id="select_platform">
                                ...
                                <c:forEach var="platform" items="${platforms}">
                                    <option value="${platform}"><fmt:message
                                            key="joymeapp.platform.${platform}" bundle="${def}"/></option>
                                </c:forEach>
