...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/joymeapp/menu/thirdmodify" method="get" id="form_submit" onsubmit="return isNotNull();">
                        ...
                        <td height="1" class="">
                            <select name="displayType" id="displayType">
                                ...
                                <option value="${dtype.code}"
                                        <c:if test="${dtype.code==joymeAppMenu.displayType.code}">selected</c:if>>
                            ...
                            <tr>
                                ...
                                <td height="1" class="">
                                    <input type="text" name="recomstar" id="input_recomstar"
                                           value="${joymeAppMenu.recommendStar}"/>*1 -- 5之间的数字
                                </td>
                                <td height="1" class=>
                                </td>
                            </tr>
