    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        $(document).ready(function () {
            $('#form_submit').bind('submit', function () {
                ...
                var type = $.trim($("#redirecttype").val());
                if (type == '') {
                    alert("请选择跳转类型");
                    return false;
                }
                ...
                if ((type == '4' && isNaN(url)) || (type == '5' && isNaN(url))) {
                    alert("跳转链接请填写数字");
                    return false;
                }
                if (type == '6' && url.indexOf("http") < 0) {
                    alert("请填写正确地址");
                    return false;
                }
            });
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/joymeapp/social/pushmessage/create" method="post" id="form_submit">
                            ...
                            <select name="type" id="redirecttype">
                                ...
                                <c:forEach var="type" items="${typeCollection}">
                                    <option value="${type.code}"><fmt:message
                                            key="social.client.item.redirect.${type.code}"
                                            bundle="${def}"/></option>
                                </c:forEach>
                            </select>
                        </td>
