    ...
    <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            $("#submit").click(function () {
                ...
                if (packageName == '') {
                    alert("请填写包名或者bundle id,然后再点击提交!");
                    return false;
                } else if (appName == '') {
                    alert("请填写app在Wap页面显示的名字,然后再点击提交!");
                    return false;
                }
                /*       else if (verName == '') {
                 alert("请填写app在wap页面显示的版本,然后再点击提交!");
                 return false;
                 }*/
                else if (appIcon == '') {
                    alert("请上传app的icon!");
                    ...
                    alert("请填写app的描述,然后再点击提交!");
                    return false;
                } else if (downloadUrl == '') {
                    alert("请填写下载的URL,然后再点击提交!");
                    return false;
                } else if (initScore == '' || initScore == 0 || isNaN(initScore)) {
                    alert("请正确填写app下载后默认可以获得的积分值,注意不要填0");
                    return false;
                } else {
                    $("#form_submit").submit();
                }
    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">编辑app信息</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <form action="/point/pointwall/app/modify" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="appId" size="32" readonly="readonly" disabled="disabled"
                                   value="<c:out value='${appId}' escapeXml='true' />"/>*不可修改
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="packageName" size="32" id="packageName"
                                   value="<c:out value='${packageName}' escapeXml='true' />"/>*必填项(此名字在热门应用中不能重复）
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <img id="menu_pic" src="${appIcon}" class="img_pic"/>
                            ...
                            <input id="input_menu_pic" type="hidden" name="appIcon" value="${appIcon}"><span
                                style="color: red">*必填项，图片尺寸：558px * 376px</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
