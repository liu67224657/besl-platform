...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/point/goodsseckill/modify" method="post" id="form_submit">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        <td>
                            <input type="hidden" name="seckillid" value="${goodsSeckill.seckillId}"/>
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <input id="goodsid" type="text" name="goodsid" value="${goodsSeckill.goodsId}">
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="">
                            <input id="title" type="text" name="title" value="${goodsSeckill.seckillTitle}">
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="">
                            <textarea id="desc" name="desc" rows="3" cols="20">${goodsSeckill.seckillDesc}</textarea>
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <c:choose>
                                <c:when test="${fn:length(goodsSeckill.seckillPic)>0}">
                                    <img id="img_pic" src="${goodsSeckill.seckillPic}"/>
                                </c:when>
                                <c:otherwise>
                            ...
                            <input id="input_hid_goodsPic" type="hidden" name="pic" value="${goodsSeckill.seckillPic}">
                        </td>
                    </tr>
                    <tr>
                        <td height="1" class="default_line_td">
                        ...
                        <td height="1" class="">
                            <input type="text" class="Wdate"
                                   ...
                                   value="<fmt:formatDate value='${goodsSeckill.startTime}' pattern='yyyy-MM-dd HH:mm:ss' type='both'/>"/>
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="">
                            <input type="text" class="Wdate"
                                   ...
                                   value="<fmt:formatDate value='${goodsSeckill.endTime}' pattern='yyyy-MM-dd HH:mm:ss' type='both'/>"/>
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="">
                            <input type="text" name="total" value="${goodsSeckill.seckillTotal}" readonly>
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="">
                            <input type="text" name="incrtotal" value="">
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="">
                            <input type="text" name="seckillsum" value="${goodsSeckill.seckillSum}" readonly>
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="">
                            开始前：<input id="beforetips" type="text" name="beforetips" value="${goodsSeckill.seckillTips.beforeTips}"><br/>
                            进行中：<input id="intips" type="text" name="intips" value="${goodsSeckill.seckillTips.inTips}"><br/>
                            结束后：<input id="aftertips" type="text" name="aftertips" value="${goodsSeckill.seckillTips.afterTips}">
                        </td>
                        <td height="1"></td>
                    </tr>
                    <tr>
