    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#form_batch_create').submit(function() {
                ...
                var allowCreateSize = $('#goods_restamount').val() - 0;
...
<body>
<form id="form_batch_create" name="batch_create" action="/point/exchangegoodsitem/create" method="post">
                    ...
                    <tr>
                        ...
                        <td class="edit_table_value_td">
                            <table>
                                <tr>
                                    <td colspan="2">
                                        激活码名称&nbsp;&nbsp;：<b>${goods.activitySubject}</b>
                                        <input id="goodsid" name="goodsid" type="hidden" value="${goods.activityGoodsId}"/>
                                        激活码总数：<input id="goods_amount" name="restAmount" type="text" readonly=""
                                                     size="10" value="${goods.goodsAmount}"/>
                                        还能导入激活码数量：<input id="goods_restamount" name="restAmount" type="text" readonly=""
                                                         size="10" value="${goods.goodsAmount-goods.goodsResetAmount}"/>
                                        导入类别：
                                        <select id="optiontype" name="optiontype">
                                            <option value="">请选择</option>
                                            <option value="1">第一次导入激活码</option>
                                            <option value="2">补仓</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
