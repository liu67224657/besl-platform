...
<head>
    ...
    <title>后台数据管理-运营管理-话题条目管理</title>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (resultJson.status_code == '1') {
                        alert("该游戏话题主名称已经存在，请重新输入！");
                    } else {
                        alert("该游戏话题主名称不存在,可以使用！");
                    }
                }
            });
        }
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> <a href="/gameresource/gametopiclist"> 条目维护</a> >>编辑话题条目</td>
    </tr>
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">编辑话题条目</td>
                </tr>
                <td align="center">
                </td>
            </table>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <form name="form1" action="/gameresource/editgametopic" method="POST" onsubmit="return checkForm();">
                    ...
                    <tr>
                        <td width="120" align="right" class="edit_table_defaulttitle_td">话题条目主名称：</td>
                        <td class="edit_table_value_td">
                            ...
                            <font color="red">*</font>
                            <input type="hidden" name="resourceDomain" id="resourceDomain" value="topic"
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <c:if test="${errorMsgMap['icon']!=null}">
                                <span class="error_msg_td"><fmt:message key="${errorMsgMap['icon']}"
                                                                        bundle="${error}"/></span><br>
                            </c:if>
                            <c:choose>
        ...
        <span id="loading_thumimg" style="display:none">
            <img src="/static/images/loading.gif"/>
                    ...
                    <tr>
                        <td width="120" align="right" class="edit_table_defaulttitle_td">话题简介：</td>
                        <td nowrap class="edit_table_value_td">
                            <textarea rows="5" cols="100" name="resourceDesc" id="resourceDesc"
                                      class="default_input_singleline">${entity.resourceDesc}</textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <textarea rows="5" cols="100" name="seokeywords"
                                      class="default_input_singleline">${entity.seoKeyWords}</textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <textarea rows="5" cols="100" name="seodesc"
                                      class="default_input_singleline">${entity.seoDescription}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td height="1" colspan="4" class="default_line_td"></td>
