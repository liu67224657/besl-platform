    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <form action="/gameresource/privacy/create" method="POST">
                    ...
                    <tr>
                        ...
                        <td class="edit_table_value_td">
                            <input name="screenname" type="text" class="default_input_singleline" size="24" maxlength="50" value="${screename}" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <select name="level">
                                <c:forEach items="${privacyLevelList}" var="privacyLevel">
                                    <option value="${privacyLevel.code}" <c:if test="${levelCode eq privacyLevel.code}">selected="selected"</c:if>>
