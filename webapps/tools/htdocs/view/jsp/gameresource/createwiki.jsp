...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营维护 >> <a href="/wiki/=list">WIKI条目维护</a> >> 创建WIKI条目
        </td>
    </tr>
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">创建WIKI条目</td>
                    <td align="left">
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <form name="form1" action="/wiki/create" method="POST" onsubmit="return checkForm();">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="edit_table_value_td">
                            ...
                            <input name="wikiName" type="text" class="default_input_singleline" id="wikiName"
                                   value="${entity.wikiName}" size="24" maxlength="32">
                    ...
                    <tr>
                        ...
                        <td class="edit_table_value_td">
                            <input name="wikiCode" type="text" class="default_input_singleline" id="wikiCode"
                                   value="${entity.wikiCode}" size="32" maxlength="32">
                    ...
                    <tr>
                        ...
                        <td class="edit_table_value_td">
                            <input name="wikiUrl" type="text" class="default_input_singleline" id="wikiUrl"
                                   value="${entity.wikiUrl}" size="100" maxlength="100">
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            ...
                            <font color="red">*</font>
                            <input name="thumbicon" type="hidden" value="${thumbIcon}" id="thumbicon">
                        </td>
                        <td nowrap class="edit_table_value_td"></td>
                    </tr>
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <textarea rows="5" cols="100" name="wikiDesc" class="default_input_singleline"></textarea>
                        </td>
                    </tr>
