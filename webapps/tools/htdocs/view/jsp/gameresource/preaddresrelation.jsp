...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="100%" valign="top">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <form action="/gameresource/addresrelation" method="POST">
                            ...
                            <select name="relationType" class="default_select_single">
                                <c:forEach items="${relationTypes}" var="relationtype">
                                    <option value="${relationtype.code}">
                                        <fmt:message key="gameres.relation.type.${relationtype.code}.name" bundle="${def}"/>
                                    </option>
                                </c:forEach>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            ...
                            <input name="relationName" type="text" class="default_input_singleline" >
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            ...
                            <input name="relationValue" type="text" class="default_input_singleline" >
                        </td>
                    </tr>
                    <tr>
                        <td width="120" align="right" class="edit_table_notnulltitle_td">排序值：</td>
                        <td nowrap class="edit_table_value_td">
                            <input type="text" name="sortNum" class="default_input_singleline"> *必须是数字
                        </td>
                    </tr>
                    <tr>
