...
//                }
                ...
                if ($('input[name=mplatform]:checked').size() <= 0 && $('input[name=pcplatform]:checked').size() <= 0 && $('input[name=pspplatform]:checked').size() <= 0 && $('input[name=tvplatform]:checked').size() <= 0) {
                    alert('请选择平台！');
                    return false;
                }
            ...
            $("input[name='tvplatform']").click(function () {
                var clickVal = $(this).val();
                var checkStatus = $(this).prop("checked");
                if (clickVal == 5) { //xboxone
                    if (checkStatus == true) {
                        $("#xboxoneDownload_config").show();
                    } else {
                        $("#xboxoneDownload_config").hide();
                    }
                }

                if (clickVal == 2) {//PS4
                    if (checkStatus == true) {
                        $("#ps4Download_config").show();
                    } else {
                        $("#ps4Download_config").hide();
                    }
                }
            });
...
<table width="100%" height="90%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/gamedb/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            手机游戏： <c:forEach var="mplat" items="${mPlatforms}">
                            <c:if test="${mplat.code!=2}">
                                <input type="checkbox" onchange="showDownTr()" value="${mplat.code}" name="mplatform"
                            ...
                            <c:forEach var="pcplat" items="${pcPlatforms}">
                                <input type="checkbox" onchange="showPcConfigTr()" value="${pcplat.code}"
                                       name="pcplatform"
                    ...
                    <tr id="ios_download" style="display:none">
                        <td height="1" class="default_line_td">
                            iOS下载 ：
                        </td>
                        <td height="1">
                    ...
                    <tr id="android_download" style="display:none">
                        <td height="1" class="default_line_td">
                            Android下载 ：
                        </td>
                        <td height="1">
                    ...
                    <%--                         <tr>
                                                ...
                                                <td height="1">
                                                    <input type="text" name="wpdownload" id="wpdownload" value="${gameDb.wpDownload}"/>
                                                </td>
                                                <td height="1" class=></td>
                                            </tr> --%>
                    <tr id="pc_config_1" style="display:none">
                        <td height="1" class="default_line_td">
                            最低配置 ：
                        </td>
                        <td height="1">
                    ...
                    <tr id="pc_config_2" style="display:none">
                        <td height="1" class="default_line_td">
                            推荐配置 ：
                        </td>
                        <td height="1">
                    ...
                    <tr id="pc_config_3" style="display:none">
                        <td height="1" class="default_line_td">
                            PC下载地址 ：
                        </td>
                        <td height="1">
                    ...
                    <tr id="ps4Download_config" style="display:none">
                        <td height="1" class="default_line_td">
                            PS4下载地址 ：
                        </td>
                        <td height="1">
                    ...
                    <tr id="xboxoneDownload_config" style="display:none">
                        <td height="1" class="default_line_td">
                            Xboxone下载地址 ：
                        </td>
                        <td height="1">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input size="100" name="gamevideo" value="${gameDb.gameVideo}"/>
                        </td>
                        <td height="1" class=></td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                                ...
                                <c:when test="${not empty gamePicList}">
                                    <c:forEach items="${gamePicList}" var="pic" varStatus="picindex">
                                        <span style="padding-left:15px;" id="gamepic${picindex.index+1}"
                                            ...
                                            <img src="${pic}" name="gamepicurl" width="115" height="209"/>
                                        </span>
                                    </c:forEach>
                                </c:when>
                                <c:otherwise>
                            ...
                            <span style="color:red">*旋转：顺时针旋转，270度。不旋转：不变</span>
                        </td>
                        <td height="1" class=></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="radio" name="levelGame" value="false" checked>否
                            <input type="radio" name="levelGame" value="true">是
                        </td>
                        <td height="1" class=></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="radio" name="vpn" value="false" checked>否
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <div class="wrap">
                                <ul class="show-history"></ul>
                                <input type="text" id="inputword" size="50" autocomplete="off"/>
                                <input type="hidden" id="gameTag" name="gameTag" size="50"/>
                            </div>
                            <p class="show">
                            </p>
                            <span style="color:red">*必填项</span>&nbsp;&nbsp;<a target="_blank" href="/apiwiki/gametag/createpage">新增标签</a>
                        </td>
                        <td height="1" class=></td>
                    </tr>
                </table>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" id="table_shouye" style="display: none">
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="comment1"/> 点赞数:<input type="text" name="agree1"
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="comment2"/> 点赞数:<input type="text" name="agree2"
                                                                            onkeyup="value=value.replace(/[^\d]/g,'')"/>
                        </td>
                        <td height="1">
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="comment3"/> 点赞数:<input type="text" name="agree3"
                                                                            onkeyup="value=value.replace(/[^\d]/g,'')"/>
                        </td>
                    </tr>
                </table>
                ...
                <c:if test="${gamePlatformType == 1}">
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="0" id="table_chanel_download"
                                            ...
                                            <select id="channel1">
                                                ...
                                                <c:forEach items="${channelList}" var="channel">
                                                    <option value="${channel.channelId}"
                                                            id="channel_${channel.channelId}">${channel.channelName}</option>
                                                </c:forEach>
                                            </select>
                                        </td>
                                        <td height="1" class=>
                        ...
                        <tr id="tr_before">
                            <td colspan="3">
                                <input type="button" value="增加下载信息" id="insertline" data-idx="2"/>
                            </td>
                        </tr>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" id="table_shangwu" style="display: none">
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="teamname" size="32" id="teamname" ${gameDb.teamName}/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    ...
                    <%--</td>--%>
                    <%--<td height="1">--%>
                    <%--<input type="text" class="Wdate" onClick="WdatePicker({autoPickDate:true})"--%>
                    <%--readonly="readonly" name="publictime" id="publictime" value="${gameDb.publicTime}"/>--%>
                    <%--</td>--%>
                    <%--<td height="1" class=>--%>
                    <%--</td>--%>
                    <%--</tr>--%>
...
<script type="text/javascript">
    ...
    function showPcConfigTr() {
        var num = 0;
        $("input[name='pcplatform']:checked").each(function () {
            num += 1
        });
        if (num > 0) {
            $('#pc_config_1').css('display', '');
            $('#pc_config_2').css('display', '');
            $('#pc_config_3').css('display', '');
        } else {
            $('#pc_config_1').css('display', 'none');
            $('#pc_config_2').css('display', 'none');
            $('#pc_config_3').css('display', 'none');
        }
    }

    function showDownTr() {
        var num = 0;
        $("input[name='mplatform']:checked").each(function () {
            num += 1
        });
        if (num > 0) {
            $('#ios_download').css('display', '');
            $('#android_download').css('display', '');
        } else {
