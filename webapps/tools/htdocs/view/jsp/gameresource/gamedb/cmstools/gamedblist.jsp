                            ...
                            <tr class="<c:choose><c:when test="${st.index % 2 == 0}">list_table_opp_tr</c:when><c:otherwise>list_table_even_tr</c:otherwise></c:choose>">
                                ...
                                <td nowrap align="center"
                                    ...
                                    <span id="statusspan${st.index+1}">
                                        <fmt:message key="gamedb.validStatus.type.${gamedb.validStatus.code}" bundle="${def}"/>
                                    </span>
                                </td>
                                <td nowrap align="center">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="javascript:modifyStatus('${gamedb.validStatus.code}','${st.index+1}')" id="aStatus${st.index+1}">状态修改</a>
                                    &nbsp;&nbsp;
                                    <a href="/gameclient/gametab/list?gamedbid=${gamedb.gameDbId}">新手游画报配置</a>
                                    &nbsp;&nbsp;
                                    ...
                                    <select id="select_type_tags_${st.index}" onchange="addParam(${st.index})">
                                        <option value="pushlisttype=3&tags=game${gamedb.gameDbId}">关注游戏</option>
                                    </select>
