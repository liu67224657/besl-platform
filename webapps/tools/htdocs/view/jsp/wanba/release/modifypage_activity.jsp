...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top"><br>
            ...
            <form action="/wanba/release/modifyactivity" method="post" id="form_submit">
                <input type="hidden" name="apptype"  value="7"/>
                <input type="hidden" name="timeid" value="${release.timeid}"/>
