    ...
    <tr>
        <td valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">添加标签轮播图</td>
                </tr>
            </table>
            <form action="/wanba/menu/create" method="post" id="form_submit">
                <input type="hidden" name="channelid" size="48" value="${wanbamenudomain}"/>
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="input_menu_pic" type="hidden" name="picurl" value="">*必填项<span style="color:red">尺寸：750*300</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
