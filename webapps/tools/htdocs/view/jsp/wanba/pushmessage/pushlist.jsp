                ...
                <td nowrap>
                    <c:choose>
                        <c:when test="${pushListType == 0 || pushListType == 3 || pushListType == 4}">
                            <c:choose>
                                <c:when test="${msg.pushMessage.sendStatus.code == 'n'}">
                                    <a href="/joymeapp/push/send?app=${app}&msgid=${msg.pushMessage.pushMsgId}&appid=${appId}&pushlisttype=${msg.pushMessage.pushListType.code}&searchtext=${searchText}"
                                       name="send_click">推送</a>
                                    <a href="/joymeapp/push/modifypage?app=${app}&msgid=${msg.pushMessage.pushMsgId}&appid=${appId}&pushlisttype=${msg.pushMessage.pushListType.code}&searchtext=${searchText}">编辑</a>
                                    <a href="/joymeapp/push/remove?app=wanbaask&msgid=${msg.pushMessage.pushMsgId}&appid=${appId}&pushlisttype=${msg.pushMessage.pushListType.code}&searchtext=${searchText}">删除</a>
                                </c:when>
                                <c:when test="${msg.pushMessage.sendStatus.code == 'rj'}">
                                    <a href="/joymeapp/push/detail?app=${app}&msgid=${msg.pushMessage.pushMsgId}&appid=${appId}&pushlisttype=${msg.pushMessage.pushListType.code}&searchtext=${searchText}">查看</a>
                                </c:when>
                                <c:when test="${msg.pushMessage.sendStatus.code == 'ing'}">
                                    <a href="/joymeapp/push/detail?app=${app}&msgid=${msg.pushMessage.pushMsgId}&appid=${appId}&pushlisttype=${msg.pushMessage.pushListType.code}&searchtext=${searchText}">查看</a>
                                </c:when>
                        ...
                        <c:when test="${pushListType == 5}">
                            <c:choose>
                                <c:when test="${msg.pushMessage.sendStatus.code == 'n'}">
                                    <a href="/joymeapp/push/publish?app=${app}&msgid=${msg.pushMessage.pushMsgId}&appid=${appId}&pushlisttype=${msg.pushMessage.pushListType.code}&platform=${msg.pushMessage.appPlatform.code}&searchtext=${searchText}">发布</a>
                                    <a href="/joymeapp/push/modifypage?app=${app}&msgid=${msg.pushMessage.pushMsgId}&appid=${appId}&pushlisttype=${msg.pushMessage.pushListType.code}&searchtext=${searchText}">编辑</a>
                                    <a href="/joymeapp/push/remove?app=${app}&msgid=${msg.pushMessage.pushMsgId}&appid=${appId}&pushlisttype=${msg.pushMessage.pushListType.code}&searchtext=${searchText}">删除</a>
                                </c:when>
                                <c:when test="${msg.pushMessage.sendStatus.code == 'ing'}">
                                    <a href="/joymeapp/push/modifypage?app=${app}&msgid=${msg.pushMessage.pushMsgId}&appid=${appId}&pushlisttype=${msg.pushMessage.pushListType.code}&searchtext=${searchText}">编辑</a>
                                    <a href="/joymeapp/push/remove?app=${app}&msgid=${msg.pushMessage.pushMsgId}&appid=${appId}&pushlisttype=${msg.pushMessage.pushListType.code}&searchtext=${searchText}">删除</a>
