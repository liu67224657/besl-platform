...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="22" class="page_navigation_td">>> 运营维护 >> 玩霸-问答画报管理 >> 玩霸-问答消息中心列表</td>
    </tr>
<tr>
    ...
    <td height="1" class="edit_table_defaulttitle_td">
        <select name="rtype" id="select_rtype">
            ...
            <c:forEach items="${WanbaJt}" var="type">
                <option value="${type.code}"  <c:if test='${type.code==msgDTO.pushMessage.options.list.get(0).type}'>selected</c:if> >${type.name}</option>
            </c:forEach>
        </select>
    </td>
    <td height="1">
