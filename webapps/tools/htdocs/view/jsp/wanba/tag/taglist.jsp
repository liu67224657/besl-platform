                ...
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <form action="/wanba/tag/createpage" method="post">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <c:choose>
                    ...
                    ${st.index % 2 == 0}">list_table_opp_tr</c:when><c:otherwise>list_table_even_tr</c:otherwise></c:choose>">
                                ...
                                <c:if test="${dto.picjson.type=='0'}">
                                    <td nowrap><a href="/wanba/askrecommend/list?tagid=${dto.tag_id}">${dto.tag_name}</a></td>
                                </c:if>
                                <c:if test="${dto.picjson.type=='1' || dto.picjson.type=='2'}">
                                ...
                                <td nowrap>
                                    <a href="/wanba/tag/sort?desc=up&tag_id=${dto.tag_id}"><img
                                            src="/static/images/icon/up.gif"></a>

                                    <a href="/wanba/tag/sort?desc=down&tag_id=${dto.tag_id}"><img
                                            src="/static/images/icon/down.gif"></a>
                                </td>
                                <td nowrap>
                                    <a href="/wanba/tag/modifypage?tag_id=${dto.tag_id}">编辑</a>
                                </td>
                            </tr>
                        </c:forEach>
                        <tr>
