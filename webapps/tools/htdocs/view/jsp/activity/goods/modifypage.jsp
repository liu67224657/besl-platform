...
<form action="/activity/goods/modify" method="post" id="form_submit">
<table width="90%" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr>
        ...
        <td height="1">
            <textarea name="content" id="editor_id">${activity.activityDesc}</textarea>
    ...
    <tr>
        ...
        <td height="1" class="">
            ...
            <c:if test="${activity.goodsCategory.hasClassic()}">checked="checked"</c:if>/>精品推荐&nbsp;&nbsp;
            <input type="checkbox" name="box" value="2"
            <c:if test="${activity.goodsCategory.hasHot()}">checked="checked"</c:if>/>热卖实物&nbsp;&nbsp;
            <input type="checkbox" name="box" value="4"
            <c:if test="${activity.goodsCategory.hasNew()}">checked="checked"</c:if>/>最新上架&nbsp;&nbsp;
            <input type="checkbox" name="box" value="8"
            <c:if test="${activity.goodsCategory.hasSpecial()}">checked="checked"</c:if>/>特价商品&nbsp;&nbsp;
        </td>
        <td height="1"></td>
    </tr>
    <tr>
        ...
        <td height="1" class="">
            <select name="goodsactiontype">
                <c:forEach items="${shopTypes}" var="item">
                    ...
                    <c:if test="${activity.goodsActionType.code==item.code}">selected</c:if>>${item.name}</option>
                </c:forEach>
            </select>
        </td>
    </tr>
...
<table width="90%" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr>
        ...
        <td height="1">
            苹果下载地址:<input type="text" name="iosUrl" size="20" id="iosUrl" value="${activity.iosDownloadUrl}"/>*地址请已http://或者https://开头，谢谢
            <br/>
            安卓下载地址:<input type="text" name="androidUrl" size="20" id="androidUrl"
                          value="${activity.androidDownloadUrl}"/>*地址请已http://或者https://开头，谢谢
        </td>
        <td>
        </td>
    </tr>
