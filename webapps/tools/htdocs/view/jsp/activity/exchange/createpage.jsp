...
$().ready(function () {
    ...
    $('#form_submit').bind('submit', function () {
        ...
        var exchangegoodsid = $("#exchangegoodsid").val();
...
<form action="/activity/exchange/create" method="post" id="form_submit">
<table width="90%" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr>
        ...
        <td height="1" class="">
            <select name="exchangegoodsid" id="exchangegoodsid">
                <option value=""></option>
...
<table width="90%" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr>
        ...
        <td height="1" class="" width="10">
            ...
            <input type="checkbox" name="pbox" value="2"/>IOS&nbsp;&nbsp;
            <input type="checkbox" name="pbox" value="3"/>全部
    ...
    <tr>
        ...
        <td height="1" class="" width="10">
            <input type="checkbox" name="cbox" value="1"/>91&nbsp;&nbsp;
            <input type="checkbox" name="cbox" value="2"/>360&nbsp;&nbsp;
            <input type="checkbox" name="cbox" value="3"/>全部
