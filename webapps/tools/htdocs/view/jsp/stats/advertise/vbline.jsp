...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td" colspan="3">
                        <input type="button" class="tab_button_long" value="页面跳出统计曲线" title="页面跳出统计曲线">
                    </td>
                </tr>
                <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <form name="repForm" method="post" action="/stats/advertise/vb/report">
                    <tr>
                        <td height="1" class="default_line_td" colspan="3"></td>
                    </tr>
                    <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <form name="schForm" method="post" action="/stats/advertise/vb/line">
                    <tr>
                        <td height="1" class="default_line_td" colspan="3"></td>
                    </tr>
                    <tr>
