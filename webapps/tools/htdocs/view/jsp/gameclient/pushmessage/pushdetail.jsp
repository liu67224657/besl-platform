...
<tr>
    ...
    <td height="1" class="edit_table_defaulttitle_td">
        <select name="rtype" id="select_rtype" disabled="disabled">
            ...
            <option value="-2"
                    <c:if test="${msgDTO.pushMessage.options.list.get(0).type == -2}">selected="selected"</c:if>>wap页(有头部导航)
            </option>
            <option value="23"
                    <c:if test="${msgDTO.pushMessage.options.list.get(0).type == 23}">selected="selected"</c:if>>wap页(无头部导航)
            </option>
            <option value="24"
