    ...
    <script>
        $(function () {
            $("#backButton").on("click", function () {
                window.location.href = "/gameclient/clientline/gamecategory/sublist?lineName=${lineName}&lineCode=${lineCode}&platform=${platform}";
            });
    ...
    <tr>
        <td height="100%" valign="top"><br/>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><span>修改一条Line</span>
                        <label>所属平台: <b><c:choose><c:when
                                test="${platform==0}">ios</c:when><c:otherwise>android</c:otherwise></c:choose></b>
                            &nbsp;父类别名:<b>${lineName}</b>(${lineCode})
                            &nbsp;&nbsp;子类别名:<b>${subLineName}</b>(${subLineCode})的clientline</label>
                    </td>
                </tr>
            ...
            <form action="/gameclient/clientline/gamecategory/submodify" method="post" id="form_submit">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        <td height="1" class="">
                            <input type="hidden" name="subLineId" value="${subLineId}"/>
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input type="text" name="subLineName" size="20" id="input_text_name"
                                   value="${subLineName}"/> *必填项
                        </td>
                    ...
                    <tr align="center">
                        <td colspan="3">
                            ...
                            <input type="button" class="default_button" value="返回" id="backButton">
                        </td>
                    </tr>
                </table>
            </form>
