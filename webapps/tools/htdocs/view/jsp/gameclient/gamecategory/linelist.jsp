...
<head>
    ...
    <script>
        ...
        function toDelete(lineId, lineName, type) {
            var msg = "";
            if (type == 1) {
                msg = "您确定要停用lineName为<<" + lineName + ">>(lineId=" + lineId + "),的clientLine吗？\n\n请确认！";
            } else {
                msg = "您确定要启用lineName为<<" + lineName + ">>(lineId=" + lineId + "),的clientLine吗？\n\n请确认！";
            }
            if (confirm(msg) == true) {
                window.location.href = "/gameclient/clientline/gamecategory/delete?lineId=" + lineId + "&type=" + type;
            }
        }
    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">热门页游戏分类clientline管理</td>
                    <td height="15" valign="top">
                        <form method="post" action="/gameclient/clientline/gamecategory/createpage">
                            <input type="submit" name="button" class="default_button" value="添加新的父类别"/>
                        </form>
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr class="list_table_title_tr">
                    <td nowrap align="left" width="80">lineId</td>
                        ...
                        <c:forEach items="${list}" var="line" varStatus="st">
                            <tr data-id=""
                                ...
                                <td nowrap align="left"><a
                                        href="/gameclient/clientline/gamecategory/sublist?lineCode=${line.code}&lineName=${line.lineName}&platform=${line.platform}">${line.lineName}</a>
                                </td>
                                ...
                                <td nowrap align="left">
                                    <a href="/gameclient/clientline/gamecategory/modifypage?lineId=${line.lineId}&lineName=${line.lineName}&platform=${line.platform}">编辑</a>

                                    <c:choose>
                                        <c:when test="${line.validStatus.code == 'valid'}">
                                            <a href="javascript:void(0);"
                                               onclick="toDelete(${line.lineId},'${line.lineName}',1);">停用</a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="javascript:void(0);"
                                               onclick="toDelete(${line.lineId},'${line.lineName}',2);">启用</a>
                                        </c:otherwise>
                                    </c:choose>
                ...
                <c:if test="${page.maxPage > 1}">
                    <tr class="list_table_opp_tr">
                        <td colspan="14">
                            <pg:pager url="/gameclient/clientline/gamecategory/list"
