...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top"><br>
            ...
            <form action="/gameclient/advertise/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="advertise_name" type="text" name="advertise_name" size="100" value=""/><span
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="advertise_desc" type="text" name="advertise_desc" size="100" value=""/><span
                                style="color:red;">*必填项</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_adname1" type="text" name="adname1" size="100" value=""/><span
                                style="color:red;">*必填项</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_url1" type="text" name="url1" size="100" value=""/>
                            <br/>
                        </td>
                        <td height="1" class=>
                        </td>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${fn:length(iosPic) > 0}"><img id="picurl1_src" src=""
                                                                             class="img_pic" width="100px"
                                                                             height="100px"/></c:when>
                                <c:otherwise><img id="picurl1_src" src="/static/images/default.jpg"
                                                  class="img_pic" width="100px" height="100px"/></c:otherwise>
                            </c:choose>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_adname2" type="text" name="adname2" size="100" value=""/><span
                                style="color:red;">*必填项</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_url2" type="text" name="url2" size="100" value=""/>
                            <br/>
                        </td>
                        <td height="1" class=>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${fn:length(iosPic) > 0}"><img id="picurl2_src" src=""
                                                                             class="img_pic" width="100px"
                                                                             height="100px"/></c:when>
                            ...
                            <span id="loading2" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
                            <input id="picurl12" type="hidden" name="picurl2" value=""><span
                                style="color:red;">*必填项</span>
                        </td>
                        <td height="1">
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_adname3" type="text" name="adname3" size="100" value=""/><span
                                style="color:red;">*必填项</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_url3" type="text" name="url3" size="100" value=""/>
                            <br/>
                        </td>
                        <td height="1" class=>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${fn:length(iosPic) > 0}"><img id="picurl3_src" src=""
                                                                             class="img_pic" width="100px"
                                                                             height="100px"/></c:when>
                                <c:otherwise><img id="picurl3_src" src="/static/images/default.jpg"
                                                  class="img_pic" width="100px" height="100px"/></c:otherwise>
                            </c:choose>
                            <span id="upload_button3" class="upload_button3">上传</span>
                            <span id="loading3" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
                            <input id="picurl3" type="hidden" name="picurl3" value=""><span
                                style="color:red;">*必填项</span>
                        </td>
                        <td height="1">
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_adname4" type="text" name="adname4" size="100" value=""/><span
                                style="color:red;">*必填项</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_url4" type="text" name="url4" size="100" value=""/>
                            <br/>
                        </td>
                        <td height="1" class=>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${fn:length(iosPic) > 0}"><img id="picurl4_src" src=""
                                                                             class="img_pic" width="100px"
                                                                             height="100px"/></c:when>
                                <c:otherwise><img id="picurl4_src" src="/static/images/default.jpg"
                                                  class="img_pic" width="100px" height="100px"/></c:otherwise>
                            </c:choose>
                            <span id="upload_button4" class="upload_button4">上传</span>
                            <span id="loading4" style="display:none" class="loading"><img
                                    src="/static/images/loading.gif"/></span>
                            <input id="picurl4" type="hidden" name="picurl4" value=""><span
                                style="color:red;">*必填项</span>
                        </td>
                        <td height="1">
                        </td>
