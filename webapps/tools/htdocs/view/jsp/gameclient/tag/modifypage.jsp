    ...
    <tr>
        <td valign="top"><br>
            ...
            <%--<table width="10%" border="0" cellspacing="0" cellpadding="0">--%>
                ...
                <%--</tr>--%>
            <%--</table>--%>
            <form action="/gameclient/tag/modify" method="post" id="form_submit">
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <c:forEach var="type" items="${gameClientTagType}">
                                <c:if test="${type.code==animeTag.animeTagType.code}">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <img id="img_icon" src="${animeTag.picjson.ios}" height="64" width="64"/>
                            <span id="upload_button">上传</span>
                            <span id="loading" style="display:none"><img src="/static/images/loading.gif"/></span>
                            <input id="msg_icon" type="hidden" name="icon" value="${animeTag.picjson.ios}">
                        </td>
                        <td height="1">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="1" class="">
                            <c:forEach var="type" items="${tagType}">
                                <c:if test="${type.code==animeTag.picjson.type}">
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <c:if test="${animeTag.picjson.type==0}">
                                <input id="url" type="text" name="url" size="48" value="" disabled/></span>
                            </c:if>
