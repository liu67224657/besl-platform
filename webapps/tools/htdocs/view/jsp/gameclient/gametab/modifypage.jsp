...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/gameclient/gametab/modify" method="post" id="form_submit">
                ...
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        <td height="1" class="" width="150">
                            《${game.gameName}》--TAB页编辑
                            <input type="hidden" name="gamedbid" value="${relation.gamedbId}"/>
                    ...
                    <tr>
                        ...
                        <td height="1" width="200">
                            <input type="text" name="title" size="50" value="${relation.title}"/>*显示的名称
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" width="200">
                            <input type="text" name="uri" size="50" value="${relation.uri}"
                                   <c:if test="${relation.type.code!=4}">readonly="true"</c:if>  />*类型选择连接请填写完整的URL，其他的可不填写
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
