...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td"><span
                            style="font-size:16px; font-family: Arial, Helvetica, sans-serif; font-weight:bold;">游戏TAB-最建详情修改</span>
                    </td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <form action="/gameclient/gametab/news/modify" method="post" id="form_submit">
                <table width="90%" border="0" cellspacing="1" cellpadding="0">
                            ...
                            <select name="redirecttype" id="redirecttype">
                                ...
                                <c:forEach items="${redirectCollection}" var="type">
                                    <option value="${type.code}"
                                            <c:if test="${clienLineItem.redirectType.code == type.code}">selected</c:if> >
                                        <fmt:message
                    ...
                    <td height="1" class="" width="10">
                        <select name="redmessagetype" id="redmessagetype">
                            ...
                            <c:forEach items="${redMessageType}" var="type">
                                <option value="${type.code}"
                                <c:if test="${clienLineItem.param.redMessageType == type.code}">selected</c:if> >
                                <fmt:message
                    ...
                    <tr>
                        ...
                        <td height="1" class="" width="10">
                            <input id="redmessagetext" type="text" size="80" name="redmessagetext" value="${clienLineItem.param.redMessageText}">
                        </td>
                        <td height="1" align="left"></td>
                    </tr>
                </table>
