                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                            ...
                            <c:forEach items="${list}" var="line" varStatus="st">
                                <tr class="<c:choose><c:when test="${st.index % 2 == 0}">list_table_opp_tr</c:when><c:otherwise>list_table_even_tr</c:otherwise></c:choose>">
                                    ...
                                    <td nowrap align="left"><a
                                            href="/gameclient/clientline/hotfloor/itemlist?lineId=${line.lineId}&lineName=${line.lineName}&lineCode=${line.code}">${line.lineName}</a>
                                    </td>
                                    ...
                                    <td nowrap align="left">
                                      <%--   <a href="/gameclient/clientline/game/modifypage?lineId=${line.lineId}">编辑</a>
                    ...
                    <c:if test="${page.maxPage > 1}">
                        <tr class="list_table_opp_tr">
                            <td colspan="14">
                                <pg:pager url="/gameclient/clientline/hotfloor/list"
