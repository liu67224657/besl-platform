    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">添加分享话题</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
            ...
            <form action="/sync/sharetopic/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <input type="text" name="sharetopic" size="32" id="input_text_sharetopic"/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
