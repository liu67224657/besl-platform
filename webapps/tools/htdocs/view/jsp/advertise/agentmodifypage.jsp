...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        $().ready(function() {
            $('#form_modifyagent').submit(function() {
                var errorFlag = false;
    ...
    <tr>
        <td height="100%" valign="top">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <form action="/advertise/agent/modify" method="POST" id="form_modifyagent">
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td" width="660px" height="25px">
                            <input style="float: left" name="agentname" type="text" class="default_input_singleline" size="64" maxlength="64" value="${agent.agentName}" id="input_agentname">
                            <div id="error_agentname" class="error_msg_td" style="float: left;">
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <select name="validstatus">
                                <option value="valid" <c:if test="${agent.validStatus.code eq 'valid'}">selected</c:if>>有效</option>
                                <option value="invalid" <c:if test="${agent.validStatus.code eq 'invalid'}">selected</c:if>>无效</option>
                                <option value="removed" <c:if test="${agent.validStatus.code eq 'removed'}">selected</c:if>>删除</option>
                            </select> * 广告商的状态。
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <textarea name="agentdesc" rows="5" cols="51" style="width: 418px;float: left"
                                      class="default_input_multiline" id="input_agentdesc">${agent.agentDesc}</textarea>
                            <div id="error_agentdesc" class="error_msg_td" style="float: left;">
