...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td valign="top"><br>
            ...
            <form action="/advertise/app/modify" method="post" id="form_submit">
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        <td height="1" class="default_line_td td_cent" width="100" valign="middle">
                            广告名称:
                        </td>
                        <td height="1">
                            <input id="input_text_adname" type="text" name="adname" size="100"
                                   value="${appAdvertise.advertiseName}"/><span style="color:red;">*必填项</span>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <textarea id="input_description" type="text" name="addesc"
                                      style="height: 100px;width: 634px">${appAdvertise.advertiseDesc}</textarea>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <input id="input_text_url" type="text" name="url" size="100" value="${appAdvertise.url}"/>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            ...
                            <select name="redirecttype">
                                <option value="0" <c:if test="${appAdvertise.appAdvertiseRedirectType == '0'}">selected</c:if>>WEB_VIEW</option>
                                <option value="1" <c:if test="${appAdvertise.appAdvertiseRedirectType == '1'}">selected</c:if>>APP_STORE</option>
                                <c:forEach items="${WanbaJt}" var="type">
                                    <option value="${type.code}" <c:if test="${appAdvertise.appAdvertiseRedirectType == type.code}">selected</c:if>>${type.name}</option>
                                </c:forEach>
                            </select>
                    ...
                    <tr>
                        ...
                        <td height="1">
                            ...
                            <c:if test="${appAdvertise.appPlatform.code == '2'}">
                                <input type="radio" name="appPlatform" value="0"/>IOS&nbsp;
                                <input type="radio" name="appPlatform" value="1"/>ANDROID&nbsp;
                                <input type="radio" name="appPlatform" checked="true" value="2"/>WEB&nbsp;
                                <input type="radio" name="appPlatform" value="3"/>CLIENT&nbsp;
                            </c:if>
                            <c:if test="${appAdvertise.appPlatform.code == '3'}">
                                <input type="radio" name="appPlatform" value="0"/>IOS&nbsp;
                                <input type="radio" name="appPlatform" value="1"/>ANDROID&nbsp;
                                <input type="radio" name="appPlatform" value="2"/>WEB&nbsp;
                                <input type="radio" name="appPlatform" checked="true" value="3"/>CLIENT&nbsp;
                            </c:if>
                    ...
                    <c:if test="${fn:length(appAdvertise.picUrl1) > 0}">
                        <tr>
                            <td height="1" class="default_line_td td_cent" width="100">
                                ios4图片:
                            </td>
                            <td>
                                <img id="picurl1_src" src="${appAdvertise.picUrl1}" class="img_pic" width="200px"
                                     height="200px"/>
                                <span id="upload_button" class="upload_button">上传</span>
                                <span id="loading" style="display:none" class="loading">
                                    <img src="/static/images/loading.gif"/>
                                </span>
                                <input id="picurl1" type="hidden" name="picurl1" value="${appAdvertise.picUrl1}">
                            </td>
                            <td height="1">
                            </td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${fn:length(appAdvertise.picUrl2) > 0}">
                                    <img id="picurl2_src" src="${appAdvertise.picUrl2}" class="img_pic" width="200px"
                                         height="200px"/>
                                </c:when>
                                <c:otherwise>
                                    <img id="picurl2_src" src="/static/images/default.jpg" class="img_pic" width="200px"
                                         height="200px"/>
                                </c:otherwise>
                            </c:choose>
                            ...
                            <input id="picurl2" type="hidden" name="picurl2" value="${appAdvertise.picUrl2}">
