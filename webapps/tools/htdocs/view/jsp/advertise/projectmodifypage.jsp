...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        $().ready(function() {
            ...
            $('#form_modifyproject').submit(function() {
                var errorFlag = false;
    ...
    <tr>
        <td height="100%" valign="top">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <form action="/advertise/project/modify" method="POST" id="form_modifyproject">
                    ...
                    <tr>
                        ...
                        <td nowrap width="660" class="edit_table_value_td">
                            <input style="float: left" name="projectname" type="text" class="default_input_singleline" size="64" maxlength="64" value="${project.projectName}" id="input_projectname">
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <select name="validstatus">
                                <option value="valid" <c:if test="${project.validStatus.code eq 'valid'}">selected</c:if>>有效</option>
                                <option value="invalid" <c:if test="${project.validStatus.code eq 'invalid'}">selected</c:if>>无效</option>
                                <option value="removed" <c:if test="${project.validStatus.code eq 'removed'}">selected</c:if>>删除</option>
                            </select> * 广告项目的状态。
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <input  id="input_project_startdate" style="float: left" name="startdate" type="text" class="default_input_singleline" size="32"
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            ...
                            <input style="float:left"  name="enddate" type="text" class="default_input_singleline" size="32"
                                   value="<fmt:formatDate value="${project.endDate}" pattern="yyyy-MM-dd"/>"
                                   id="input_project_enddate">
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <input style="float:left"  name="statenddate" type="text" class="default_input_singleline" size="32"
                                   value="<fmt:formatDate value="${project.statEndDate}" pattern="yyyy-MM-dd"/>"
                                   id="input_project_statenddate">
                    ...
                    <tr>
                        ...
                        <td nowrap class="edit_table_value_td">
                            <textarea style="float: left" name="projectdesc" rows="5" cols="51" style="width: 418px;" class="default_input_multiline" id="input_projectdesc">${project.projectDesc}</textarea>
