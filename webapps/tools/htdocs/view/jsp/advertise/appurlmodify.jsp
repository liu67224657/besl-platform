    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">链接修改</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
            ...
            <form action="/advertise/appurl/modify" method="post" id="form_submit" onsubmit="return isNotNull();">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        <td height="1" colspan="3" class="default_line_td">
                            <input type="hidden" name="clientId" value="${advertiseAppUrl.clientUrlId}"/>
                            <input type="hidden" name="code" value="${advertiseAppUrl.code}"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <input id="codename" type="text" name="codename" size="32" value="${advertiseAppUrl.codeName}"/>
                    ...
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <input id="input_text_ios" type="text" name="iosUrl" size="32"
                                   value="${advertiseAppUrl.iosUrl}"/>
                    ...
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <input id="input_text_android" type="text" name="androidUrl" size="32"
                                   value="${advertiseAppUrl.androidUrl}"/>
