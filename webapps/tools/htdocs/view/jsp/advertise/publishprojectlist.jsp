...
<body>
<form action="/advertise/publish/publishlistbyproject" method="post">
...
<tr>
    <td height="100%" valign="top">
        <%--<iframe src="publishiframelist.jsp" width="100%" height="400px"></iframe>--%>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
            ...
            <tr class="toolbar_tr">
                ...
                <td width="4%" class="list_table_header_td">
                    ...
                    <%--<a style="text-decoration: none" href="/advertise/publish/addpage?projectid=${project.projectId}&source=project">--%>
                        <%--添加广告发布</a>--%>
                </td>
            </tr>
        </table>
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
              ...
              <c:otherwise>list_table_even_tr</c:otherwise>
                            ...
                            <td align="left">
                                <div title="${publish.publishName}">
                                    <a href="/advertise/publish/detail?publishid=${publish.publishId}&source=project&projectid=${publish.projectId}&agentid=${publish.agentId}}" <c:if test="${publish.validStatus.code!='removed'}">target="incFrame"</c:if>>
                                      ${publish.publishName}
                                    </a>
                                </div>
                            </td>
                            ...
                            <td><div title="${publish.advertiseAgent.agentName}"
                            ...
                            <td nowrap align="center">
                                <p:privilege name="/advertise/publish/modifypage">
                                    <a <c:if test="${publish.validStatus.code=='removed'}">style="color: #808080"</c:if> href="/advertise/publish/modifypage?publishid=${publish.publishId}&source=project&&modifyagentid=${publish.agentId}&modifyprojectid=${publish.projectId}">编辑</a>
                                </p:privilege>
                            </td>
                        </tr>
                    </c:forEach>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <LABEL>
                        <pg:pager url="/advertise/publish/publishlistbyproject"
                            ...
                            <pg:param name="projectid" value="${project.projectId}"/>
