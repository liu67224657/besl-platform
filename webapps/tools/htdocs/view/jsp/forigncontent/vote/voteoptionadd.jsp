...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <form action="/comment/vote/wiki/option/create" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        ...
                        <td height="1">
                            <input type="text" name="title" size="50" id="title" maxlength="50"
                                   value="<c:out value='${title}' escapeXml='true' />"/>*必填项(最长50个字符)
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="1">
                            <img id="menu_pic" <c:choose><c:when
                                    test="${not empty pic}"> src="${pic}" </c:when><c:otherwise> src="/static/images/default.jpg" </c:otherwise>
                            </c:choose>  />
                            <span id="upload_button" class="upload_button">上传</span>
                                                                        <span id="loading" style="display:none"
                                                                              class="loading"><img
                                                                                src="/static/images/loading.gif"/></span>
                            <input id="input_menu_pic" type="hidden" name="pic" value="${pic}"><span style="color: red">*可选填，图片尺寸：70px * 70px</span>
                    </tr>
                    <tr>
