...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            var flag_forever='${flag_forever}';

                   if(flag_forever=='1'){
                       $("#form_submit select[name='flag_forever']").val("1");
                       $(".easyui-datetimebox").datetimebox({ disabled: true });
                   }else{

                       $("#form_submit select[name='flag_forever']").val("2");
                   }
    ...
    <tr>
        <td height="100%" valign="top"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="list_table_header_td">编辑需要禁言的用户</td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <form action="/forign/content/forbid/modify" method="post" id="form_submit">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        ...
                        <td height="1">
                            <input type="text"  size="32" value="${nickName}" disabled="disabled"/>
                            *必填项
                        </td>
                        <td height="1">
                        </td>
