    ...
    <tr>
        <td height="100%" valign="top"><br>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <form action="/video/modify" method="post" id="form_submit">
                    <input type="hidden" name="type" value="${type}"/>
                    <input type="hidden" name="actstatus" value="${actstatus}"/>
                    <tr>
                        <td height="1" colspan="3" class="default_line_td">
                            <input type="hidden" value="${commentVideo.jsonUrl.qnurl}" name="videourl"/>
                            <input type="hidden" value="${commentVideo.commentVideoId}" name="id"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="1" class="edit_table_defaulttitle_td">
                            <input type="text" name="title" size="32" value="${commentVideo.videoTitle}"
                                   id="input_text_appname"/>
                        </td>
                        <td height="1" class=>
                        </td>
                    </tr>
                            ...
                            <select name="gamesdk">
                                ...
                                <c:forEach items="${gamelist}" var="game">
                                    <option value="${game.appId}"
                                            <c:if test="${game.appId eq commentVideo.sdk_key}">selected </c:if> >${game.appName}</option>
                                </c:forEach>
                            </select>
                        </td>
                        <td height="1" class=>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <video id="video"
                               src="${commentVideo.jsonUrl.qnurl}"
                               width="400" style="" controls autobuffer preload="metadata">
