 ...
 */
@Controller
@RequestMapping(value = "/joymeapp/client/topmenu/android")
public class AndroidTopMenuController extends ToolsBaseController {
    ...
    private String CLIENT_APP_KEY = joymeAppConfig.getAppKey();
    ...
    public ModelAndView queryTopMenuList(@RequestParam(value = "channelid", required = false) Long channelId,
        ...
        try {
            ...
            return new ModelAndView("/joymeapp/client/android/topmenulist", mapMessage);
        }

        QueryExpress queryExpress = new QueryExpress();
        queryExpress.add(QuerySort.add(ActivityTopMenuField.DISPLAY_ORDER, QuerySortOrder.ASC));
        //queryExpress.add(QueryCriterions.eq(ActivityTopMenuField.APP_KEY, CLIENT_APP_KEY));
        queryExpress.add(QueryCriterions.eq(ActivityTopMenuField.CATEGORY, AppTopMenuCategory.CLIENT_LINE.getCode()));

        queryExpress.add(QueryCriterions.eq(ActivityTopMenuField.PLATFORM, CLIENT_PLATFORM_ANDROID));
    ...
    public ModelAndView createTopMenuPage() {
        ...
        try {
            ...
            GAlerter.lab(this.getClass().getName() + " occured ServiceException.e: ", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/client/topmenu/android/list", mapMessage);
        }
        return new ModelAndView("/joymeapp/client/android/createtopmenu", mapMessage);
    }
    ...
    public ModelAndView createTopMenu(@RequestParam(value = "menuname", required = false) String menuName,
        ...
        try {
            ...
            activityTopMenu.setAppKey(CLIENT_APP_KEY);
            activityTopMenu.setPlatform(CLIENT_PLATFORM_ANDROID);
...
//            activityTopMenu.setLinkType(AppRedirectType.getByCode(linkType));
            activityTopMenu.setCategory(AppTopMenuCategory.CLIENT_LINE);

            JoymeAppConfigServiceSngl.get().createActivityTopMenu(activityTopMenu);
        } catch (ServiceException e) {
            GAlerter.lab(this.getClass().getName() + "ServiceException", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/client/topmenu/android/createpage", mapMessage);
        }
        return new ModelAndView("redirect:/joymeapp/client/topmenu/android/list");
    }
    ...
    public ModelAndView modifyAppPage(@RequestParam(value = "activitytopmenuid", required = true) Long activityTopMenuId) {
        ...
        return new ModelAndView("joymeapp/client/android/modifytopmenu", mapMessage);
    }
    ...
    public ModelAndView modify(@RequestParam(value = "activitytopmenuid", required = true) Long activityTopMenuId,
        ...
        updateExpress.set(ActivityTopMenuField.LAST_MODIFY_DATE, date);
        updateExpress.set(ActivityTopMenuField.LAST_MODIFY_IP, getIp());
//        updateExpress.set(ActivityTopMenuField.LINK_TYPE, linkType);
        ...
        try {
            ...
            GAlerter.lab(this.getClass().getName() + "ServiceException", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/client/topmenu/android/modifypage?activitytopmenuid=" + activityTopMenuId);
        }
        return new ModelAndView("redirect:/joymeapp/client/topmenu/android/list");
    }
    ...
    public ModelAndView getAppMenuSort(@PathVariable(value = "sort") String sort,
        ...
        try {
            ...
            JoymeAppWebLogic.sortClientTopMenu(sort, activityTopMenuId, AppTopMenuCategory.CLIENT_LINE.getCode(), CLIENT_PLATFORM_ANDROID);
        } catch (Exception e) {
            GAlerter.lab(this.getClass().getName() + "ServiceException", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/client/topmenu/android/list");
