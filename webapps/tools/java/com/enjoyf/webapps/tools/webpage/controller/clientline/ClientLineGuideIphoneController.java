 ...
 */
@Controller
@RequestMapping(value = "/clientline/iphone/guide")
public class ClientLineGuideIphoneController extends ToolsBaseController {
    ...
    public ModelAndView lineList(@RequestParam(value = "pager.offset", required = false, defaultValue = "0") int pageStartIndex,
        ...
        return new ModelAndView("/clientline/iphoneguide/linelist", mapMessage);
    }
    ...
    public ModelAndView createLinePage() {
        ...
        return new ModelAndView("/clientline/iphoneguide/createline", mapMessage);
    }
    ...
    public ModelAndView createLine(@RequestParam(value = "linename", required = false) String lineName,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                return new ModelAndView("forward:/clientline/iphone/guide/createpage", mapMessage);
            }
        ...
        return new ModelAndView("redirect:/clientline/iphone/guide/list?itemtype=" + itemType);
    }
    ...
    public ModelAndView modifyLinePage(@RequestParam(value = "lineid", required = true) Long lineId) {
        ...
        Map<String, Object> mapMessage = new HashMap<String, Object>();
        if (lineId == null) {
            return new ModelAndView("redirect:/clientline/iphone/guide/list");
        }
        mapMessage.put("itemTypeCollection", itemTypes);
        ...
        return new ModelAndView("/clientline/iphoneguide/modifyline", mapMessage);
    }
    ...
    public ModelAndView modifyLine(@RequestParam(value = "lineid", required = false) Long lineId,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                mapMessage.put("codeExist", "line.code.exist");
                return new ModelAndView("forward:/clientline/iphone/guide/modifypage", mapMessage);
            }
    ...
    public ModelAndView detail(@RequestParam(value = "lineid", required = false) Long lineId) {
        ...
        return new ModelAndView("/clientline/iphoneguide/linedetail", mapMessage);
    }
