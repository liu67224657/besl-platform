 ...
 */
@Controller
@RequestMapping(value = "/joymeapp/client/topmenu/iphone")
public class IphoneTopMenuController extends ToolsBaseController {
    ...
    public ModelAndView queryTopMenuList(@RequestParam(value = "channelid", required = false) Long channelId,
        ...
        try {
            ...
            return new ModelAndView("/joymeapp/client/iphone/topmenulist", mapMessage);
        }
    ...
    public ModelAndView createTopMenuPage() {
        ...
        try {
            ...
            GAlerter.lab(this.getClass().getName() + " occured ServiceException.e: ", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/client/topmenu/iphone/list", mapMessage);
        }
        return new ModelAndView("/joymeapp/client/iphone/createtopmenu", mapMessage);
    }
...
//            activityTopMenu.setLinkType(AppRedirectType.getByCode(linkType));
            ...
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/client/topmenu/iphone/createpage", mapMessage);
        }
        return new ModelAndView("redirect:/joymeapp/client/topmenu/iphone/list");
    }
    ...
    public ModelAndView modifyAppPage(@RequestParam(value = "activitytopmenuid", required = true) Long activityTopMenuId) {
        ...
        return new ModelAndView("joymeapp/client/iphone/modifytopmenu", mapMessage);
    }
...
//        updateExpress.set(ActivityTopMenuField.LINK_TYPE, linkType);
        ...
        try {
            ...
            GAlerter.lab(this.getClass().getName() + "ServiceException", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/client/topmenu/iphone/modifypage?activitytopmenuid=" + activityTopMenuId);
        }
        return new ModelAndView("redirect:/joymeapp/client/topmenu/iphone/list");
    }
    ...
    public ModelAndView getAppMenuSort(@PathVariable(value = "sort") String sort,
        ...
        try {
            ...
            JoymeAppWebLogic.sortClientTopMenu(sort, activityTopMenuId, AppTopMenuCategory.CLIENT_LINE.getCode(), CLIENT_PLATFORM_IPHONE);
        } catch (Exception e) {
            GAlerter.lab(this.getClass().getName() + "ServiceException", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/client/topmenu/iphone/list");
