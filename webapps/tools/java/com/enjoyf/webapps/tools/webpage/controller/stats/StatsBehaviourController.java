 ...
 */
@Controller
@RequestMapping(value = "/stats/behaviour")
public class StatsBehaviourController extends ToolsBaseController {
    //
    ...
    //
    @RequestMapping(value = "/postline")
    public ModelAndView postLine(HttpServletRequest request, HttpServletResponse response,//
                                 //
        ...
        if (Strings.isNullOrEmpty(domainCode)) {
            domainCode = OperationStatDomain.USER_EVENT_POST.getCode();
        }
        ...
        //
        return new ModelAndView("/stats/behaviour/postline", modelData);
    }


    //
    @RequestMapping(value = "/commentline")
    public ModelAndView commentLine(HttpServletRequest request, HttpServletResponse response,//
                                    //
                                    @RequestParam(value = "domaincode", required = false) String domainCode,
                                    @RequestParam(value = "sectioncode", required = false, defaultValue = "all") String sectionCode,
                                    //
        ...
        if (Strings.isNullOrEmpty(domainCode)) {
            domainCode = OperationStatDomain.USER_EVENT_COMMENT.getCode();
        }
        ...
        //
        return new ModelAndView("/stats/behaviour/commentline", modelData);
    }


    //
    @RequestMapping(value = "/fwdline")
    public ModelAndView fwdLine(HttpServletRequest request, HttpServletResponse response,//
                                //
                                @RequestParam(value = "domaincode", required = false) String domainCode,
                                @RequestParam(value = "sectioncode", required = false, defaultValue = "all") String sectionCode,
                                //
        ...
        if (Strings.isNullOrEmpty(domainCode)) {
            domainCode = OperationStatDomain.USER_EVENT_FORWARD.getCode();
        }
        ...
        //
        return new ModelAndView("/stats/behaviour/fwdline", modelData);
    }

    //
    @RequestMapping(value = "/likeline")
    public ModelAndView likeLine(HttpServletRequest request, HttpServletResponse response,//
                                 //
                                 @RequestParam(value = "domaincode", required = false) String domainCode,
                                 @RequestParam(value = "sectioncode", required = false, defaultValue = "all") String sectionCode,
                                 //
        ...
        if (Strings.isNullOrEmpty(domainCode)) {
            domainCode = OperationStatDomain.USER_EVENT_LIKE.getCode();
        }
        ...
        //
        return new ModelAndView("/stats/behaviour/likeline", modelData);
    }

    //
    @RequestMapping(value = "/registerline")
    public ModelAndView registerLine(HttpServletRequest request, HttpServletResponse response,//
                                     //
                                     @RequestParam(value = "domaincode", required = false) String domainCode,
                                     @RequestParam(value = "sectioncode", required = false, defaultValue = "all") String sectionCode,
                                     //
        ...
        if (Strings.isNullOrEmpty(domainCode)) {
            domainCode = OperationStatDomain.USER_EVENT_REGISTER.getCode();
        }
        ...
        //
        return new ModelAndView("/stats/behaviour/registerline", modelData);
    }
    ...
    public ModelAndView pie(HttpServletRequest request, HttpServletResponse response,//
        ...
        //
        return new ModelAndView("/stats/behaviour/pie", modelData);
    }
}
