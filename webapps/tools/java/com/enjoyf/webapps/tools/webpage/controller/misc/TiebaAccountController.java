 ...
 */
@Controller
@RequestMapping(value = "/misc/tieba")
public class TiebaAccountController extends ToolsBaseController {
    ...
    public ModelAndView list(@RequestParam(value = "pager.offset", required = false, defaultValue = "0") int pageStartIndex,
                             ...
                             @RequestParam(value = "qlast", required = false) String qlast
    ) {
        ...
        if (!StringUtil.isEmpty(qlast)) {
            queryExpress.add(QueryCriterions.eq(InterFlowAccountField.LAST_POST, qlast));
        }

        queryExpress.add(QueryCriterions.eq(InterFlowAccountField.INTERFLOW_TYPE, InterFlowType.TIEBA.getCode()));
        ...
        return new ModelAndView("/misc/interflow/tiebalist", mapMessage);
    }
    ...
    public ModelAndView createPage(@RequestParam(value = "ifname", required = false) String ifName,
                                   ...
                                   @RequestParam(value = "lastpost", required = false) String lastPost
    ) {
        Map<String, Object> mapMessage = new HashMap<String, Object>();
        ...
        mapMessage.put("lastpost", lastPost);
        ...
        return new ModelAndView("/misc/interflow/createtieba", mapMessage);
    }
    ...
    public ModelAndView create(@RequestParam(value = "ifname", required = false) String ifName,
        ...
        try {
            ...
            interFlowAccount.setType(InterFlowType.TIEBA);
            ...
            interFlowAccount.setLastPostDate(lastPost);
            ...
            GAlerter.lab(this.getClass().getName() + " occured ServiceExcpetion.e:", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("forward:/misc/tieba/createpage", mapMessage);
        }
        return new ModelAndView("redirect:/misc/tieba/list");
    }
    ...
    public ModelAndView modifyPage(@RequestParam(value = "ifid", required = false) String ifId
        ...
        try {
            ...
            if (!getCurrentUser().getUserid().equals(interFlowAccount.getCreateUser())) {
                return new ModelAndView("redirect:/misc/tieba/list?error=interflow.user.no.privilege");
            }
        ...
        return new ModelAndView("/misc/interflow/modifytieba", mapMessage);
    }
    ...
    public ModelAndView modify(@RequestParam(value = "ifid", required = false) String ifId,
        ...
        updateExpress.set(InterFlowAccountField.LAST_POST, lastPost);
        ...
        try {
            ...
            GAlerter.lab(this.getClass().getName() + " occured ServiceExcpetion.e:", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("forward:/misc/tieba/modifypage?ifid=" + ifId, mapMessage);
        }
        return new ModelAndView("redirect:/misc/tieba/list");
    }
    ...
    public ModelAndView remove(@RequestParam(value = "ifid", required = false) String ifId,
        ...
        return new ModelAndView("forward:/misc/tieba/list", mapMessage);
    }
...
//                    }
    ...
    public ModelAndView output(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            response.addHeader("Content-Disposition", "attachment; filename=" + new String("贴吧帐号.xls".getBytes("GB2312"), "iso-8859-1"));
            ...
            do {
                ...
                if (pageRows != null && !CollectionUtil.isEmpty(pageRows.getRows())) {
                    ...
                    for (InterFlowAccount interFlowAccount : pageRows.getRows()) {
                        ...
                        Label typeLabel = new Label(15, row, "贴吧");
