 ...
 */
@Controller
@RequestMapping(value = "/clientline/iphone/news")
public class ClientLineNewsIphoneController extends ToolsBaseController {
    ...
    public ModelAndView lineList(@RequestParam(value = "pager.offset", required = false, defaultValue = "0") int pageStartIndex,
        ...
        queryExpress.add(QueryCriterions.eq(ClientLineField.PLATFORM, CLIENT_PLATFORM_IPHONE));
         queryExpress.add(QueryCriterions.eq(ClientLineField.LINE_TYPE, ClientLineType.NEWSITEM.getCode()));
        if (itemType != null) {
        ...
        return new ModelAndView("/clientline/iphonenews/linelist", mapMessage);
    }
    ...
    public ModelAndView createLinePage() {
        ...
        return new ModelAndView("/clientline/iphonenews/createline", mapMessage);
    }
    ...
    public ModelAndView createLine(@RequestParam(value = "linename", required = false) String lineName,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                return new ModelAndView("forward:/clientline/iphone/news/createpage", mapMessage);
            }
            ...
            clientLine.setLineType(ClientLineType.NEWSITEM);
        ...
        return new ModelAndView("redirect:/clientline/iphone/news/list?itemtype=" + itemType);
    }
    ...
    public ModelAndView modifyLinePage(@RequestParam(value = "lineid", required = true) Long lineId) {
        ...
        Map<String, Object> mapMessage = new HashMap<String, Object>();
        if (lineId == null) {
            return new ModelAndView("redirect:/clientline/iphone/news/list");
        }
        mapMessage.put("itemTypeCollection", itemTypes);
        ...
        return new ModelAndView("/clientline/iphonenews/modifyline", mapMessage);
    }
    ...
    public ModelAndView detail(@RequestParam(value = "lineid", required = false) Long lineId) {
        ...
        return new ModelAndView("/clientline/iphonenews/linedetail", mapMessage);
    }
