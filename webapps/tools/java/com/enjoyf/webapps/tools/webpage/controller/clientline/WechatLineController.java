 ...
 */
@Controller
@RequestMapping(value = "/wechat/line")
public class WechatLineController extends ToolsBaseController {
    private static Set<ClientItemType> itemTypes = new HashSet<ClientItemType>();

    static {
        itemTypes.add(ClientItemType.WECHAT_BBSAC_TOP);
        itemTypes.add(ClientItemType.WECHAT_BBSAC_LIST);
    }
    ...
    public ModelAndView list(@RequestParam(value = "pager.offset", required = false, defaultValue = "0") int pageStartIndex,
        ...
        try {
            ...
            queryExpress.add(QueryCriterions.eq(ClientLineField.LINE_TYPE, ClientLineType.WECHAT_BBSAC.getCode()));
            ...
            return new ModelAndView("/clientline/wechat/linelist", mapMessage);
        }
        return new ModelAndView("/clientline/wechat/linelist", mapMessage);
    }
    ...
    public ModelAndView createPage() {
        ...
        return new ModelAndView("/clientline/wechat/createline", mapMessage);
    }
    ...
    public ModelAndView createLine(@RequestParam(value = "linename", required = false) String lineName,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                return new ModelAndView("forward:/wechat/line/createpage", mapMessage);
            }
            ...
            clientLine.setPlatform(AppPlatform.CLIENT.getCode());
            clientLine.setLineType(ClientLineType.WECHAT_BBSAC);
        ...
        return new ModelAndView("forward:/wechat/line/list", mapMessage);
    }
    ...
    public ModelAndView modifyLinePage(@RequestParam(value = "lineid", required = false) Long lineId) {
        ...
        try {
            ...
            if (clientLine == null) {
                return new ModelAndView("redirect:/wechat/line/list");
            }
        ...
        return new ModelAndView("/clientline/wechat/modifyline", mapMessage);
    }
    ...
    public ModelAndView modifyLine(@RequestParam(value = "lineid", required = false) Long lineId,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                mapMessage.put("codeExist", "line.code.exist");
                return new ModelAndView("forward:/clientline/wechat/modifypage", mapMessage);
            }
    ...
    public ModelAndView detail(@RequestParam(value = "lineid", required = false) Long lineId) {
        ...
        return new ModelAndView("/clientline/wechat/linedetail", mapMessage);
    }
}
