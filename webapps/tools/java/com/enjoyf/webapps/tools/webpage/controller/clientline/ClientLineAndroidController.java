 ...
 */
@Controller
@RequestMapping(value = "/clientline/android")
public class ClientLineAndroidController extends ToolsBaseController {
    ...
    public ModelAndView lineList(@RequestParam(value = "pager.offset", required = false, defaultValue = "0") int pageStartIndex,
        ...
        return new ModelAndView("/clientline/android/linelist", mapMessage);
    }
    ...
    public ModelAndView createLinePage() {
        ...
        return new ModelAndView("/clientline/android/createline", mapMessage);
    }
    ...
    public ModelAndView createLine(@RequestParam(value = "linename", required = false) String lineName,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                return new ModelAndView("forward:/clientline/android/createpage", mapMessage);
            }
        ...
        return new ModelAndView("redirect:/clientline/android/list?itemtype=" + itemType);
    }
    ...
    public ModelAndView modifyLinePage(@RequestParam(value = "lineid", required = true) Long lineId) {
        ...
        Map<String, Object> mapMessage = new HashMap<String, Object>();
        if (lineId == null) {
            return new ModelAndView("redirect:/clientline/android/list");
        }
        mapMessage.put("itemTypeCollection", itemTypes);
        ...
        return new ModelAndView("/clientline/android/modifyline", mapMessage);
    }
    ...
    public ModelAndView modifyLine(@RequestParam(value = "lineid", required = false) Long lineId,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                mapMessage.put("codeExist", "line.code.exist");
                return new ModelAndView("forward:/clientline/android/modifypage", mapMessage);
            }
    ...
    public ModelAndView detail(@RequestParam(value = "lineid", required = false) Long lineId) {
        ...
        return new ModelAndView("/clientline/android/linedetail", mapMessage);
    }
