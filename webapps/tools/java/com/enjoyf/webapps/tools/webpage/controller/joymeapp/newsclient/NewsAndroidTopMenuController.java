 ...
 */
@Controller
@RequestMapping(value = "/joymeapp/newsclient/topmenu/android")
public class NewsAndroidTopMenuController extends ToolsBaseController {
...
//    private JoymeAppConfig joymeAppConfig = config.getJoymeAppConfig();
    ...
    public ModelAndView queryTopMenuList(@RequestParam(value = "channelid", required = false) Long channelId,
        ...
        try {
            ...
            return new ModelAndView("/joymeapp/newsclient/android/topmenulist", mapMessage);
        }
    ...
    public ModelAndView createTopMenuPage() {
        ...
        try {
            ...
            GAlerter.lab(this.getClass().getName() + " occured ServiceException.e: ", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/newsclient/topmenu/android/list", mapMessage);
        }
        return new ModelAndView("/joymeapp/newsclient/android/createtopmenu", mapMessage);
    }
    ...
    public ModelAndView createTopMenu(@RequestParam(value = "menuname", required = false) String menuName,
        ...
        try {
            ...
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/newsclient/topmenu/android/createpage", mapMessage);
        }
        return new ModelAndView("redirect:/joymeapp/newsclient/topmenu/android/list");
    }
    ...
    public ModelAndView modifyAppPage(@RequestParam(value = "activitytopmenuid", required = true) Long activityTopMenuId) {
        ...
        return new ModelAndView("joymeapp/newsclient/android/modifytopmenu", mapMessage);
    }
    ...
    public ModelAndView modify(@RequestParam(value = "activitytopmenuid", required = true) Long activityTopMenuId,
        ...
        try {
            ...
            GAlerter.lab(this.getClass().getName() + "ServiceException", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/newsclient/topmenu/android/modifypage?activitytopmenuid=" + activityTopMenuId);
        }
        return new ModelAndView("redirect:/joymeapp/newsclient/topmenu/android/list");
    }
    ...
    public ModelAndView getAppMenuSort(@PathVariable(value = "sort") String sort,
        ...
        try {
            ...
            JoymeAppWebLogic.sortClientTopMenu(sort, activityTopMenuId, AppTopMenuCategory.NEWS_CLIENT_LINE.getCode(), CLIENT_PLATFORM_ANDROID);
        } catch (Exception e) {
            GAlerter.lab(this.getClass().getName() + "ServiceException", e);
            mapMessage = putErrorMessage(mapMessage, "system.error");
            return new ModelAndView("redirect:/joymeapp/newsclient/topmenu/android/list");
