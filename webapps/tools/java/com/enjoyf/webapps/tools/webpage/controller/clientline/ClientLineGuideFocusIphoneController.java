 ...
 */
@Controller
@RequestMapping(value = "/clientline/iphone/guidefocus")
public class ClientLineGuideFocusIphoneController extends ToolsBaseController {
    ...
    public ModelAndView lineList(@RequestParam(value = "pager.offset", required = false, defaultValue = "0") int pageStartIndex,
        ...
        return new ModelAndView("/clientline/iphoneguidefocus/linelist", mapMessage);
    }
    ...
    public ModelAndView createLinePage() {
        ...
        mapMessage.put("itemTypeCollection", itemTypes);
        mapMessage.put("itemAngleCollection", ClientLineAngular.getAll());
        return new ModelAndView("/clientline/iphoneguidefocus/createline", mapMessage);
    }
    ...
    public ModelAndView createLine(@RequestParam(value = "linename", required = false) String lineName,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                return new ModelAndView("forward:/clientline/iphone/guidefocus/createpage", mapMessage);
            }
        ...
        return new ModelAndView("redirect:/clientline/iphone/guidefocus/list?itemtype=" + itemType);
    }
    ...
    public ModelAndView modifyLinePage(@RequestParam(value = "lineid", required = true) Long lineId) {
        ...
        Map<String, Object> mapMessage = new HashMap<String, Object>();
        if (lineId == null) {
            return new ModelAndView("redirect:/clientline/iphone/guidefocus/list");
        }
        mapMessage.put("itemTypeCollection", itemTypes);
        mapMessage.put("itemAngleCollection", ClientLineAngular.getAll());
        try {
        ...
        return new ModelAndView("/clientline/iphoneguidefocus/modifyline", mapMessage);
    }
    ...
    public ModelAndView modifyLine(@RequestParam(value = "lineid", required = false) Long lineId,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                mapMessage.put("codeExist", "line.code.exist");
                return new ModelAndView("forward:/clientline/iphone/guidefocus/modifypage", mapMessage);
            }
    ...
    public ModelAndView detail(@RequestParam(value = "lineid", required = false) Long lineId) {
        ...
        return new ModelAndView("/clientline/iphoneguidefocus/linedetail", mapMessage);
    }
