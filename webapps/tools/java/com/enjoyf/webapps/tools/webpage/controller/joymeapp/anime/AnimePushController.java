 ...
 */
@Controller
@RequestMapping(value = "/anime/push")
public class AnimePushController extends ToolsBaseController {
    ...
    public ModelAndView createMessage(@RequestParam(value = "icon", required = false) String icon,
        ...
        try {
            ...
            return new ModelAndView("redirect:/anime/push/list", mapMessage);
        }
        HashMap<String, Object> map = new HashMap<String, Object>();
        map.put("appkey", appkey);
        return new ModelAndView("redirect:/anime/push/list", map);
    }
    ...
    public ModelAndView sendMessage(@RequestParam(value = "msgid", required = true) Long msgId,
        ...
        try {
            ...
            if (pushMessage == null || !pushMessage.getPushStatus().equals(ActStatus.UNACT)) {
                return new ModelAndView("redirect:/anime/push/list");
            }
...
//            AppPushFactory.get().factory(pushMessage.getPushChannel(), pushMessage.getAppPlatform()).sendPushMessage(pushMessage);
            ...
            new ModelAndView("redirect:/anime/push/list", map);
        }
...
//            mapMessage.put("versionList", versionList);
            ...
            mapMessage.put("errorMsg", "error.exception");
            new ModelAndView("redirect:/anime/push/list", mapMessage);
        }
