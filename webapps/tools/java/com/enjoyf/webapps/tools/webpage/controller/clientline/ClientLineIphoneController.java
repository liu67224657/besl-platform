 ...
 */
@Controller
@RequestMapping(value = "/clientline/iphone")
public class ClientLineIphoneController extends ToolsBaseController {
    ...
    public ModelAndView lineList(@RequestParam(value = "pager.offset", required = false, defaultValue = "0") int pageStartIndex,
        ...
        queryExpress.add(QueryCriterions.eq(ClientLineField.PLATFORM, CLIENT_PLATFORM_IPHONE));
        queryExpress.add(QueryCriterions.eq(ClientLineField.LINE_TYPE, ClientLineType.BIGITEM.getCode()));
        if (itemType != null) {
            queryExpress.add(QueryCriterions.eq(ClientLineField.ITEM_TYPE, itemType));
        }
        queryExpress.add(QuerySort.add(ClientLineField.CREATE_DATE, QuerySortOrder.DESC));
        ...
        return new ModelAndView("/clientline/iphone/linelist", mapMessage);
    }
    ...
    public ModelAndView createLinePage() {
        ...
        return new ModelAndView("/clientline/iphone/createline", mapMessage);
    }
    ...
    public ModelAndView createLine(@RequestParam(value = "linename", required = false) String lineName,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                return new ModelAndView("forward:/clientline/iphone/createpage", mapMessage);
            }
            ...
            clientLine.setPlatform(CLIENT_PLATFORM_IPHONE);
            clientLine.setLineType(ClientLineType.BIGITEM);
        ...
        return new ModelAndView("redirect:/clientline/iphone/list?itemtype=" + itemType);
    }
    ...
    public ModelAndView modifyLinePage(@RequestParam(value = "lineid", required = true) Long lineId) {
        ...
        Map<String, Object> mapMessage = new HashMap<String, Object>();
        if (lineId == null) {
            return new ModelAndView("redirect:/clientline/iphone/list");
        }
        mapMessage.put("itemTypeCollection", itemTypes);
        ...
        return new ModelAndView("/clientline/iphone/modifyline", mapMessage);
    }
    ...
    public ModelAndView modifyLine(@RequestParam(value = "lineid", required = false) Long lineId,
        ...
        try {
            ...
            if (existLine != null) {
                ...
                mapMessage.put("codeExist", "line.code.exist");
                return new ModelAndView("forward:/clientline/iphone/modifypage", mapMessage);
            }
    ...
    public ModelAndView detail(@RequestParam(value = "lineid", required = false) Long lineId) {
        ...
        return new ModelAndView("/clientline/iphone/linedetail", mapMessage);
    }
