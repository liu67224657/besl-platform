 ...
 */
@Controller
@RequestMapping(value = "/joymeapp/pushmessage")
public class AppPushMessageController extends ToolsBaseController {
    ...
    public ModelAndView list(@RequestParam(value = "pager.offset", required = false, defaultValue = "0") int pageStartIndex,      //数据库记录索引
        ...
        return new ModelAndView("/joymeapp/pushmessagelist", mapMessage);
    }
    ...
    public ModelAndView createPushPage() {
        Map<String, Object> mapMessage = new HashMap<String, Object>();
        mapMessage.put("typeCollection", AppRedirectType.getAll());
        try {
        ...
        return new ModelAndView("/joymeapp/pushmessagecreate", mapMessage);
    }
    ...
    public ModelAndView createMessage(@RequestParam(value = "icon") String icon,
        ...
        try {
            ...
            if (app == null || platform == null) {
                ...
                return new ModelAndView("forward:/joymeapp/pushmessage/createpage", mapMessage);
            }
        ...
        return new ModelAndView("redirect:/joymeapp/pushmessage/list");
    }
    ...
    public ModelAndView sendMessage(@RequestParam(value = "msgid", required = true) Long msgId) {
        ...
        try {
            ...
            if (pushMessage == null) {
                ...
                new ModelAndView("forward:/joymeapp/pushmessage/list", mapMessage);
            }

            joymeAppWebLogic.sendMessage(pushMessage);
        ...
        return new ModelAndView("forward:/joymeapp/pushmessage/list", mapMessage);
    }
    ...
    public ModelAndView modifyPage(@RequestParam(value = "msgid", required = true) Long pushMsgId) {
        ...
        return new ModelAndView("/joymeapp/pushmessagemodify", mapMessage);
    }
