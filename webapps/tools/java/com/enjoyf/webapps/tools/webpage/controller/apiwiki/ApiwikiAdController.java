...
import com.enjoyf.platform.service.ask.wiki.AdExtendJson;
...
@Controller
@RequestMapping(value = "/apiwiki/ad")
public class ApiwikiAdController extends ToolsBaseController {
    ...
    public ModelAndView list(@RequestParam(value = "pager.offset", required = false, defaultValue = "0") int pageStartIndex,
        ...
        try {
            ...
            queryExpress.add(QueryCriterions.eq(AdvertiseField.DOMAIN, AdvertiseDomain.ARTICLE_ADVERTISE.getCode()));
            ...
            if (!CollectionUtil.isEmpty(pageRows.getRows())) {
                for (Advertise advertise : pageRows.getRows()) {
                    AdExtendJson adExtendJson = AdExtendJson.toObject(advertise.getExtend());
                    if (adExtendJson != null) {
                        advertise.setExtend(String.valueOf(adExtendJson.getIndex()));
                    }
                }
            }
        ...
        return new ModelAndView("/apiwiki/ad/adlist", mapMessage);
    }
    ...
    public ModelAndView createPage(HttpServletRequest request) {
        ...
        return new ModelAndView("/apiwiki/ad/createpage", mapMessage);
    }
    ...
    public ModelAndView create(@RequestParam(value = "title", required = false) String title,
        ...
        try {
            ...
            advertise.setDomain(AdvertiseDomain.ARTICLE_ADVERTISE);
            ...
            AdExtendJson adExtendJson = new AdExtendJson();
            adExtendJson.setIndex(index);
            advertise.setExtend(adExtendJson.toJson());
        ...
        return new ModelAndView("redirect:/apiwiki/ad/list");
    }
    ...
    public ModelAndView modifyPage(@RequestParam(value = "id", required = false) Long id,
        ...
        try {
            ...
            mapMessage.put("adExtendJson", AdExtendJson.toObject(advertise.getExtend()));
        ...
        return new ModelAndView("/apiwiki/ad/modifypage", mapMessage);
    }
    ...
    public ModelAndView modify(@RequestParam(value = "id", required = false) Long id,
        ...
        try {
            ...
            AdExtendJson adExtendJson = new AdExtendJson();
            adExtendJson.setIndex(index);
            updateExpress.set(AdvertiseField.EXTEND, adExtendJson.toJson());
        ...
        return new ModelAndView("redirect:/apiwiki/ad/list", map);
    }
    ...
    public ModelAndView updatestatus(@RequestParam(value = "id", required = false) Long id,
        ...
        return new ModelAndView("redirect:/apiwiki/ad/list?removestatus=" + removestatus + "&platform=" + platform + "&pager.offset=" + pageStartIndex, map);
    }
    ...
    public String sort(@RequestParam(value = "sort", required = true) String sort,
                       ...
                       @RequestParam(value = "removestatus", required = false, defaultValue = "") String removestatus,
                       @RequestParam(value = "platform", required = false, defaultValue = "") String platform, HttpServletRequest request) {
        Map<String, Object> mapMessage = new HashMap<String, Object>();
        try {
