...
<h4 class="game-net-icon">网络游戏</h4>
<ul class="tj-game-item clearfix">
    <#list majorList as game>
        <li>
            <a href="${URL_WWW}/game/${game.code}" target="_blank" title="${game.title}"><p>
                ...
                <img src="${thumbimg}" width="100" height="136"><em></em></p>
                <#if game.extField1??>
    ...
    <ul class="tj-game-tag clearfix">
        <#list list as game>
            <li>
                <#if game.extField1??>
                    <span class="week-game-tag">${game.extField1}</span>
                </#if>
                <a href="http://www.joyme.com/game/${game.code}" target="_blank"
