...
<h2 class="index-2013-title">WIKI资料大百科<a class="normalLink" target="_blank" href="${URL_WWW}/games">&gt;更多</a></h2>
<div class="game-wiki">
    <ul class="game-measured">
        <#list wikiList as wiki>
            <li>
                ...
                <a href="${wiki.link}" class="game-pic" target="_blank" title="${wiki.title}">
                    <p>
                        <#if wiki.thumbimg??>
                            ...
                            <img width="183" height="90" src="${thumbimg}" <#if wiki.title??>alt="${wiki.title}"</#if> >
                            <#else>
                ...
                <div>
                    <h2><a href="${wiki.link}" target="_blank" title="${wiki.title?html}">${wiki.title?html}
                    ...
                    <#if wiki.extField3??><p class="wiki-tag">${wiki.extField3}</p></#if>
                </div>
            </li>
        </#list>
    </ul>
