...
/**
 * This was grabbed off of the web. It is supposed to be open source.
 * <p/>
 * Encodes and decodes to and from Base64 notation. I modified it to
 * use different characters that are more URL friendly. In particular,
 * i used '_' instead of '+', '-' instead of '/', and '.' instead of '='.
 * Note that the characters chosen were so that we would not need to
 * URLEncode them.
 * <p/>
 * -gil.
 * *************************************************************************
...
/* ********  P R I V A T E   F I E L D S  ******** */
    ...
    private final static byte[] _NATIVE_ALPHABET = /* May be something funny like EBCDIC */
            {
                    ...
                    (byte) '6', (byte) '7', (byte) '8', (byte) '9', (byte) '_', (byte) '-'
            };
    ...
    static {
        byte[] __bytes;
        try {
            __bytes = new String("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_-").getBytes(PREFERRED_ENCODING);
        }   // end try
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
     ...
     * @return the decoded data. Will return null if the passed in
     *         charaters are bad, or 's' is null or empty.
     * @since 1.4
     */
    public static byte[] decode(String s) {
        ...
        //--
        // We may end up with a null array if the passed in characters
        // are bad.
        //--
        if (bytes == null) {
            return null;
