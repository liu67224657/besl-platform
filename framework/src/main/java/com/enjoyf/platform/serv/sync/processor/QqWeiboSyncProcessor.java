 ...
 */
public class QqWeiboSyncProcessor implements SyncProcessor {
    ...
    public boolean processShare(TokenInfo tokenInfo, SyncContent syncContent) throws ServiceException {
        IOauthApi oauthApi = OAuthInterfaceSngl.get().getApiByProvider(AccountDomain.SYNC_QQ_WEIBO, AuthVersion.SYNC_AUTH_VERSION_AUTH10);
