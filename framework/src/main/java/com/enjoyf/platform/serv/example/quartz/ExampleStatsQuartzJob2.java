 ...
 */
public class ExampleStatsQuartzJob2 extends FivewhQuartzJob {
    //
    private static final Logger logger = LoggerFactory.getLogger(ExampleStatsQuartzJob2.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        logger.info("ExampleStatsQuartzJob2 starts executing.");
    }
}
