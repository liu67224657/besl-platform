 ...
 * weibo app 属性文件
 */
public class QqV2Config {
    private static QqV2Config instance;
    ...
    public static synchronized QqV2Config get() {
        if (instance == null) {
            instance = new QqV2Config();
        }
    ...
    private void init() {
        props = new FiveProps(HotdeployConfigFactory.get().getConfig(ThirdApiHotdeployConfig.class).getProviderPropsMap().get(LoginDomain.QQ));
