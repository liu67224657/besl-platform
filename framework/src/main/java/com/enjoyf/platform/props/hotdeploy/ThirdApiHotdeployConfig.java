 ...
 * webapp 属性文件
 */
public class ThirdApiHotdeployConfig extends HotdeployConfig {

    private static final Logger logger = LoggerFactory.getLogger(ThirdApiHotdeployConfig.class);
    ...
    public ThirdApiHotdeployConfig() {
        super(EnvConfig.get().getSyncHotdeployConfigureFile());
        init();
    }
