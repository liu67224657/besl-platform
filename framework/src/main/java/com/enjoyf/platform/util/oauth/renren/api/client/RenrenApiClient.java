...
import com.enjoyf.platform.util.oauth.renren.api.client.services.*;
...
public class RenrenApiClient {
    ...
    private void checkConfig() {
        String renrenApiKey = RenRenConfig.get().getRenrenApiKey();
        String renrenApiSecret = RenRenConfig.get().getRenrenApiSecret();
