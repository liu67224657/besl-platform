 ...
 *
 */
package com.enjoyf.platform.util.oauth.weibo4j.http;

import com.enjoyf.platform.util.oauth.weibo4j.model.Constants;
		...
		try {
			...
			while (itr.hasNext()) {
                ...
                if ("gif".equalsIgnoreCase(reader.getFormatName())) {
                    type = "image/gif";
                } else if ("jpeg".equalsIgnoreCase(reader.getFormatName())) {
                    type = "image/jpeg";
                } else if ("png".equalsIgnoreCase(reader.getFormatName())) {
                    type = "image/png";
                } else if ("bmp".equalsIgnoreCase(reader.getFormatName())) {
