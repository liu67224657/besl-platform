 ...
 * Description:
 */
public class WeixinServUserService {
     ...
     * @return
     */
    public WeixinServUserInfo getUserInfo(String accessToken, String openId) {
        WeixinServUserInfo returnObj = new WeixinServUserInfo();
