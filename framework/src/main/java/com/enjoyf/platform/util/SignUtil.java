 ...
 * Create time:  14-1-14 下午3:30
 * Description:
 */
public class SignUtil {


    private static String sign(List<String> paramList, String despassword) throws Exception {
        StringBuffer sb = new StringBuffer();

        for (String param : paramList) {
            sb.append("&").append(param);
        }
        return DESUtil.desEncrypt(despassword, sb.toString());
    }
