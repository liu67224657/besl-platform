...
public class Comments {
	...
	public List<Comment> getCommentById(String id) throws WeiboException {
		return Comment.constructComments(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()+"comments/show.json", new PostParameter[]{
	...
	public List<Comment> getCommentById(String id,Paging page,Integer count,Integer filter_by_author) throws WeiboException{
		return Comment.constructComments(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()+"comments/show.json",
				new PostParameter[]{
			new PostParameter("id", id),
	...
	public List<Comment> getCommentByMe() throws WeiboException{
		return Comment.constructComments(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()+"comments/by_me.json"));
	}
	/**
	 * 获取当前登录用户所发出的评论列表  
	 * @param count 单页返回的记录条数，默认为50 
	...
	public List<Comment> getCommentByMe(Paging page,Integer filter_by_source) throws WeiboException{
		return Comment.constructComments(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()+"comments/by_me.json",new PostParameter[]{
	...
	public List<Comment> getCommentToMe() throws WeiboException{
		return Comment.constructComments(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()+"comments/to_me.json"));
	}
	/**
	 * 获取当前登录用户所接收到的评论列表   
	 * @param count 单页返回的记录条数，默认为50。
	...
	public List<Comment> getCommentTimeline() throws WeiboException{
		return Comment.constructComments(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()+"comments/timeline.json"));
	}
	/**
	 * 获取当前登录用户的最新评论包括接收到的与发出的   
	 * @param count 单页返回的记录条数，默认为50。 
	...
	public List<Comment> getCommentTimeline(Paging page) throws WeiboException{
		return Comment.constructComments(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()+"comments/timeline.json",null,page));
	}
	/**
	...
	public List<Comment> getCommentMentions() throws WeiboException{
		return Comment.constructComments(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()+"comments/mentions.json"));
	}
	/**
	 * 获取最新的提到当前登录用户的评论，即@我的评论   
	 * @param count 单页返回的记录条数，默认为50。
	...
	public List<Comment> getCommentShowBatch(String cids) throws WeiboException{
		return Comment.constructComment(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()+"comments/show_batch.json",new PostParameter[]{new PostParameter("cids", cids)}));
	}
	/**
	 * 对一条微博进行评论    
	...
	public Comment createComment(String comment,String id) throws WeiboException{
		return new Comment(Weibo.client.post(SinaWeiboConfig.get().getBaseUrl()+"comments/create.json", new PostParameter[]{
...
s	 * @param comment 评论内容，必须做URLencode，内容不超过140个汉字
	...
	public Comment replyComment(String cid,String id,String comment) throws WeiboException{
		return new Comment(Weibo.client.post(SinaWeiboConfig.get().getBaseUrl()+"comments/reply.json",new PostParameter[]{
	...
	public Comment destroyComment(String cid) throws WeiboException{
		return new Comment(Weibo.client.post(SinaWeiboConfig.get().getBaseUrl()+"comments/destroy.json",new PostParameter[]{
				new PostParameter("cid", cid)}));
	}
	/**
	 * 根据评论ID批量删除评论
	...
	public List<Comment> destoryCommentBatch(String ids) throws WeiboException{
		return Comment.constructComment(Weibo.client.post(SinaWeiboConfig.get().getBaseUrl()+"comments/destroy_batch.json", new PostParameter[]{
