 ...
 * Description:
 */
public class WeixinServAuthService {

    private WeixinServConfig weixinConfig = WeixinServConfig.get();
    ...
    public String getWeiXinAuthUrl(String redirectUrl) {
        ...
        String url = "https://open.weixin.qq.com/connect/oauth2/authorize?" +
                "appid=" + weixinConfig.getApiKey() + "&redirect_uri=" + redirectUrl + "&response_type=code&scope=snsapi_userinfo&state=" + stat + "#wechat_redirect";
        return url;
    }
     ...
     * @return
     */
    public WeiXinServAuth getAccessToken(String code) {
...
//               "&secret="+weixinConfig.getApiSecret()+"&code="+code+"&grant_type=authorization_code";
        ...
        WeiXinServAuth returnObj = new WeiXinServAuth();
     ...
     * @return
     */
    public WeiXinServAuth refreshToken(String refreshToken) {
        WeiXinServAuth returnObj = new WeiXinServAuth();
