...
import com.enjoyf.platform.util.oauth.weibo4j.util.URLEncodeUtils;
...
public class Timeline {
	...
	public List<Status> getPublicTimeline() throws WeiboException {
		...
		return Status.constructStatuses(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl() + "statuses/public_timeline.json"));
	}
	...
	public List<Status> getFriendsTimeline() throws WeiboException {
		...
		return Status.constructStatuses(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl() + "statuses/friends_timeline.json"));
	...
	public List<Status> getHomeTimeline() throws WeiboException {
		...
		return Status.constructStatuses(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl() + "statuses/home_timeline.json"));
	...
	public List<Status> getUserTimeline(String access_token)
			throws WeiboException {
		return Status.constructStatuses(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl() + "statuses/user_timeline.json"));
	}
	...
	public List<Status> getRepostByMe() throws WeiboException {
		return Status.constructStatuses(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl() + "statuses/repost_by_me.json"));
	}
	...
	public List<Status> getRepostByMe(Paging page) throws WeiboException {
		return Status.constructStatuses(Weibo.client.get(
				SinaWeiboConfig.get().getBaseUrl() + "statuses/repost_by_me.json",
				null, page));
	}
	...
	public List<Status> getMentions() throws WeiboException {
		return Status.constructStatuses(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl() + "statuses/mentions.json"));
	}
	...
	public List<Status> getMentions(Paging page, Integer filter_by_author,
			...
			throws WeiboException {
		return Status.constructStatuses(Weibo.client.get(
				SinaWeiboConfig.get().getBaseUrl() + "statuses/mentions.json",
				new PostParameter[] {
	...
	public Status showStatus(String id) throws WeiboException {
		return new Status(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()
				+ "statuses/show.json",
				new PostParameter[] { new PostParameter("id", id) }));
	}
	...
	public List<QueryID> QueryId(String mid, Integer type,Integer isBatch,Integer inbox,Integer isBase62) throws WeiboException {
		return QueryID.constructQueryID(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()
	...
	public List<QueryID> QueryMid(Integer type, String id,Integer isBatch) throws WeiboException {
		return QueryID.constructQueryID(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl()+ "statuses/querymid.json", new PostParameter[] {
				new PostParameter("id", id.toString()),
				new PostParameter("type", type.toString()),
	...
	public List<Status> getRepostDaily() throws WeiboException {
		return Status.constructStatuses(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl() + "statuses/hot/repost_daily.json"));
	}
	...
	public Status Repost(String id) throws WeiboException {
		return new Status(Weibo.client.post(SinaWeiboConfig.get().getBaseUrl()
	...
	public Status UploadStatus(String status, ImageItem item)
		...
		return new Status(Weibo.client.multPartURL(
				SinaWeiboConfig.get().getBaseUrl() + "statuses/upload.json",
				new PostParameter[] { new PostParameter("status", status) },
				item));
	}
	...
	public List<Emotion> getEmotions() throws WeiboException {
		return Emotion.constructEmotions(Weibo.client.get(SinaWeiboConfig.get().getBaseUrl() + "emotions.json"));
	}
	...
	public List<Emotion> getEmotions(String type, String language)
		...
		return Emotion.constructEmotions(Weibo.client.get(
                SinaWeiboConfig.get().getBaseUrl() + "emotions.json",
